...
### `nextcloud:11.0.4-apache` - linux; arm variant v7
...
### `nextcloud:11.0.4-apache` - linux; arm64 variant v8
...
### `nextcloud:11.0.4-apache` - linux; 386
...
### `nextcloud:11.0.4-apache` - linux; ppc64le
...
### `nextcloud:11.0.4-apache` - linux; s390x
