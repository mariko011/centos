...
### `nextcloud:12.0.5-apache` - linux; arm variant v7
...
### `nextcloud:12.0.5-apache` - linux; arm64 variant v8
...
### `nextcloud:12.0.5-apache` - linux; 386
...
### `nextcloud:12.0.5-apache` - linux; ppc64le
