...
```console
$ docker pull wordpress@sha256:88143c0edaef9ce7ae05e2fc10910e0fd5e020970440805a00f6eeb0770a09bc
```
...
### `wordpress:4.8.1-php7.0` - linux; arm64 variant v8
...
### `wordpress:4.8.1-php7.0` - linux; 386
...
### `wordpress:4.8.1-php7.0` - linux; ppc64le
...
### `wordpress:4.8.1-php7.0` - linux; s390x
