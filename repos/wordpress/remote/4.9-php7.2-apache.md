...
### `wordpress:4.9-php7.2-apache` - linux; arm variant v5
...
### `wordpress:4.9-php7.2-apache` - linux; arm variant v7
...
### `wordpress:4.9-php7.2-apache` - linux; arm64 variant v8
...
### `wordpress:4.9-php7.2-apache` - linux; 386
