...
### `wordpress:4.8.1-php7.0-fpm` - linux; amd64
...
### `wordpress:4.8.1-php7.0-fpm` - linux; 386
...
### `wordpress:4.8.1-php7.0-fpm` - linux; ppc64le
...
### `wordpress:4.8.1-php7.0-fpm` - linux; s390x
