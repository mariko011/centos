...
### `wordpress:4.8-apache` - linux; arm variant v5
...
### `wordpress:4.8-apache` - linux; arm64 variant v8
...
### `wordpress:4.8-apache` - linux; 386
...
### `wordpress:4.8-apache` - linux; ppc64le
...
### `wordpress:4.8-apache` - linux; s390x
