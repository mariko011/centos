...
### `wordpress:4.9.0-php7.1-apache` - linux; amd64
...
### `wordpress:4.9.0-php7.1-apache` - linux; arm variant v5
...
### `wordpress:4.9.0-php7.1-apache` - linux; arm variant v7
...
### `wordpress:4.9.0-php7.1-apache` - linux; arm64 variant v8
...
### `wordpress:4.9.0-php7.1-apache` - linux; 386
...
### `wordpress:4.9.0-php7.1-apache` - linux; ppc64le
...
### `wordpress:4.9.0-php7.1-apache` - linux; s390x
