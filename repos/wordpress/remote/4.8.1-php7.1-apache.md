...
### `wordpress:4.8.1-php7.1-apache` - linux; arm64 variant v8
...
### `wordpress:4.8.1-php7.1-apache` - linux; 386
...
### `wordpress:4.8.1-php7.1-apache` - linux; ppc64le
...
### `wordpress:4.8.1-php7.1-apache` - linux; s390x
