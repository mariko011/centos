...
### `wordpress:4.9.2-php7.1-fpm` - linux; amd64
...
### `wordpress:4.9.2-php7.1-fpm` - linux; arm variant v5
...
### `wordpress:4.9.2-php7.1-fpm` - linux; arm variant v7
...
### `wordpress:4.9.2-php7.1-fpm` - linux; arm64 variant v8
...
### `wordpress:4.9.2-php7.1-fpm` - linux; 386
...
### `wordpress:4.9.2-php7.1-fpm` - linux; ppc64le
...
### `wordpress:4.9.2-php7.1-fpm` - linux; s390x
