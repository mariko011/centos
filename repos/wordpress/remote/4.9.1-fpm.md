...
### `wordpress:4.9.1-fpm` - linux; arm variant v7
...
### `wordpress:4.9.1-fpm` - linux; arm64 variant v8
...
### `wordpress:4.9.1-fpm` - linux; ppc64le
...
### `wordpress:4.9.1-fpm` - linux; s390x
