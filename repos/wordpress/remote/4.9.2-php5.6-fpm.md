...
### `wordpress:4.9.2-php5.6-fpm` - linux; amd64
...
### `wordpress:4.9.2-php5.6-fpm` - linux; arm variant v5
...
### `wordpress:4.9.2-php5.6-fpm` - linux; arm variant v7
...
### `wordpress:4.9.2-php5.6-fpm` - linux; arm64 variant v8
