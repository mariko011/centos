...
### `wordpress:4.9.2-fpm` - linux; amd64
...
### `wordpress:4.9.2-fpm` - linux; arm variant v7
...
### `wordpress:4.9.2-fpm` - linux; arm64 variant v8
...
### `wordpress:4.9.2-fpm` - linux; ppc64le
