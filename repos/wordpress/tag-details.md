...
-	[`wordpress:4.8.0-fpm-alpine`](#wordpress480-fpm-alpine)
...
-	[`wordpress:4.8.0-php5.6-fpm-alpine`](#wordpress480-php56-fpm-alpine)
...
-	[`wordpress:4.8.0-php7.0-apache`](#wordpress480-php70-apache)
...
-	[`wordpress:4.8.0-php7.0-fpm-alpine`](#wordpress480-php70-fpm-alpine)
...
-	[`wordpress:4.8.0-php7.1-apache`](#wordpress480-php71-apache)
...
-	[`wordpress:4.8.0-php7.1-fpm-alpine`](#wordpress480-php71-fpm-alpine)
...
### `wordpress:4.8.0-fpm` - linux; amd64
...
### `wordpress:4.8.0-php7.0-apache` - linux; amd64
...
### `wordpress:cli-1.2.1` - linux; amd64
