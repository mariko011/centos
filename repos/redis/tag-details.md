...
### `redis:4.0.7` - linux; arm variant v5
...
### `redis:4.0.7` - linux; arm64 variant v8
...
```console
$ docker pull redis@sha256:7968a7d902ec5d7278a7dd0510e0fadbef39c15672d3aa2fe6d3ba27b7c255c1
```
