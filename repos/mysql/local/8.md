...
- Created: `2017-04-25T01:31:56.031753204Z`
- Virtual Size: ~ 482.63 Mb  
...
- Environment:
  ...
  - `GOSU_VERSION=1.7`
  - `MYSQL_MAJOR=8.0`
  - `MYSQL_VERSION=8.0.1-dmr-1debian8`
...
### `dpkg` source package: `mysql-community=8.0.1-dmr-1debian8`

Binary Packages:

- `mysql-client=8.0.1-dmr-1debian8`
- `mysql-common=8.0.1-dmr-1debian8`
- `mysql-community-client=8.0.1-dmr-1debian8`
- `mysql-community-client-core=8.0.1-dmr-1debian8`
- `mysql-community-server=8.0.1-dmr-1debian8`
- `mysql-community-server-core=8.0.1-dmr-1debian8`
- `mysql-server=8.0.1-dmr-1debian8`
...
```console
$ apt-get source -qq --print-uris mysql-community=8.0.1-dmr-1debian8
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.1-dmr-1debian8.dsc' mysql-community_8.0.1-dmr-1debian8.dsc 1958 SHA256:ce0df4c594388252f71dccbf853deafe249898df76b3fad1897479ea8a900cba
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.1-dmr.orig.tar.gz' mysql-community_8.0.1-dmr.orig.tar.gz 60461566 SHA256:db34a89a5882f65e727bc3c41420bc23f9ab30f29128fcae5608367521fa1084
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.1-dmr-1debian8.debian.tar.xz' mysql-community_8.0.1-dmr-1debian8.debian.tar.xz 63838668 SHA256:e3d6d4261f3e8d5bb7c6f1d96f432310fb162ffe2f893dc5b2891c9ab4c0ca38
```
