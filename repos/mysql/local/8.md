...
- Created: `2017-07-18T23:13:50.540937116Z`
- Virtual Size: ~ 266.48 Mb  
...
- Environment:
  ...
  - `GOSU_VERSION=1.7`
  - `MYSQL_MAJOR=8.0`
  - `MYSQL_VERSION=8.0.2-dmr-1debian8`
...
### `dpkg` source package: `mysql-community=8.0.2-dmr-1debian8`

Binary Packages:

- `mysql-community-client-core=8.0.2-dmr-1debian8`
- `mysql-community-server-core=8.0.2-dmr-1debian8`
...
```console
$ apt-get source -qq --print-uris mysql-community=8.0.2-dmr-1debian8
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.2-dmr-1debian8.dsc' mysql-community_8.0.2-dmr-1debian8.dsc 1958 SHA256:36ab407577f9c8c3299749e9b1c862c29594f248c900b2f37497ed9f1de3da52
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.2-dmr.orig.tar.gz' mysql-community_8.0.2-dmr.orig.tar.gz 62400197 SHA256:1c0c349cd69a3642402cecebd70038e6ec3e20fd7ecf08af197af840284842e9
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.2-dmr-1debian8.debian.tar.xz' mysql-community_8.0.2-dmr-1debian8.debian.tar.xz 82374936 SHA256:a9158e10a9c02936d565f50a12220ae0672a71825ef7a0a5c9577d4a052dd9eb
```
