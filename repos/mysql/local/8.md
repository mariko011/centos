...
- Created: `2017-02-28T06:58:58.252601357Z`
- Arch: `linux`/`amd64`
...
- Environment:
  ...
  - `GOSU_VERSION=1.7`
  - `MYSQL_MAJOR=8.0`
  - `MYSQL_VERSION=8.0.0-dmr-1debian8`
...
### `dpkg` source package: `mysql-community=8.0.0-dmr-1debian8`

Binary Packages:

- `mysql-client=8.0.0-dmr-1debian8`
- `mysql-common=8.0.0-dmr-1debian8`
- `mysql-community-client=8.0.0-dmr-1debian8`
- `mysql-community-server=8.0.0-dmr-1debian8`
- `mysql-server=8.0.0-dmr-1debian8`
...
```console
$ apt-get source -qq --print-uris mysql-community=8.0.0-dmr-1debian8
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.0-dmr-1debian8.dsc' mysql-community_8.0.0-dmr-1debian8.dsc 1844 SHA256:ec85430d0f1a981c5f1902db5d61b915c042dcd9443027ef6bb8daf245bbd97c
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.0-dmr.orig.tar.gz' mysql-community_8.0.0-dmr.orig.tar.gz 55384068 SHA256:712cbbf9edf2c6fccbc6d98b1d47d58a9408e59822cd7273b7adf8d35ce5ffe9
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.0-dmr-1debian8.debian.tar.xz' mysql-community_8.0.0-dmr-1debian8.debian.tar.xz 134312552 SHA256:d884c78f35525a8a1985913f43a744992c2231aebcf2b0c7d2f2b73c4b8ede3b
```
