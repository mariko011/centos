...
- Created: `2017-04-25T01:31:00.476282679Z`
- Virtual Size: ~ 298.44 Mb  
...
### `dpkg` source package: `mysql-community=5.6.36-1debian8`

Binary Packages:

- `mysql-client=5.6.36-1debian8`
- `mysql-common=5.6.36-1debian8`
- `mysql-community-client=5.6.36-1debian8`
- `mysql-community-server=5.6.36-1debian8`
- `mysql-server=5.6.36-1debian8`
