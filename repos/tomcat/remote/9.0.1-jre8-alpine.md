...
```console
$ docker pull tomcat@sha256:ecbca4921a4b09d94db010de67e3941863fe390a17546f6b169e8b2f3bfdfa70
```
...
### `tomcat:9.0.1-jre8-alpine` - linux; arm variant v6
...
### `tomcat:9.0.1-jre8-alpine` - linux; arm64 variant v8
...
### `tomcat:9.0.1-jre8-alpine` - linux; 386
...
### `tomcat:9.0.1-jre8-alpine` - linux; ppc64le
...
### `tomcat:9.0.1-jre8-alpine` - linux; s390x
