...
### `tomcat:8.5.27-alpine` - linux; amd64
...
### `tomcat:8.5.27-alpine` - linux; arm64 variant v8
...
### `tomcat:8.5.27-alpine` - linux; 386
...
### `tomcat:8.5.27-alpine` - linux; ppc64le
...
### `tomcat:8.5.27-alpine` - linux; s390x
