...
### `tomcat:7.0.84-jre7-alpine` - linux; amd64
...
### `tomcat:7.0.84-jre7-alpine` - linux; arm64 variant v8
...
### `tomcat:7.0.84-jre7-alpine` - linux; 386
...
### `tomcat:7.0.84-jre7-alpine` - linux; ppc64le
...
### `tomcat:7.0.84-jre7-alpine` - linux; s390x
