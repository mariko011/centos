...
### `tomcat:7.0.84-jre8` - linux; amd64
...
### `tomcat:7.0.84-jre8` - linux; arm variant v7
...
### `tomcat:7.0.84-jre8` - linux; arm64 variant v8
...
### `tomcat:7.0.84-jre8` - linux; ppc64le
...
### `tomcat:7.0.84-jre8` - linux; s390x
