...
### `tomcat:7.0.82-slim` - linux; amd64
...
### `tomcat:7.0.82-slim` - linux; arm variant v5
...
### `tomcat:7.0.82-slim` - linux; arm variant v7
...
### `tomcat:7.0.82-slim` - linux; arm64 variant v8
...
### `tomcat:7.0.82-slim` - linux; ppc64le
...
### `tomcat:7.0.82-slim` - linux; s390x
