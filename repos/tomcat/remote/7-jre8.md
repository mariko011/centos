...
```console
$ docker pull tomcat@sha256:48c5ce95725242f10be5edc7d3685706bd82bb8792022308a9e84ccbcc6af341
```
...
```console
$ docker pull tomcat@sha256:86c85c12bc320efc5e6cff13409811c0078cb90b4807f514b58fae1c69676738
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.7 MB (221658246 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c1711d9dab045e2e2441eb5794875b829427f725655dd00059a67dca36294c69`
-	Default Command: `["catalina.sh","run"]`
