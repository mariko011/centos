...
### `tomcat:9.0.1-alpine` - linux; arm variant v6
...
### `tomcat:9.0.1-alpine` - linux; arm64 variant v8
...
### `tomcat:9.0.1-alpine` - linux; ppc64le
...
### `tomcat:9.0.1-alpine` - linux; s390x
