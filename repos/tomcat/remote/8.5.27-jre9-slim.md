...
### `tomcat:8.5.27-jre9-slim` - linux; amd64
...
### `tomcat:8.5.27-jre9-slim` - linux; arm variant v5
...
### `tomcat:8.5.27-jre9-slim` - linux; arm variant v7
...
### `tomcat:8.5.27-jre9-slim` - linux; arm64 variant v8
...
### `tomcat:8.5.27-jre9-slim` - linux; 386
...
### `tomcat:8.5.27-jre9-slim` - linux; ppc64le
...
### `tomcat:8.5.27-jre9-slim` - linux; s390x
