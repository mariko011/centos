...
```console
$ docker pull tomcat@sha256:2c661ff862f6e839f4954f89ac0b3b66955d14194026c9911c68ded68bdb2e2b
```
...
-	Docker Version: 1.12.6
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.8 MB (143770888 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d06041a8ad6cee16064394924769a4ad6f1587a4e35923a34f036645fb489af`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=6
# Wed, 22 Mar 2017 17:43:21 GMT
ENV TOMCAT_VERSION=6.0.51
# Wed, 22 Mar 2017 17:43:21 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dyn/closer.cgi?action=download&filename=tomcat/tomcat-6/v6.0.51/bin/apache-tomcat-6.0.51.tar.gz
# Wed, 22 Mar 2017 17:43:22 GMT
ENV TOMCAT_ASC_URL=https://www.apache.org/dist/tomcat/tomcat-6/v6.0.51/bin/apache-tomcat-6.0.51.tar.gz.asc
# Wed, 22 Mar 2017 17:44:03 GMT
RUN set -x 		&& wget -O tomcat.tar.gz "$TOMCAT_TGZ_URL" 	&& wget -O tomcat.tar.gz.asc "$TOMCAT_ASC_URL" 	&& gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz 	&& tar -xvf tomcat.tar.gz --strip-components=1 	&& rm bin/*.bat 	&& rm tomcat.tar.gz* 		&& nativeBuildDir="$(mktemp -d)" 	&& tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1 	&& nativeBuildDeps=" 		gcc 		libapr1-dev 		libssl-dev 		make 		openjdk-${JAVA_VERSION%%[-~bu]*}-jdk=$JAVA_DEBIAN_VERSION 	" 	&& apt-get update && apt-get install -y --no-install-recommends $nativeBuildDeps && rm -rf /var/lib/apt/lists/* 	&& ( 		export CATALINA_HOME="$PWD" 		&& cd "$nativeBuildDir/native" 		&& ./configure 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$(which apr-1-config)" 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes 		&& make -j$(nproc) 		&& make install 	) 	&& apt-get purge -y --auto-remove $nativeBuildDeps 	&& rm -rf "$nativeBuildDir" 	&& rm bin/tomcat-native.tar.gz
# Wed, 22 Mar 2017 17:44:03 GMT
EXPOSE 8080/tcp
# Wed, 22 Mar 2017 17:44:04 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:8852184289b238f694514af0e9ba5a6f497e754b63c09d94255c88598dec302a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b476b0e89bbeceafccf8c27a9ce02d20fc154b9d58786c891b39a08e365663b`  
		Last Modified: Fri, 24 Mar 2017 01:03:11 GMT  
		Size: 7.7 MB (7689061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `tomcat:7.0.76-jre7` - linux; amd64
...
```console
$ docker pull tomcat@sha256:a497af9a7529d62ea2219acef4b58a8cab007b50e33f3ab355c642a0edd59614
```

-	Platforms:
	-	linux; amd64

### `tomcat:7.0.76-jre7-alpine` - linux; amd64

-	Docker Version: 1.12.6
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **75.8 MB (75815085 bytes)**  
	(compressed transfer size, not on-disk size)
...
# Fri, 03 Mar 2017 23:46:32 GMT
ENV TOMCAT_MAJOR=7
# Sat, 18 Mar 2017 00:24:34 GMT
ENV TOMCAT_VERSION=7.0.76
# Sat, 18 Mar 2017 00:24:35 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dyn/closer.cgi?action=download&filename=tomcat/tomcat-7/v7.0.76/bin/apache-tomcat-7.0.76.tar.gz
# Sat, 18 Mar 2017 00:24:35 GMT
ENV TOMCAT_ASC_URL=https://www.apache.org/dist/tomcat/tomcat-7/v7.0.76/bin/apache-tomcat-7.0.76.tar.gz.asc
# Sat, 18 Mar 2017 00:24:50 GMT
...
# Sat, 18 Mar 2017 00:24:55 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 18 Mar 2017 00:24:55 GMT
EXPOSE 8080/tcp
# Sat, 18 Mar 2017 00:24:56 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:179b1b3a6fe7072e828a34d2b359225133a0ba3cdb8b34480b31546172e21637`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58538c6474446eb11849a80d3f1c6c652e7cbd0c20cecaba05cdd76cd9e7bbe5`  
		Last Modified: Sat, 18 Mar 2017 00:35:07 GMT  
		Size: 10.0 MB (10023855 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a815d9693158b552c9795e3e9af9699d22bcb2ced574f5243d1f55430d923ef`  
		Last Modified: Sat, 18 Mar 2017 00:35:06 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `tomcat:7.0.76-alpine` - linux; amd64
...
### `tomcat:8.0.42-jre7` - linux; amd64
...
### `tomcat:8.0.42-alpine` - linux; amd64
...
### `tomcat:8.0.42-jre8` - linux; amd64
...
### `tomcat:8.5.12-jre8` - linux; amd64
...
### `tomcat:8.5.12-jre8-alpine` - linux; amd64
...
### `tomcat:8.5.12-alpine` - linux; amd64
...
### `tomcat:9.0.0.M18-jre8` - linux; amd64
...
### `tomcat:9.0.0.M18-alpine` - linux; amd64
