...
- Created: `2017-01-17T20:36:28.41975456Z`
- Arch: `linux`/`amd64`
...
- Environment:
  ...
  - `TOMCAT_TGZ_URL=https://www.apache.org/dyn/closer.cgi?action=download&filename=tomcat/tomcat-8/v8.5.9/bin/apache-tomcat-8.5.9.tar.gz`
  - `TOMCAT_ASC_URL=https://www.apache.org/dist/tomcat/tomcat-8/v8.5.9/bin/apache-tomcat-8.5.9.tar.gz.asc`
