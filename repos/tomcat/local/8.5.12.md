...
- Created: `2017-03-22T17:49:14.943785988Z`
- Arch: `linux`/`amd64`
...
- Environment:
  ...
  - `TOMCAT_TGZ_URL=https://www.apache.org/dyn/closer.cgi?action=download&filename=tomcat/tomcat-8/v8.5.12/bin/apache-tomcat-8.5.12.tar.gz`
  - `TOMCAT_ASC_URL=https://www.apache.org/dist/tomcat/tomcat-8/v8.5.12/bin/apache-tomcat-8.5.12.tar.gz.asc`
