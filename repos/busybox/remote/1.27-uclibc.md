...
```console
$ docker pull busybox@sha256:fbdba782ab7043243077a9a5cfa1cfb923569f33977ea4a3158337ae0e2cf5fc
```
...
```console
$ docker pull busybox@sha256:91ef6c1c52b166be02645b8efee30d1ee65362024f7da41c404681561734c465
```
