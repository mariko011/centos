...
- Created: `2017-12-12T04:00:12.797927872Z`
- Virtual Size: ~ 332.78 Mb  
...
### `dpkg` source package: `erlang=1:17.3-dfsg-4+deb8u2`
...
```console
$ apt-get source -qq --print-uris erlang=1:17.3-dfsg-4+deb8u2
'http://security.debian.org/pool/updates/main/e/erlang/erlang_17.3-dfsg-4+deb8u2.dsc' erlang_17.3-dfsg-4+deb8u2.dsc 5499 SHA256:5d34bde78c6c22429a7bca8f4545c8749751dbaa528b47059f6982afade8e1cf
'http://security.debian.org/pool/updates/main/e/erlang/erlang_17.3-dfsg.orig.tar.xz' erlang_17.3-dfsg.orig.tar.xz 26122088 SHA256:5d8a627c7435c7fd6bd00cde8d292ee93e5fb4ebf1560ba17f4d7ad38f1b2f6a
'http://security.debian.org/pool/updates/main/e/erlang/erlang_17.3-dfsg-4+deb8u2.debian.tar.xz' erlang_17.3-dfsg-4+deb8u2.debian.tar.xz 73564 SHA256:c73436fe2927e4c29c4d105af521c9109c2cd1584dd2987d8c326c6e6cbf866e
```

Other potentially useful URLs:

- https://sources.debian.net/src/erlang/1:17.3-dfsg-4+deb8u2/ (for browsing the source)
- https://sources.debian.net/src/erlang/1:17.3-dfsg-4+deb8u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/erlang/1:17.3-dfsg-4+deb8u2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mozjs=1.8.5-1.0.0+dfsg-4.3`

Binary Packages:

- `libmozjs185-1.0=1.8.5-1.0.0+dfsg-4.3`

Licenses: (parsed from: `/usr/share/doc/libmozjs185-1.0/copyright`)
...
```console
$ apt-get source -qq --print-uris mozjs=1.8.5-1.0.0+dfsg-4.3
'http://deb.debian.org/debian/pool/main/m/mozjs/mozjs_1.8.5-1.0.0+dfsg-4.3.dsc' mozjs_1.8.5-1.0.0+dfsg-4.3.dsc 1393 SHA256:b0c47af18fa78066b836db6e3e6714cdbe3856b0a3bf4faec287f9f5176ac58d
'http://deb.debian.org/debian/pool/main/m/mozjs/mozjs_1.8.5-1.0.0+dfsg.orig.tar.gz' mozjs_1.8.5-1.0.0+dfsg.orig.tar.gz 5912801 SHA256:736c993caf80ae75d97d2b2a30369a7de84ed6cce28979816500fde7e45a5978
'http://deb.debian.org/debian/pool/main/m/mozjs/mozjs_1.8.5-1.0.0+dfsg-4.3.debian.tar.xz' mozjs_1.8.5-1.0.0+dfsg-4.3.debian.tar.xz 50112 SHA256:fc184414f22500f5bba6fa45a5cfe452f9fce07622b79bb4147e01914c4aeef6
```

Other potentially useful URLs:

- https://sources.debian.net/src/mozjs/1.8.5-1.0.0+dfsg-4.3/ (for browsing the source)
- https://sources.debian.net/src/mozjs/1.8.5-1.0.0+dfsg-4.3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mozjs/1.8.5-1.0.0+dfsg-4.3/ (for access to the source package after it no longer exists in the archive)
