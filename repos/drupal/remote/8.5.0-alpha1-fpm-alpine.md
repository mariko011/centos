...
### `drupal:8.5.0-alpha1-fpm-alpine` - linux; amd64
...
### `drupal:8.5.0-alpha1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:8.5.0-alpha1-fpm-alpine` - linux; 386
...
### `drupal:8.5.0-alpha1-fpm-alpine` - linux; ppc64le
