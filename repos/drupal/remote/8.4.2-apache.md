...
### `drupal:8.4.2-apache` - linux; amd64
...
### `drupal:8.4.2-apache` - linux; arm variant v5
...
### `drupal:8.4.2-apache` - linux; arm variant v7
...
### `drupal:8.4.2-apache` - linux; ppc64le
...
### `drupal:8.4.2-apache` - linux; s390x
