...
### `golang:1.9.1-alpine` - linux; arm variant v6
...
### `golang:1.9.1-alpine` - linux; arm64 variant v8
...
### `golang:1.9.1-alpine` - linux; ppc64le
...
### `golang:1.9.1-alpine` - linux; s390x
