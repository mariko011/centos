...
### `dpkg` source package: `nginx-module-geoip=1.13.1-1~stretch`

Binary Packages:

- `nginx-module-geoip=1.13.1-1~stretch`
...
```console
$ apt-get source -qq --print-uris nginx-module-geoip=1.13.1-1~stretch
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx-module-geoip/nginx-module-geoip_1.13.1-1~stretch.dsc' nginx-module-geoip_1.13.1-1~stretch.dsc 1651 SHA256:3446fc8f92ec2c53848c168179dc7f4b25af0db9d7f11360014c0832f30e4bda
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx-module-geoip/nginx-module-geoip_1.13.1.orig.tar.gz' nginx-module-geoip_1.13.1.orig.tar.gz 984142 SHA256:a5856c72a6609a4dc68c88a7f3c33b79e6693343b62952e021e043fe347b6776
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx-module-geoip/nginx-module-geoip_1.13.1-1~stretch.debian.tar.xz' nginx-module-geoip_1.13.1-1~stretch.debian.tar.xz 3320 SHA256:c4085f967c77ff426ff93ec6bf2d489d4d106aacefc3eb315a24bc647e910a7d
```

### `dpkg` source package: `nginx-module-image-filter=1.13.1-1~stretch`

Binary Packages:

- `nginx-module-image-filter=1.13.1-1~stretch`
...
```console
$ apt-get source -qq --print-uris nginx-module-image-filter=1.13.1-1~stretch
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx-module-image-filter/nginx-module-image-filter_1.13.1-1~stretch.dsc' nginx-module-image-filter_1.13.1-1~stretch.dsc 1725 SHA256:96c643f3b31b74670bc9884e3f1b35dff9dacfcb4612cd645c133ef6d0fc9805
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx-module-image-filter/nginx-module-image-filter_1.13.1.orig.tar.gz' nginx-module-image-filter_1.13.1.orig.tar.gz 984142 SHA256:a5856c72a6609a4dc68c88a7f3c33b79e6693343b62952e021e043fe347b6776
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx-module-image-filter/nginx-module-image-filter_1.13.1-1~stretch.debian.tar.xz' nginx-module-image-filter_1.13.1-1~stretch.debian.tar.xz 3300 SHA256:ef0034d234b9c0e6013b6bc31ca0b7ae09414d70dbd6cae3dede96bccc98054d
```

### `dpkg` source package: `nginx-module-njs=1.13.1.0.1.10-1~stretch`

Binary Packages:

- `nginx-module-njs=1.13.1.0.1.10-1~stretch`
...
```console
$ apt-get source -qq --print-uris nginx-module-njs=1.13.1.0.1.10-1~stretch
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx-module-njs/nginx-module-njs_1.13.1.0.1.10-1~stretch.dsc' nginx-module-njs_1.13.1.0.1.10-1~stretch.dsc 1670 SHA256:80eebc0f23e0f5dd7b21ac8fa9a30e6e9a6f2c82847b29317fc48f4fbf3c4220
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx-module-njs/nginx-module-njs_1.13.1.0.1.10.orig.tar.gz' nginx-module-njs_1.13.1.0.1.10.orig.tar.gz 984142 SHA256:a5856c72a6609a4dc68c88a7f3c33b79e6693343b62952e021e043fe347b6776
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx-module-njs/nginx-module-njs_1.13.1.0.1.10-1~stretch.debian.tar.xz' nginx-module-njs_1.13.1.0.1.10-1~stretch.debian.tar.xz 139144 SHA256:cee19d58bc53964f90ec8f30bd2046b2da0acce3a774141d696f6d6222653ad9
```

### `dpkg` source package: `nginx-module-xslt=1.13.1-1~stretch`

Binary Packages:

- `nginx-module-xslt=1.13.1-1~stretch`
...
```console
$ apt-get source -qq --print-uris nginx-module-xslt=1.13.1-1~stretch
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx-module-xslt/nginx-module-xslt_1.13.1-1~stretch.dsc' nginx-module-xslt_1.13.1-1~stretch.dsc 1640 SHA256:5b785116bb75f4a0e66a08928301602c2038d61ef8e88aba01783364cbcdec20
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx-module-xslt/nginx-module-xslt_1.13.1.orig.tar.gz' nginx-module-xslt_1.13.1.orig.tar.gz 984142 SHA256:a5856c72a6609a4dc68c88a7f3c33b79e6693343b62952e021e043fe347b6776
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx-module-xslt/nginx-module-xslt_1.13.1-1~stretch.debian.tar.xz' nginx-module-xslt_1.13.1-1~stretch.debian.tar.xz 3304 SHA256:e87f6b00fe303aeb169194cdc3488ba64cab9519967ea3f269b743e0411c19be
```

### `dpkg` source package: `nginx=1.13.1-1~stretch`

Binary Packages:

- `nginx=1.13.1-1~stretch`
...
```console
$ apt-get source -qq --print-uris nginx=1.13.1-1~stretch
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx/nginx_1.13.1-1~stretch.dsc' nginx_1.13.1-1~stretch.dsc 1499 SHA256:2bad007abc3a34b99188fded58bbaf4c633cfa80f541bf54e71e1b5629638c50
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx/nginx_1.13.1.orig.tar.gz' nginx_1.13.1.orig.tar.gz 984142 SHA256:a5856c72a6609a4dc68c88a7f3c33b79e6693343b62952e021e043fe347b6776
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx/nginx_1.13.1-1~stretch.debian.tar.xz' nginx_1.13.1-1~stretch.debian.tar.xz 107704 SHA256:3bb9f64644d536aa4a29236d5885f8f7e1f1dedd07b69f6f8b4e329acd8f8108
```
...
### `dpkg` source package: `tiff=4.0.8-1`

Binary Packages:

- `libtiff5:amd64=4.0.8-1`
