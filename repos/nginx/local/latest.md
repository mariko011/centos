...
### `dpkg` source package: `nginx=1.11.3-1~jessie`

Binary Packages:

- `nginx=1.11.3-1~jessie`
- `nginx-module-geoip=1.11.3-1~jessie`
- `nginx-module-image-filter=1.11.3-1~jessie`
- `nginx-module-njs=1.11.3.0.1.0-1~jessie`
- `nginx-module-perl=1.11.3-1~jessie`
- `nginx-module-xslt=1.11.3-1~jessie`
...
```
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx/nginx_1.11.3-1~jessie.dsc' nginx_1.11.3-1~jessie.dsc 1843 SHA256:db4df51ebd5d4d08bee768772823974dd35b5deb99cdb27a1a81f952758073a8
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx/nginx_1.11.3.orig.tar.gz' nginx_1.11.3.orig.tar.gz 938045 SHA256:4a667f40f9f3917069db1dea1f2d5baa612f1fa19378aadf71502e846a424610
'http://nginx.org/packages/mainline/debian/pool/nginx/n/nginx/nginx_1.11.3-1~jessie.debian.tar.xz' nginx_1.11.3-1~jessie.debian.tar.xz 128908 SHA256:357c259679424a694ddc40fa7c180b32230688af303b3f4c3005fd8c45d99da6
```
