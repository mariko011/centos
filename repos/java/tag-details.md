...
-	[`java:8u102-jdk`](#java8u102-jdk)
-	[`java:8u102`](#java8u102)
-	[`java:8-jdk`](#java8-jdk)
-	[`java:8`](#java8)
-	[`java:jdk`](#javajdk)
-	[`java:latest`](#javalatest)
-	[`java:openjdk-8u102-jdk`](#javaopenjdk-8u102-jdk)
-	[`java:openjdk-8u102`](#javaopenjdk-8u102)
...
-	[`java:8u102-jre`](#java8u102-jre)
-	[`java:8-jre`](#java8-jre)
-	[`java:jre`](#javajre)
-	[`java:openjdk-8u102-jre`](#javaopenjdk-8u102-jre)
...
-	[`java:9-b130-jdk`](#java9-b130-jdk)
-	[`java:9-b130`](#java9-b130)
-	[`java:9-jdk`](#java9-jdk)
-	[`java:9`](#java9)
-	[`java:openjdk-9-b130-jdk`](#javaopenjdk-9-b130-jdk)
-	[`java:openjdk-9-b130`](#javaopenjdk-9-b130)
-	[`java:openjdk-9-jdk`](#javaopenjdk-9-jdk)
-	[`java:openjdk-9`](#javaopenjdk-9)
-	[`java:9-b130-jre`](#java9-b130-jre)
-	[`java:9-jre`](#java9-jre)
-	[`java:openjdk-9-b130-jre`](#javaopenjdk-9-b130-jre)
...
```console
$ docker pull java@sha256:77a2b05f48c896035e85cbfa1a4d28612561be8dec1f25d86daf2a2742b1ffef
```
...
```console
$ docker pull java@sha256:0a16a00c637a640432195efcac360320a221052474dbd9b5c9c88df49dc3bb35
```
...
```console
$ docker pull java@sha256:b5353e915448b231fc72a2fff25ec1e784c02ffb474b7e55b58139aa5413223c
```
...
```console
$ docker pull java@sha256:1064e0e67166f8859dd7e1aa1104ffc00133bcf19dbd426447cce6f90319031e
```
...
```console
$ docker pull java@sha256:a12cf102b6116e81101741e3ae1c5e957dc4f5ff6a2d2cc9ab881e717371175e
```
...
-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **243.3 MB (243250950 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7919ba82fd04cd796d908751fb6a4ab204ff3c0c63a6407089021f5cde34f8a`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull java@sha256:05f61f6a681ebaf7a1ee15d11477e717ab5f4faa66ca7680f0d9f7a6fe4988f8
```
...
-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.1 MB (124145876 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a290b7fd4c4c5b323168975eb9b298b2918dcd0e5877fc3bd9d6701670f93dc`
-	Default Command: `["\/bin\/bash"]`
