...
- Created: `2016-08-31T21:06:21.510015661Z`
- Arch: `linux`/`amd64`
...
### `dpkg` source package: `bzr=2.7.0+bzr6619-1`

Binary Packages:

- `bzr=2.7.0+bzr6619-1`
- `python-bzrlib=2.7.0+bzr6619-1`
...
```
'http://httpredir.debian.org/debian/pool/main/b/bzr/bzr_2.7.0+bzr6619-1.dsc' bzr_2.7.0+bzr6619-1.dsc 2355 SHA256:8214b56531de4fd423adb32c453c0604d0191d6eddcfbd766abdeda9cebd64d6
...
'http://httpredir.debian.org/debian/pool/main/b/bzr/bzr_2.7.0+bzr6619-1.debian.tar.xz' bzr_2.7.0+bzr6619-1.debian.tar.xz 65580 SHA256:46f41420e8672ef6c52d1cb0d21afdf8b5cf51bfffe2bc6a5add58a03620861e
```
...
### `dpkg` source package: `mercurial=3.9-1`

Binary Packages:

- `mercurial=3.9-1`
- `mercurial-common=3.9-1`
...
### `dpkg` source package: `nghttp2=1.14.0-1`

Binary Packages:

- `libnghttp2-14:amd64=1.14.0-1`
...
```
'http://httpredir.debian.org/debian/pool/main/n/nghttp2/nghttp2_1.14.0-1.dsc' nghttp2_1.14.0-1.dsc 2224 SHA256:5cec5f368ce01083c549c51cc8e9bcfb632fad2ab01ed9c930e7a03465d0b1a2
'http://httpredir.debian.org/debian/pool/main/n/nghttp2/nghttp2_1.14.0.orig.tar.bz2' nghttp2_1.14.0.orig.tar.bz2 1757883 SHA256:9516918c1bda50b7d09c308926448ca756b887ee051c94fe6835749ca41eaba2
'http://httpredir.debian.org/debian/pool/main/n/nghttp2/nghttp2_1.14.0-1.debian.tar.xz' nghttp2_1.14.0-1.debian.tar.xz 11260 SHA256:6f77eb4179bc585a50a5e3732a7e376a06dec51fe89a0635aec7f064baf5ee72
```

Likely also available for browsing at:

- https://sources.debian.net/src/nghttp2/1.14.0-1/
- https://sources.debian.net/src/nghttp2/1.14.0-1/debian/copyright (for direct copyright/license information)
...
### `dpkg` source package: `nss=2:3.26-1`

Binary Packages:

- `libnss3:amd64=2:3.26-1`
...
### `dpkg` source package: `python2.7=2.7.12-2`

Binary Packages:

- `libpython2.7-minimal:amd64=2.7.12-2`
- `libpython2.7-stdlib:amd64=2.7.12-2`
- `python2.7=2.7.12-2`
- `python2.7-minimal=2.7.12-2`
...
### `dpkg` source package: `serf=1.3.8-3`

Binary Packages:

- `libserf-1-1:amd64=1.3.8-3`
...
### `dpkg` source package: `subversion=1.9.4-2`

Binary Packages:

- `libsvn1:amd64=1.9.4-2`
- `subversion=1.9.4-2`
...
- `libsystemd0:amd64=231-5`
- `libudev1:amd64=231-5`
...
```
'http://httpredir.debian.org/debian/pool/main/s/systemd/systemd_231-5.dsc' systemd_231-5.dsc 4436 SHA256:a5acf6b2f8e8fc70a71ea8ac94c084084da634beab313199e5f8545dc3d44557
...
'http://httpredir.debian.org/debian/pool/main/s/systemd/systemd_231-5.debian.tar.xz' systemd_231-5.debian.tar.xz 129864 SHA256:1978c5709dad9f6412318be953ae9e0734e31ea5501b2b015a40222a76ba2569
```

Likely also available for browsing at:

- https://sources.debian.net/src/systemd/231-5/
- https://sources.debian.net/src/systemd/231-5/debian/copyright (for direct copyright/license information)
