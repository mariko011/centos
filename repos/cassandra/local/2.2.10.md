...
- Created: `2017-09-13T10:16:24.175398698Z`
- Virtual Size: ~ 366.25 Mb  
...
- https://sources.debian.net/src/autogen/1:5.18.4-3/ (for browsing the source)
- https://sources.debian.net/src/autogen/1:5.18.4-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/autogen/1:5.18.4-3/ (for access to the source package after it no longer exists in the archive)
...
- https://sources.debian.net/src/jemalloc/3.6.0-3/ (for browsing the source)
- https://sources.debian.net/src/jemalloc/3.6.0-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/jemalloc/3.6.0-3/ (for access to the source package after it no longer exists in the archive)
...
- https://sources.debian.net/src/ntp/1:4.2.6.p5+dfsg-7+deb8u2/ (for browsing the source)
- https://sources.debian.net/src/ntp/1:4.2.6.p5+dfsg-7+deb8u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ntp/1:4.2.6.p5+dfsg-7+deb8u2/ (for access to the source package after it no longer exists in the archive)
