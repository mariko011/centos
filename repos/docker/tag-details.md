...
```console
$ docker pull docker@sha256:52cbf9b7bc7efebbee4f92edeed07ef4b7c71812f7c8e73aebc7009586c903e5
```
...
```console
$ docker pull docker@sha256:03b2b45affd2e3b8ecc4c54310d738a28640b0285f33750a2d2d271ed211b6b9
```
