...
- Created: `2016-05-24T16:02:06.971718319Z`
- Arch: `linux`/`amd64`
...
### `dpkg` source package: `apt=1.0.1ubuntu2.13`

Binary Packages:

- `apt=1.0.1ubuntu2.13`
- `apt-utils=1.0.1ubuntu2.13`
- `libapt-inst1.5:amd64=1.0.1ubuntu2.13`
- `libapt-pkg4.12:amd64=1.0.1ubuntu2.13`
...
```console
$ apt-get source -qq --print-uris apt=1.0.1ubuntu2.13
'http://archive.ubuntu.com/ubuntu/pool/main/a/apt/apt_1.0.1ubuntu2.13.dsc' apt_1.0.1ubuntu2.13.dsc 2461 SHA256:7d8a1a49008d27c0b3e20ea0f8b16f73b6f3f1856b79b90663f5f74e65d81b3c
'http://archive.ubuntu.com/ubuntu/pool/main/a/apt/apt_1.0.1ubuntu2.13.tar.xz' apt_1.0.1ubuntu2.13.tar.xz 1781844 SHA256:d9ad5116eb8de4e7e3da8408af3ed28630e0d074690fa43478ce2b5a22638872
```
...
### `dpkg` source package: `base-files=7.2ubuntu5.4`
...
### `dpkg` source package: `binutils=2.24-5ubuntu14`
...
Licenses: (parsed from: `/usr/share/doc/libc-ares-dev/copyright`, `/usr/share/doc/libc-ares2/copyright`)
...
'http://archive.ubuntu.com/ubuntu/pool/main/c/c-ares/c-ares_1.10.0-2.dsc' c-ares_1.10.0-2.dsc 1948 SHA256:bad707c795ac05cabbb6d564008bfe7c6775b82cb3cd9902685239915a2b97f2
'http://archive.ubuntu.com/ubuntu/pool/main/c/c-ares/c-ares_1.10.0.orig.tar.gz' c-ares_1.10.0.orig.tar.gz 809073 SHA256:3d701674615d1158e56a59aaede7891f2dde3da0f46a6d3c684e0ae70f52d3db
'http://archive.ubuntu.com/ubuntu/pool/main/c/c-ares/c-ares_1.10.0-2.debian.tar.gz' c-ares_1.10.0-2.debian.tar.gz 5295 SHA256:aef89b3b5bb7f1aae8332eea2f04930badb47f4e3582ec4dac9ba71256d8299a
```
...
### `dpkg` source package: `dpkg=1.17.5ubuntu5.6`
...
```console
$ apt-get source -qq --print-uris dpkg=1.17.5ubuntu5.6
'http://archive.ubuntu.com/ubuntu/pool/main/d/dpkg/dpkg_1.17.5ubuntu5.6.dsc' dpkg_1.17.5ubuntu5.6.dsc 2104 SHA256:40b5c5ffddaf7381a979adb74bfd524289a8647269bbc9ae2e6b0ba9a3e3ae34
'http://archive.ubuntu.com/ubuntu/pool/main/d/dpkg/dpkg_1.17.5ubuntu5.6.tar.xz' dpkg_1.17.5ubuntu5.6.tar.xz 3843084 SHA256:26d1d9bbccc4cc5bbb6baf04e3282c981b11691ee4d44480cdb4db830c4347e8
```
...
### `dpkg` source package: `eglibc=2.19-0ubuntu6.7`
...
### `dpkg` source package: `expat=2.1.0-4ubuntu1.1`
...
### `dpkg` source package: `gcc-4.8=4.8.4-2ubuntu1~14.04.1`
...
### `dpkg` source package: `gnupg=1.4.16-1ubuntu2.3`
...
### `dpkg` source package: `gyp=0.1~svn1729-3ubuntu1`

Binary Packages:

- `gyp=0.1~svn1729-3ubuntu1`
...
```console
$ apt-get source -qq --print-uris gyp=0.1~svn1729-3ubuntu1
'http://archive.ubuntu.com/ubuntu/pool/universe/g/gyp/gyp_0.1~svn1729-3ubuntu1.dsc' gyp_0.1~svn1729-3ubuntu1.dsc 1303 SHA256:e30abb9f1bca6f24792495bc5eae7a47d7f387f6d4c1fa31391afd8e56a6520f
'http://archive.ubuntu.com/ubuntu/pool/universe/g/gyp/gyp_0.1~svn1729.orig.tar.gz' gyp_0.1~svn1729.orig.tar.gz 508501 SHA256:7d7994b759a03f3a8529845602b5e0c549e640dd9789bf00fdab0ee029698bf6
'http://archive.ubuntu.com/ubuntu/pool/universe/g/gyp/gyp_0.1~svn1729-3ubuntu1.debian.tar.gz' gyp_0.1~svn1729-3ubuntu1.debian.tar.gz 6645 SHA256:d60cf61571adb8eb98450bbe715dbcdfb07a5b6d22aa0c25b2d30121d59492e0
```
...
### `dpkg` source package: `initramfs-tools=0.103ubuntu4.3`
...
### `dpkg` source package: `isc-dhcp=4.2.4-7ubuntu12.4`
...
```console
$ apt-get source -qq --print-uris isc-dhcp=4.2.4-7ubuntu12.4
'http://archive.ubuntu.com/ubuntu/pool/main/i/isc-dhcp/isc-dhcp_4.2.4-7ubuntu12.4.dsc' isc-dhcp_4.2.4-7ubuntu12.4.dsc 2720 SHA256:b68d69e75a9f809d5e7dcfb87a40078877bf058ca265af39e4e836df8e288165
...
'http://archive.ubuntu.com/ubuntu/pool/main/i/isc-dhcp/isc-dhcp_4.2.4-7ubuntu12.4.debian.tar.gz' isc-dhcp_4.2.4-7ubuntu12.4.debian.tar.gz 136001 SHA256:6a88070c19a6c0f6834475933950cd0c60bd7f19cfb835866eed07e857bdb70c
```
...
### `dpkg` source package: `jemalloc=3.5.1-2`
...
```console
$ apt-get source -qq --print-uris jemalloc=3.5.1-2
'http://archive.ubuntu.com/ubuntu/pool/universe/j/jemalloc/jemalloc_3.5.1-2.dsc' jemalloc_3.5.1-2.dsc 1355 SHA256:87274409ee08a4d4f741fb46c7511bc1313c21335694acb8d7c7214004471758
'http://archive.ubuntu.com/ubuntu/pool/universe/j/jemalloc/jemalloc_3.5.1.orig.tar.bz2' jemalloc_3.5.1.orig.tar.bz2 336555 SHA256:1a09f2570167ebc5fba4ddcc09176575d8acbb77017faf27797b9ab7f38f349f
'http://archive.ubuntu.com/ubuntu/pool/universe/j/jemalloc/jemalloc_3.5.1-2.debian.tar.xz' jemalloc_3.5.1-2.debian.tar.xz 10596 SHA256:f4ccf84dd37140d608fe4e1177d4eb4d78af7b733d331bfbf2bf1ae719fb274a
```
...
### `dpkg` source package: `klibc=2.0.3-0ubuntu1`
...
```console
$ apt-get source -qq --print-uris klibc=2.0.3-0ubuntu1
'http://archive.ubuntu.com/ubuntu/pool/main/k/klibc/klibc_2.0.3-0ubuntu1.dsc' klibc_2.0.3-0ubuntu1.dsc 1631 SHA256:00b929867efeabab2ff4548b8b8cd1cac79f167e9b849df080dc86aa1d2343b3
...
'http://archive.ubuntu.com/ubuntu/pool/main/k/klibc/klibc_2.0.3-0ubuntu1.debian.tar.gz' klibc_2.0.3-0ubuntu1.debian.tar.gz 21853 SHA256:413467087f93d0922ff1aab6dd12f3e24986f4e1790802c1f502d1ea61774a9f
```
...
### `dpkg` source package: `libdrm=2.4.64-1~ubuntu14.04.1`
...
### `dpkg` source package: `libgcrypt11=1.5.3-2ubuntu4.3`
...
### `dpkg` source package: `libv8-3.14=3.14.5.8-5ubuntu2`

Binary Packages:

- `libv8-3.14-dev=3.14.5.8-5ubuntu2`
- `libv8-3.14.5=3.14.5.8-5ubuntu2`

Licenses: (parsed from: `/usr/share/doc/libv8-3.14-dev/copyright`, `/usr/share/doc/libv8-3.14.5/copyright`)
...
```console
$ apt-get source -qq --print-uris libv8-3.14=3.14.5.8-5ubuntu2
'http://archive.ubuntu.com/ubuntu/pool/universe/libv/libv8-3.14/libv8-3.14_3.14.5.8-5ubuntu2.dsc' libv8-3.14_3.14.5.8-5ubuntu2.dsc 1698 SHA256:9ed26bef3a7ed8efa0be2e3ee5a86bb835847da8bed3dcc24f3de3e28e6b5076
'http://archive.ubuntu.com/ubuntu/pool/universe/libv/libv8-3.14/libv8-3.14_3.14.5.8.orig.tar.gz' libv8-3.14_3.14.5.8.orig.tar.gz 11711639 SHA256:a3316c181a31139ac80013d436d8d217cec72ddf22f2bb3c8b22d02bdf4780fd
'http://archive.ubuntu.com/ubuntu/pool/universe/libv/libv8-3.14/libv8-3.14_3.14.5.8-5ubuntu2.debian.tar.gz' libv8-3.14_3.14.5.8-5ubuntu2.debian.tar.gz 443079 SHA256:d51041a87c7168ce207cea3a95b7dac3cb9c1cde9b4bb17a09a4ca748f3c56d4
```

### `dpkg` source package: `linux=3.13.0-85.129`

Binary Packages:

- `linux-libc-dev:amd64=3.13.0-85.129`
...
### `dpkg` source package: `lsb=4.1+Debian11ubuntu6`
...
```console
$ apt-get source -qq --print-uris lsb=4.1+Debian11ubuntu6
'http://archive.ubuntu.com/ubuntu/pool/main/l/lsb/lsb_4.1+Debian11ubuntu6.dsc' lsb_4.1+Debian11ubuntu6.dsc 1679 SHA256:e71eb42e4b04d4d2d27cfe0dbafb5da26352584c345ca7ab6986ef12557643a2
'http://archive.ubuntu.com/ubuntu/pool/main/l/lsb/lsb_4.1+Debian11ubuntu6.tar.xz' lsb_4.1+Debian11ubuntu6.tar.xz 65460 SHA256:616f68e07707370ce7311a98e67eb66144d2bdee00025cbe46f5bcb412f4bcd4
```
...
### `dpkg` source package: `node-abbrev=1.0.4-2`
...
```console
$ apt-get source -qq --print-uris node-abbrev=1.0.4-2
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-abbrev/node-abbrev_1.0.4-2.dsc' node-abbrev_1.0.4-2.dsc 1968 SHA256:3e198305554f9eeed746f5a1f72571e5a2f9212b6ba936229d86d3aefd1f8a0d
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-abbrev/node-abbrev_1.0.4.orig.tar.gz' node-abbrev_1.0.4.orig.tar.gz 2454 SHA256:8bc8855e8e8eede38f28494e407bdeff5dd44583a917e4a7668034a6013a47de
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-abbrev/node-abbrev_1.0.4-2.debian.tar.gz' node-abbrev_1.0.4-2.debian.tar.gz 2077 SHA256:2bbaa79b68c6bdf7e54eb7d26561f57a5509e4c851b28e0d86ef3bd008d02907
```

### `dpkg` source package: `node-ansi=0.2.1-1`
...
```console
$ apt-get source -qq --print-uris node-ansi=0.2.1-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-ansi/node-ansi_0.2.1-1.dsc' node-ansi_0.2.1-1.dsc 1949 SHA256:6ada129d6445fc43d4bfbc5066bc96d25281f45c186e6c66cab5e182f0e94816
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-ansi/node-ansi_0.2.1.orig.tar.gz' node-ansi_0.2.1.orig.tar.gz 6983 SHA256:c65095e8fb4beb27e2139fce7c3b5b3e1cbd95c258ddb2c2efeb82a2b519529a
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-ansi/node-ansi_0.2.1-1.debian.tar.gz' node-ansi_0.2.1-1.debian.tar.gz 2208 SHA256:0f5a690653e6d7d4aa004aa45484b2342ae8d2091edc53d7927e1e77c3019310
```

### `dpkg` source package: `node-archy=0.0.2-1`
...
```console
$ apt-get source -qq --print-uris node-archy=0.0.2-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-archy/node-archy_0.0.2-1.dsc' node-archy_0.0.2-1.dsc 1945 SHA256:82d430fe0450d1bcc6f23fdeb1495d5974cfa2356c7f0366dcd89867be5f7e71
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-archy/node-archy_0.0.2.orig.tar.gz' node-archy_0.0.2.orig.tar.gz 2378 SHA256:eee0a68b448da1a24e23d70c09cd1c3388d65fcdf664faba39a1daa9c4bff082
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-archy/node-archy_0.0.2-1.debian.tar.gz' node-archy_0.0.2-1.debian.tar.gz 1918 SHA256:43c2bc2a26d0ae0ace0a54877b8e155357992c4bb0ea88811e2d31b3522eded2
```

### `dpkg` source package: `node-async=0.2.5-1`

Binary Packages:

- `node-async=0.2.5-1`

Licenses: (parsed from: `/usr/share/doc/node-async/copyright`)
...
```console
$ apt-get source -qq --print-uris node-async=0.2.5-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-async/node-async_0.2.5-1.dsc' node-async_0.2.5-1.dsc 2021 SHA256:28aa12b145151e2fccee1d44bea6b5889826968bd5e64e3d1331236e56b87507
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-async/node-async_0.2.5.orig.tar.gz' node-async_0.2.5.orig.tar.gz 37391 SHA256:187411a04d43b2490e8073eb78bbfe0a13b2cb9e741984121deafeb9404500f0
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-async/node-async_0.2.5-1.debian.tar.gz' node-async_0.2.5-1.debian.tar.gz 4689 SHA256:6b8a29db9f73922aa5d0faae2e7391d1d154bdf8fec05dbffc69f6863cf3ee6a
```

### `dpkg` source package: `node-block-stream=0.0.7-1`

Binary Packages:

- `node-block-stream=0.0.7-1`

Licenses: (parsed from: `/usr/share/doc/node-block-stream/copyright`)
...
```console
$ apt-get source -qq --print-uris node-block-stream=0.0.7-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-block-stream/node-block-stream_0.0.7-1.dsc' node-block-stream_0.0.7-1.dsc 2037 SHA256:1b650948fb327463662f1a68e4e2def4f63baaad81e683180f79e03819aee4a7
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-block-stream/node-block-stream_0.0.7.orig.tar.gz' node-block-stream_0.0.7.orig.tar.gz 5624 SHA256:16e38f996bd862b2b80756c7dc2204ddc4c7d86d29dfd069268872ab7c62d23a
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-block-stream/node-block-stream_0.0.7-1.debian.tar.gz' node-block-stream_0.0.7-1.debian.tar.gz 2123 SHA256:9cddea6f80d542ad87fbc1d6a90f2aeaa168013dd7c3255520814b95a4740610
```

### `dpkg` source package: `node-combined-stream=0.0.4-1`

Binary Packages:

- `node-combined-stream=0.0.4-1`
...
```console
$ apt-get source -qq --print-uris node-combined-stream=0.0.4-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-combined-stream/node-combined-stream_0.0.4-1.dsc' node-combined-stream_0.0.4-1.dsc 2076 SHA256:cc401ef47429f2d91bedf5e2ce6c7887b276d4c5cc8a84a2b436903b85a16ed7
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-combined-stream/node-combined-stream_0.0.4.orig.tar.gz' node-combined-stream_0.0.4.orig.tar.gz 5899 SHA256:2e0a8ed42c33cd5aee8bd84572499fad46306f39096ac408d05ea42da5888950
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-combined-stream/node-combined-stream_0.0.4-1.debian.tar.gz' node-combined-stream_0.0.4-1.debian.tar.gz 1991 SHA256:d3a97ad5585a414b936bc6c0d2d207d3c3437bfaca7ea3d8946ced4e0a91d39a
```

### `dpkg` source package: `node-cookie-jar=0.3.1-1`

Binary Packages:

- `node-cookie-jar=0.3.1-1`

Licenses: (parsed from: `/usr/share/doc/node-cookie-jar/copyright`)
...
```console
$ apt-get source -qq --print-uris node-cookie-jar=0.3.1-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-cookie-jar/node-cookie-jar_0.3.1-1.dsc' node-cookie-jar_0.3.1-1.dsc 2010 SHA256:884efc9fec3b7d4bbe13032da26ed88d52118ff521ca66343ae133c25e06bde9
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-cookie-jar/node-cookie-jar_0.3.1.orig.tar.gz' node-cookie-jar_0.3.1.orig.tar.gz 6062 SHA256:15945a12d22e3b921c152c60941381d358b5f1d765b758a79fecf1fefca2a8b6
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-cookie-jar/node-cookie-jar_0.3.1-1.debian.tar.gz' node-cookie-jar_0.3.1-1.debian.tar.gz 2234 SHA256:8f235e4771793bedf5de87b9995f68cc1c8e5f9f972b0bf323fb21ad65a80c3d
```
...
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-delayed-stream/node-delayed-stream_0.0.5-1.dsc' node-delayed-stream_0.0.5-1.dsc 2064 SHA256:651b48396d424650508c9311cc34b8aabecf7600e45f5a152921ed8b94469431
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-delayed-stream/node-delayed-stream_0.0.5.orig.tar.gz' node-delayed-stream_0.0.5.orig.tar.gz 4807 SHA256:9362f8265dca41254613a73e7239da14b3bbad2740437c7158ac628dba2a4c1a
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-delayed-stream/node-delayed-stream_0.0.5-1.debian.tar.gz' node-delayed-stream_0.0.5-1.debian.tar.gz 1960 SHA256:a9e52e81c50d6b754db310bda3dbccd84fd705f2b53148de8f1e57dd1dece7c7
```

### `dpkg` source package: `node-forever-agent=0.5.1-1`
...
```console
$ apt-get source -qq --print-uris node-forever-agent=0.5.1-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-forever-agent/node-forever-agent_0.5.1-1.dsc' node-forever-agent_0.5.1-1.dsc 2046 SHA256:6cef893bdb59753accf4c31af6810fec99da9f1ac58d548de505ef600ead8e4e
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-forever-agent/node-forever-agent_0.5.1.orig.tar.gz' node-forever-agent_0.5.1.orig.tar.gz 4976 SHA256:bad380236c6c5e7e6ccb8cba82e7769384b2162057af650f0e4e917d3c78ccaf
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-forever-agent/node-forever-agent_0.5.1-1.debian.tar.gz' node-forever-agent_0.5.1-1.debian.tar.gz 1612 SHA256:2a05215e1f4788ecdb1d9993b2d31f628de2d902f326bb0ad279c92cc00c5104
```

### `dpkg` source package: `node-form-data=0.1.0-1`
...
```console
$ apt-get source -qq --print-uris node-form-data=0.1.0-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-form-data/node-form-data_0.1.0-1.dsc' node-form-data_0.1.0-1.dsc 2010 SHA256:be37036c9aec9e865845cf959e1202b34ab13da4a4255239751618c70fb7655f
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-form-data/node-form-data_0.1.0.orig.tar.gz' node-form-data_0.1.0.orig.tar.gz 28281 SHA256:2e386ec04e84e799e23fbec2037c24efe68411644e8e80b5409ef1d027b27282
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-form-data/node-form-data_0.1.0-1.debian.tar.gz' node-form-data_0.1.0-1.debian.tar.gz 2038 SHA256:cf7a920bf37b0b622ba4733da8f50dac53ec20b3fcfae9f19323d03e3f3d4120
```

### `dpkg` source package: `node-fstream-ignore=0.0.6-2`

Binary Packages:

- `node-fstream-ignore=0.0.6-2`

Licenses: (parsed from: `/usr/share/doc/node-fstream-ignore/copyright`)
...
```console
$ apt-get source -qq --print-uris node-fstream-ignore=0.0.6-2
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-fstream-ignore/node-fstream-ignore_0.0.6-2.dsc' node-fstream-ignore_0.0.6-2.dsc 2046 SHA256:fa88effe5a8f8bfe127ab6d1ffadf32abf4900e805bbb3b4ce91d6cb29ee3bdd
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-fstream-ignore/node-fstream-ignore_0.0.6.orig.tar.gz' node-fstream-ignore_0.0.6.orig.tar.gz 6134 SHA256:f04a80cf87906d0c55f72855f2da9cccddace116fd20d4c0ec19764e3c3bdf47
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-fstream-ignore/node-fstream-ignore_0.0.6-2.debian.tar.gz' node-fstream-ignore_0.0.6-2.debian.tar.gz 2099 SHA256:710af027428868c3c8ce983b742cc112733ee711f57c52f4d7d90acf7d51ad92
```

### `dpkg` source package: `node-fstream=0.1.24-1`

Binary Packages:

- `node-fstream=0.1.24-1`

Licenses: (parsed from: `/usr/share/doc/node-fstream/copyright`)
...
```console
$ apt-get source -qq --print-uris node-fstream=0.1.24-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-fstream/node-fstream_0.1.24-1.dsc' node-fstream_0.1.24-1.dsc 1987 SHA256:b863f81d7d275d72abf0b7edb57ad9d130b2135261764f475823b389207518c5
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-fstream/node-fstream_0.1.24.orig.tar.gz' node-fstream_0.1.24.orig.tar.gz 17265 SHA256:023e6d3ce520106bdb8a15bd56793f206c1eca6dc0f8a7cd19e29f1d4562ed7d
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-fstream/node-fstream_0.1.24-1.debian.tar.gz' node-fstream_0.1.24-1.debian.tar.gz 2330 SHA256:00f6228bf1b11ff005db6ecc4f9bfb1a21c6348e9460f8a043395036965fb244
```

### `dpkg` source package: `node-github-url-from-git=1.1.1-1`

Binary Packages:

- `node-github-url-from-git=1.1.1-1`

Licenses: (parsed from: `/usr/share/doc/node-github-url-from-git/copyright`)
...
```console
$ apt-get source -qq --print-uris node-github-url-from-git=1.1.1-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-github-url-from-git/node-github-url-from-git_1.1.1-1.dsc' node-github-url-from-git_1.1.1-1.dsc 2117 SHA256:d75e6d20c6469cced14c525759281f99ea01f5852b2c34d1b9abc71b9713dd03
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-github-url-from-git/node-github-url-from-git_1.1.1.orig.tar.gz' node-github-url-from-git_1.1.1.orig.tar.gz 1217 SHA256:c2dff5515defdbae633a974925fa387ecb70081655cce20c6ee972fc13947c19
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-github-url-from-git/node-github-url-from-git_1.1.1-1.debian.tar.gz' node-github-url-from-git_1.1.1-1.debian.tar.gz 1962 SHA256:2d003afa3b9ecfc119fb42ab7f484a413a9994bb7e0251c4979f479f0d983639
```

### `dpkg` source package: `node-glob=3.2.6-1`
...
```console
$ apt-get source -qq --print-uris node-glob=3.2.6-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-glob/node-glob_3.2.6-1.dsc' node-glob_3.2.6-1.dsc 1982 SHA256:75e2a9d69a543bd49da6a5f642316afd5a839e783381c728f916a4c4532553d3
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-glob/node-glob_3.2.6.orig.tar.gz' node-glob_3.2.6.orig.tar.gz 16312 SHA256:ccfe9f3ac4bf84fe6c577cd0af66b7e0f025d36f0551730dbae2e390c53e7689
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-glob/node-glob_3.2.6-1.debian.tar.gz' node-glob_3.2.6-1.debian.tar.gz 2886 SHA256:23b7671b0dc2ecbc7897d949e8b2028fc0d43648acdff3a50c0ebadaeec7b459
```

### `dpkg` source package: `node-graceful-fs=2.0.0-2`

Binary Packages:

- `node-graceful-fs=2.0.0-2`
...
```console
$ apt-get source -qq --print-uris node-graceful-fs=2.0.0-2
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-graceful-fs/node-graceful-fs_2.0.0-2.dsc' node-graceful-fs_2.0.0-2.dsc 2069 SHA256:131a09e08f0c4d3d65f217c975674dfd9ceee8cbd25fc8593c20eb1982ee1e2f
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-graceful-fs/node-graceful-fs_2.0.0.orig.tar.gz' node-graceful-fs_2.0.0.orig.tar.gz 5129 SHA256:f026fdd65d65775166be17d2441bc2df2dfb3819facc54eb807b888c1fa1e9ce
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-graceful-fs/node-graceful-fs_2.0.0-2.debian.tar.gz' node-graceful-fs_2.0.0-2.debian.tar.gz 2664 SHA256:22f21c4bfda5abaacdac0863c6c7796f51ae77e7038d530d7b102a720f5c863a
```

### `dpkg` source package: `node-gyp=0.10.10-2`
...
```console
$ apt-get source -qq --print-uris node-gyp=0.10.10-2
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-gyp/node-gyp_0.10.10-2.dsc' node-gyp_0.10.10-2.dsc 1959 SHA256:4d246d216ae82385e9a8e74159273964a022ea9df9a1706c8daf8f669f8f6900
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-gyp/node-gyp_0.10.10.orig.tar.gz' node-gyp_0.10.10.orig.tar.gz 318582 SHA256:1a99d7aecadeb08e674847030d8d9465fd403d543339351883ad65ab0463cb9f
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-gyp/node-gyp_0.10.10-2.debian.tar.gz' node-gyp_0.10.10-2.debian.tar.gz 5366 SHA256:25245c053ccfc0facb4d7b436c30c7fdc2042b14cb8c5e7f6da3d0c13137caa5
```

### `dpkg` source package: `node-inherits=2.0.0-1`

Binary Packages:

- `node-inherits=2.0.0-1`

Licenses: (parsed from: `/usr/share/doc/node-inherits/copyright`)
...
```console
$ apt-get source -qq --print-uris node-inherits=2.0.0-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-inherits/node-inherits_2.0.0-1.dsc' node-inherits_2.0.0-1.dsc 2035 SHA256:882782668ca107a39bdb4ba713dd8d1f67f733867d207d8dab908a490493667f
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-inherits/node-inherits_2.0.0.orig.tar.gz' node-inherits_2.0.0.orig.tar.gz 2086 SHA256:1918c652769db80f196ab43bcc41240afbcdeca7f99a0feaa4e19c7ba076de9e
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-inherits/node-inherits_2.0.0-1.debian.tar.gz' node-inherits_2.0.0-1.debian.tar.gz 1888 SHA256:fea1a7420ce0d4a0998bd77493c0ec5a7b32324af738e6e5704f9b8af8d8fa33
```

### `dpkg` source package: `node-ini=1.1.0-1`
...
```console
$ apt-get source -qq --print-uris node-ini=1.1.0-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-ini/node-ini_1.1.0-1.dsc' node-ini_1.1.0-1.dsc 1924 SHA256:294783c19bee5374abff79d7ca16f84ec9071fad3718322a56b2fd41230a67f7
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-ini/node-ini_1.1.0.orig.tar.gz' node-ini_1.1.0.orig.tar.gz 4999 SHA256:c75a2f7c8cf6526d4db0833867e9005249b0f9fa4a0ca1c09508d7ff64fac5e7
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-ini/node-ini_1.1.0-1.debian.tar.gz' node-ini_1.1.0-1.debian.tar.gz 1921 SHA256:40cda08cd1b369fa71eef9df248d33fed1018a98c5ae74a146b06cb1aad3b9cb
```

### `dpkg` source package: `node-json-stringify-safe=5.0.0-1`
...
```console
$ apt-get source -qq --print-uris node-json-stringify-safe=5.0.0-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-json-stringify-safe/node-json-stringify-safe_5.0.0-1.dsc' node-json-stringify-safe_5.0.0-1.dsc 2121 SHA256:031c4ddf4463350ea4377278d2552895f99479c2dc754456a1f20bacf64cf739
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-json-stringify-safe/node-json-stringify-safe_5.0.0.orig.tar.gz' node-json-stringify-safe_5.0.0.orig.tar.gz 2786 SHA256:0f5a63d2c1196f3ebc5e8007c5f16aff43b3d2c06a27d28857d0f99d34e2c369
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-json-stringify-safe/node-json-stringify-safe_5.0.0-1.debian.tar.gz' node-json-stringify-safe_5.0.0-1.debian.tar.gz 2126 SHA256:73b8a685917a3a42bec426982d2f470f98291e36198f0e7e43726dd06c00094e
```

### `dpkg` source package: `node-lockfile=0.4.1-1`
...
```console
$ apt-get source -qq --print-uris node-lockfile=0.4.1-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-lockfile/node-lockfile_0.4.1-1.dsc' node-lockfile_0.4.1-1.dsc 1989 SHA256:3790bdc406f7a1e2b401c67bcf89c58cdc8b3439d3fe4a83af659786d5724eff
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-lockfile/node-lockfile_0.4.1.orig.tar.gz' node-lockfile_0.4.1.orig.tar.gz 5853 SHA256:a7d0f61c9101461552ce4871eea900acfc8dc08a4cdf2d5d1c55ed81092beafc
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-lockfile/node-lockfile_0.4.1-1.debian.tar.gz' node-lockfile_0.4.1-1.debian.tar.gz 2050 SHA256:809915219af241bebaeb111035c5cda19dd176e9bcbf3c9e0674222ec1db69e9
```

### `dpkg` source package: `node-lru-cache=2.3.1-1`
...
```console
$ apt-get source -qq --print-uris node-lru-cache=2.3.1-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-lru-cache/node-lru-cache_2.3.1-1.dsc' node-lru-cache_2.3.1-1.dsc 2054 SHA256:41ff0a0149a8907734ddba0232b350e52e67e3e13384392c9c9fdb24e1031086
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-lru-cache/node-lru-cache_2.3.1.orig.tar.gz' node-lru-cache_2.3.1.orig.tar.gz 6533 SHA256:b7d127456ff19c94dee233c80880e0029f927d353db81255847f421059d9c80a
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-lru-cache/node-lru-cache_2.3.1-1.debian.tar.gz' node-lru-cache_2.3.1-1.debian.tar.gz 2128 SHA256:e4716698a3cc6d8c4f65ead0cb4d3ca113e9a336337a81b4ab7d55744076362e
```

### `dpkg` source package: `node-mime=1.2.11-1`
...
```console
$ apt-get source -qq --print-uris node-mime=1.2.11-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-mime/node-mime_1.2.11-1.dsc' node-mime_1.2.11-1.dsc 1390 SHA256:2ec2728fb4383d9cdda891d73fda04515decadfdf27a23d2ef84236da1f23e0b
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-mime/node-mime_1.2.11.orig.tar.gz' node-mime_1.2.11.orig.tar.gz 18995 SHA256:eac433edc08be565b850d2f034b0fa887cab758518d9212ae286d3cc089db717
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-mime/node-mime_1.2.11-1.debian.tar.gz' node-mime_1.2.11-1.debian.tar.gz 2696 SHA256:a6a02ec3ddcfc8ce2f31521b64093cb0bba5e5b0d935db243f5f72195beb511a
```

### `dpkg` source package: `node-minimatch=0.2.12-1`

Binary Packages:

- `node-minimatch=0.2.12-1`
...
```console
$ apt-get source -qq --print-uris node-minimatch=0.2.12-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-minimatch/node-minimatch_0.2.12-1.dsc' node-minimatch_0.2.12-1.dsc 2011 SHA256:67278cd64dea703deef5568526bdb4ae9593bdba8286f70aa391a28725d6e8bb
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-minimatch/node-minimatch_0.2.12.orig.tar.gz' node-minimatch_0.2.12.orig.tar.gz 17479 SHA256:cbd3005dfed75e5c169d083d98cf521a5da085fa793cabe6fdfc875840dbd17e
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-minimatch/node-minimatch_0.2.12-1.debian.tar.gz' node-minimatch_0.2.12-1.debian.tar.gz 2104 SHA256:d2d468a2da22702546051a4ed0dd41ee4887d5a5c65daa1814d20de652e47529
```

### `dpkg` source package: `node-mkdirp=0.3.5-1`
...
```console
$ apt-get source -qq --print-uris node-mkdirp=0.3.5-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-mkdirp/node-mkdirp_0.3.5-1.dsc' node-mkdirp_0.3.5-1.dsc 1393 SHA256:94d5a24c5057a601ed2e7fa2800eb66f52eb0e3328093d75c55f82281142aec1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-mkdirp/node-mkdirp_0.3.5.orig.tar.gz' node-mkdirp_0.3.5.orig.tar.gz 4199 SHA256:09fe8c3ce19a2dd20620bdcbfb446becc6e88880754a0f2c3b95504439f90c3b
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-mkdirp/node-mkdirp_0.3.5-1.debian.tar.gz' node-mkdirp_0.3.5-1.debian.tar.gz 2359 SHA256:e7cd37f0421d33c59613901db7f247a4be31f2f816b1c76e3ad15c966fa1bd62
```

### `dpkg` source package: `node-mute-stream=0.0.3-1`

Binary Packages:

- `node-mute-stream=0.0.3-1`
...
```console
$ apt-get source -qq --print-uris node-mute-stream=0.0.3-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-mute-stream/node-mute-stream_0.0.3-1.dsc' node-mute-stream_0.0.3-1.dsc 2010 SHA256:74aded401381fc3877b7f5bf84f3dee90af6bbd4746b22ded82a2e04422d31e4
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-mute-stream/node-mute-stream_0.0.3.orig.tar.gz' node-mute-stream_0.0.3.orig.tar.gz 3458 SHA256:c146d82f9a5cd9d78242fc2c0c3ff4002a5d2da4498d16dad1dcc82b8435af9d
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-mute-stream/node-mute-stream_0.0.3-1.debian.tar.gz' node-mute-stream_0.0.3-1.debian.tar.gz 1959 SHA256:dbc02197f0feadbdf7b640ba07a41668556b7736b474a9dc4ce22526f5a02707
```

### `dpkg` source package: `node-nopt=2.1.2-1`
...
```console
$ apt-get source -qq --print-uris node-nopt=2.1.2-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-nopt/node-nopt_2.1.2-1.dsc' node-nopt_2.1.2-1.dsc 1941 SHA256:fbc36eb8058b43d3bf1677bad2202282fde0d223653b4837eac4643d8645d2a4
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-nopt/node-nopt_2.1.2.orig.tar.gz' node-nopt_2.1.2.orig.tar.gz 9857 SHA256:c9da41c390a678aa251d967f8b64a66897a84cb2d67389f4c10e3a74afaa9152
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-nopt/node-nopt_2.1.2-1.debian.tar.gz' node-nopt_2.1.2-1.debian.tar.gz 2205 SHA256:011a95732c4402a157a8a754b86ff57fb6dd35947dae367f518678f43129ba80
```

### `dpkg` source package: `node-normalize-package-data=0.2.2-1`
...
```console
$ apt-get source -qq --print-uris node-normalize-package-data=0.2.2-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-normalize-package-data/node-normalize-package-data_0.2.2-1.dsc' node-normalize-package-data_0.2.2-1.dsc 2145 SHA256:bd8a166488fa8b81781468ea15bab75c4e8ae6b03c4f789d04d4a4771cb7b5c4
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-normalize-package-data/node-normalize-package-data_0.2.2.orig.tar.gz' node-normalize-package-data_0.2.2.orig.tar.gz 13642 SHA256:0ee710c1f99a07a768bb16f6fd545b4737e4bfb5401597f98fb51edb3e3dace8
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-normalize-package-data/node-normalize-package-data_0.2.2-1.debian.tar.gz' node-normalize-package-data_0.2.2-1.debian.tar.gz 2050 SHA256:cf7721ce582421072d04fac9a72eaece175b160ecbae34ae65d5c457d195bb5d
```

### `dpkg` source package: `node-npmlog=0.0.4-1`
...
```console
$ apt-get source -qq --print-uris node-npmlog=0.0.4-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-npmlog/node-npmlog_0.0.4-1.dsc' node-npmlog_0.0.4-1.dsc 1965 SHA256:545a4c74059eb4ad32a030fb4e92e9f77197e6eeb08db5a581474cf1ad57f487
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-npmlog/node-npmlog_0.0.4.orig.tar.gz' node-npmlog_0.0.4.orig.tar.gz 5385 SHA256:aa1855f7d570fe978dadaaff21ef4ba837d6a94d4c96ac60205064e80e0f3d92
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-npmlog/node-npmlog_0.0.4-1.debian.tar.gz' node-npmlog_0.0.4-1.debian.tar.gz 2124 SHA256:2a84cdd058a07f5181fe972334ca31f0d27eea0fa342e0cd9778bf1b725ccb79
```

### `dpkg` source package: `node-once=1.1.1-1`
...
```console
$ apt-get source -qq --print-uris node-once=1.1.1-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-once/node-once_1.1.1-1.dsc' node-once_1.1.1-1.dsc 1926 SHA256:f041be43c1743f3bcb6ced9620c0bd878a39d5344a458fbe30ab468543f23f8e
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-once/node-once_1.1.1.orig.tar.gz' node-once_1.1.1.orig.tar.gz 1880 SHA256:8317334ea44a9d47a948a3d7a9ffd68496c610e7bfe9134c46cc1209dcad0535
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-once/node-once_1.1.1-1.debian.tar.gz' node-once_1.1.1-1.debian.tar.gz 1869 SHA256:058a3eda0681694ac16a84b73817b84cc589927d2a4e8973baf60aa1137b666a
```

### `dpkg` source package: `node-osenv=0.0.3-1`
...
```console
$ apt-get source -qq --print-uris node-osenv=0.0.3-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-osenv/node-osenv_0.0.3-1.dsc' node-osenv_0.0.3-1.dsc 1938 SHA256:f543602a6448270b8d859e95e26f08eeb859588545ff702012ba9d0edd9f4abb
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-osenv/node-osenv_0.0.3.orig.tar.gz' node-osenv_0.0.3.orig.tar.gz 3600 SHA256:1260ba26db955cab91c5650a05cf4b685e71c963971518e2b7ff7b2cfc9838ce
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-osenv/node-osenv_0.0.3-1.debian.tar.gz' node-osenv_0.0.3-1.debian.tar.gz 1963 SHA256:6de8ad3939fc4e45c2ad50e27d0bf4aff846bd88add0302254f750ec6ad5ffce
```

### `dpkg` source package: `node-qs=0.6.5-1`
...
```console
$ apt-get source -qq --print-uris node-qs=0.6.5-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-qs/node-qs_0.6.5-1.dsc' node-qs_0.6.5-1.dsc 1973 SHA256:eee1c86dbd41503dec6a4326fc1d8d5b9973d97981dee3ee60841bb8c44568f3
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-qs/node-qs_0.6.5.orig.tar.gz' node-qs_0.6.5.orig.tar.gz 105099 SHA256:0fbf019149587538bae17185a5b476b057261a9c8c1cf845d3cf69803adce303
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-qs/node-qs_0.6.5-1.debian.tar.gz' node-qs_0.6.5-1.debian.tar.gz 2349 SHA256:e3bb75464031f0831b0a761755b59886b59b1740fb664975dd419c751478bed5
```

### `dpkg` source package: `node-read-package-json=1.1.3-1`

Binary Packages:

- `node-read-package-json=1.1.3-1`
...
```console
$ apt-get source -qq --print-uris node-read-package-json=1.1.3-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-read-package-json/node-read-package-json_1.1.3-1.dsc' node-read-package-json_1.1.3-1.dsc 2097 SHA256:2b601fbde76e5d9a0915609be3a7ddef3f08f98003da69cd46ebd1ceb3960efd
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-read-package-json/node-read-package-json_1.1.3.orig.tar.gz' node-read-package-json_1.1.3.orig.tar.gz 7016 SHA256:6aea72f3cd0404f02a7ccf6d97542bf3666eb6a0db4c7971fc257c92298a7f32
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-read-package-json/node-read-package-json_1.1.3-1.debian.tar.gz' node-read-package-json_1.1.3-1.debian.tar.gz 2056 SHA256:82f8a129321d0f1ef3cebdc1f8d9a5f181e56ef050fa1d3c133dd48329a9da91
```

### `dpkg` source package: `node-read=1.0.4-1`
...
```console
$ apt-get source -qq --print-uris node-read=1.0.4-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-read/node-read_1.0.4-1.dsc' node-read_1.0.4-1.dsc 1926 SHA256:9be3d2eb7692600e29e5ceaf421543755e41fd29ac74a79353ac0bf25256f550
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-read/node-read_1.0.4.orig.tar.gz' node-read_1.0.4.orig.tar.gz 4322 SHA256:35c64e3dd284e63b2f6b09dcdf44c4c758c8e095a95949f00b8c9173f197ad34
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-read/node-read_1.0.4-1.debian.tar.gz' node-read_1.0.4-1.debian.tar.gz 1962 SHA256:b5716992873f40c5914fa96e141f87290a6564004c8b8e2a88155220ae0c4bb4
```

### `dpkg` source package: `node-request=2.26.1-1`
...
```console
$ apt-get source -qq --print-uris node-request=2.26.1-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-request/node-request_2.26.1-1.dsc' node-request_2.26.1-1.dsc 2029 SHA256:46b78074e811e0fd4fab1bfdcddcec678beac4122020b43f28276271995f7460
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-request/node-request_2.26.1.orig.tar.gz' node-request_2.26.1.orig.tar.gz 100741 SHA256:0c463e6fc4e361bef15dadf3e2f141dea9a807f6fab670dc49a66ba46aa91af5
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-request/node-request_2.26.1-1.debian.tar.gz' node-request_2.26.1-1.debian.tar.gz 4742 SHA256:23f37c125c0d6b90fdbb668be9814fd7beded4d6cd1a805ade53ac87a8ff4dad
```

### `dpkg` source package: `node-retry=0.6.0-1`
...
```console
$ apt-get source -qq --print-uris node-retry=0.6.0-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-retry/node-retry_0.6.0-1.dsc' node-retry_0.6.0-1.dsc 1947 SHA256:f1bd38c225e4fd3a0cb5edc872fe4acfb480e99948601c94747af2f593734466
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-retry/node-retry_0.6.0.orig.tar.gz' node-retry_0.6.0.orig.tar.gz 10240 SHA256:983e676af24ff4dcbac396420fca3c195ce3b1de5f731f697888b4fe6b7bbd2a
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-retry/node-retry_0.6.0-1.debian.tar.gz' node-retry_0.6.0-1.debian.tar.gz 1990 SHA256:436d9602845d60214d1fd6afb23a78487269607bd46f87293cc62360f05edf02
```

### `dpkg` source package: `node-rimraf=2.2.2-2`
...
```console
$ apt-get source -qq --print-uris node-rimraf=2.2.2-2
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-rimraf/node-rimraf_2.2.2-2.dsc' node-rimraf_2.2.2-2.dsc 1965 SHA256:b3fd38683deb4e7723580928266d4c376b61a90ecea35ffa463292b2e0ab986a
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-rimraf/node-rimraf_2.2.2.orig.tar.gz' node-rimraf_2.2.2.orig.tar.gz 4045 SHA256:3e90b48e5ab5ee2c2c2e5d693381e71b6f1bcc3579e7f6e5684041d6b388e218
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-rimraf/node-rimraf_2.2.2-2.debian.tar.gz' node-rimraf_2.2.2-2.debian.tar.gz 2633 SHA256:897cf83a61003cd065a5391038645c318ebf76efdd29b985a27c410a4ed11acc
```

### `dpkg` source package: `node-semver=2.1.0-2`
...
```console
$ apt-get source -qq --print-uris node-semver=2.1.0-2
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-semver/node-semver_2.1.0-2.dsc' node-semver_2.1.0-2.dsc 2028 SHA256:506f50db4ad91cd25499f512b401f208d8f62ed48fd9c327503d66836e699902
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-semver/node-semver_2.1.0.orig.tar.gz' node-semver_2.1.0.orig.tar.gz 14595 SHA256:108d424dcc13ee6de11c463728e4a1d8ac4e1831c8e25cd8206e38002c60230f
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-semver/node-semver_2.1.0-2.debian.tar.gz' node-semver_2.1.0-2.debian.tar.gz 5535 SHA256:3628f6f6d72c4346275c2da12a6d005aaa0f8cc697ed2d4ea09d0758f8d99032
```

### `dpkg` source package: `node-sha=1.2.3-1`
...
```console
$ apt-get source -qq --print-uris node-sha=1.2.3-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-sha/node-sha_1.2.3-1.dsc' node-sha_1.2.3-1.dsc 1937 SHA256:f8f6d46fb136580c47cdd18332683604809aeb6b36522590f73fce242a389d3a
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-sha/node-sha_1.2.3.orig.tar.gz' node-sha_1.2.3.orig.tar.gz 4241 SHA256:bbd260ad2a9adfa4ba7eaef4ab54ac2721aedf884226d4c4d13daa44168d56d9
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-sha/node-sha_1.2.3-1.debian.tar.gz' node-sha_1.2.3-1.debian.tar.gz 2390 SHA256:54a7bffd74dc0f9eec42c7e0de3ccdcd13c3535ea746e532b45d1ea5e1b30018
```

### `dpkg` source package: `node-sigmund=1.0.0-1`

Binary Packages:

- `node-sigmund=1.0.0-1`

Licenses: (parsed from: `/usr/share/doc/node-sigmund/copyright`)
...
```console
$ apt-get source -qq --print-uris node-sigmund=1.0.0-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-sigmund/node-sigmund_1.0.0-1.dsc' node-sigmund_1.0.0-1.dsc 1962 SHA256:cc2fa1285dd83081b8647c00d5159b597aeb58483cd8e84ae9021b4a717ae1a6
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-sigmund/node-sigmund_1.0.0.orig.tar.gz' node-sigmund_1.0.0.orig.tar.gz 4158 SHA256:cc7366cb4c859e056674d3fd9a30660325af6b24da5b2ce652ad005680fc3271
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-sigmund/node-sigmund_1.0.0-1.debian.tar.gz' node-sigmund_1.0.0-1.debian.tar.gz 2009 SHA256:1727022a805eb064ce44918b8f0136f09f09699db579c06e3c89acea16360356
```

### `dpkg` source package: `node-slide=1.1.4-1`
...
```console
$ apt-get source -qq --print-uris node-slide=1.1.4-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-slide/node-slide_1.1.4-1.dsc' node-slide_1.1.4-1.dsc 1951 SHA256:fa6fe7ae280fcded31950ea8559ff5c24d5e69c175dd7074b3256fac3a555f7e
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-slide/node-slide_1.1.4.orig.tar.gz' node-slide_1.1.4.orig.tar.gz 4636 SHA256:b65351f6196b325e991eb2a6afe91ea6de709cd416ec53d07be6a8d8734c8b21
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-slide/node-slide_1.1.4-1.debian.tar.gz' node-slide_1.1.4-1.debian.tar.gz 2109 SHA256:15c65305ea8b2f004935715eb0e2cf452cc207e2b65a6d32e5d2e2612067a04c
```

### `dpkg` source package: `node-tar=0.1.18-1`
...
```console
$ apt-get source -qq --print-uris node-tar=0.1.18-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-tar/node-tar_0.1.18-1.dsc' node-tar_0.1.18-1.dsc 1944 SHA256:804898b418b874cd129110c11247befe57cd12c9dd2c50ae593559db28b43581
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-tar/node-tar_0.1.18.orig.tar.gz' node-tar_0.1.18.orig.tar.gz 44706 SHA256:e45ba9c4e43f903f97c522edf72cab913ab65f9592676d4c72f6e83b19a85bd8
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-tar/node-tar_0.1.18-1.debian.tar.gz' node-tar_0.1.18-1.debian.tar.gz 2242 SHA256:bb87d176bdfb0627267a4375dff5b0aa12de55cbd4ea947f1484ca359f4d9fc4
```

### `dpkg` source package: `node-tunnel-agent=0.3.1-1`
...
```console
$ apt-get source -qq --print-uris node-tunnel-agent=0.3.1-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-tunnel-agent/node-tunnel-agent_0.3.1-1.dsc' node-tunnel-agent_0.3.1-1.dsc 2034 SHA256:1023f542ef3cdf4d1c9b4d89695bd19c0bca1ed01deb17f18b7fd8277439877d
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-tunnel-agent/node-tunnel-agent_0.3.1.orig.tar.gz' node-tunnel-agent_0.3.1.orig.tar.gz 5836 SHA256:52030bdb62043ebf528a3ea32e7b6f12b2d82746e9211eaaa6b8b81df6138da2
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-tunnel-agent/node-tunnel-agent_0.3.1-1.debian.tar.gz' node-tunnel-agent_0.3.1-1.debian.tar.gz 1601 SHA256:e314dda530d2a194b5b9eec6727b227123c4a50c675101435385068c309b14a7
```

### `dpkg` source package: `node-uuid=1.4.0-1`
...
Licenses: (parsed from: `/usr/share/doc/libjs-node-uuid/copyright`, `/usr/share/doc/node-node-uuid/copyright`)
...
```console
$ apt-get source -qq --print-uris node-uuid=1.4.0-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-uuid/node-uuid_1.4.0-1.dsc' node-uuid_1.4.0-1.dsc 2028 SHA256:a57c570bdba6395470471fec483d5d95d1a0dae2a910cd113373a20a5e791c99
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-uuid/node-uuid_1.4.0.orig.tar.gz' node-uuid_1.4.0.orig.tar.gz 12555 SHA256:1f7a304808044206d46b0d042baa3eb9475106dd11a343eaa77c0f9bc06d2f29
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-uuid/node-uuid_1.4.0-1.debian.tar.gz' node-uuid_1.4.0-1.debian.tar.gz 4820 SHA256:221d7ce91bdd1b8776a537fbf6506db4c11f29a6aa2e15ed4e944c5a5b3a33e0
```

### `dpkg` source package: `node-which=1.0.5-2`
...
```console
$ apt-get source -qq --print-uris node-which=1.0.5-2
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-which/node-which_1.0.5-2.dsc' node-which_1.0.5-2.dsc 1943 SHA256:3a259ba025ee46b2cfbe3d48f878da7e45b42073fa98d1b9275ce5dfaaa7d159
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-which/node-which_1.0.5.orig.tar.gz' node-which_1.0.5.orig.tar.gz 2505 SHA256:62ddf94ff9c77495266002a8a6d44135afe1504b655db4d5bbd1f255f22821b1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/node-which/node-which_1.0.5-2.debian.tar.gz' node-which_1.0.5-2.debian.tar.gz 2007 SHA256:75c605dc2fe8c01a67bf3b2a4946b7ecc4e5917b0540268e9cf9657ac39215b4
```

### `dpkg` source package: `nodejs=0.10.25~dfsg2-2ubuntu1`

Binary Packages:

- `nodejs=0.10.25~dfsg2-2ubuntu1`
- `nodejs-dev=0.10.25~dfsg2-2ubuntu1`

Licenses: (parsed from: `/usr/share/doc/nodejs/copyright`, `/usr/share/doc/nodejs-dev/copyright`)
...
```console
$ apt-get source -qq --print-uris nodejs=0.10.25~dfsg2-2ubuntu1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/nodejs/nodejs_0.10.25~dfsg2-2ubuntu1.dsc' nodejs_0.10.25~dfsg2-2ubuntu1.dsc 1799 SHA256:68144b48677c6ccbe096780e0be84ab11a85117314dea195a78d4396794adc71
'http://archive.ubuntu.com/ubuntu/pool/universe/n/nodejs/nodejs_0.10.25~dfsg2.orig.tar.gz' nodejs_0.10.25~dfsg2.orig.tar.gz 6281646 SHA256:3e48428e8e3611446c00554676c3a6cc24b358a88d3e216e3de1f8c17fb07f3b
'http://archive.ubuntu.com/ubuntu/pool/universe/n/nodejs/nodejs_0.10.25~dfsg2-2ubuntu1.debian.tar.gz' nodejs_0.10.25~dfsg2-2ubuntu1.debian.tar.gz 50399 SHA256:24fd1b05c88a622be255ab7ff61af92b1d17d385af5e44aed0f5d63ed336f11b
```

### `dpkg` source package: `npm=1.3.10~dfsg-1`
...
```console
$ apt-get source -qq --print-uris npm=1.3.10~dfsg-1
'http://archive.ubuntu.com/ubuntu/pool/universe/n/npm/npm_1.3.10~dfsg-1.dsc' npm_1.3.10~dfsg-1.dsc 1998 SHA256:d8e1a1f38bab1bd0069bdbffbb1506965f4ff48d38016ac2ef2856801f5b753c
'http://archive.ubuntu.com/ubuntu/pool/universe/n/npm/npm_1.3.10~dfsg.orig.tar.gz' npm_1.3.10~dfsg.orig.tar.gz 945236 SHA256:d8905b953f55f397ae307d9a7d7f0d193dfd64ab63ce63ab278d0dafb18b6d5a
'http://archive.ubuntu.com/ubuntu/pool/universe/n/npm/npm_1.3.10~dfsg-1.debian.tar.gz' npm_1.3.10~dfsg-1.debian.tar.gz 17603 SHA256:f5e5b4a6dc861165f4a61e582c7c986858164cb9c9f78348aa792bf08036829f
```
...
### `dpkg` source package: `python-meld3=0.6.10-1`

Binary Packages:

- `python-meld3=0.6.10-1`

Licenses: (parsed from: `/usr/share/doc/python-meld3/copyright`)
...
```console
$ apt-get source -qq --print-uris python-meld3=0.6.10-1
'http://archive.ubuntu.com/ubuntu/pool/universe/p/python-meld3/python-meld3_0.6.10-1.dsc' python-meld3_0.6.10-1.dsc 1803 SHA256:b68e64a50401c2b1875ae8df39fee9686eed3e991e346f068b8049688584c5bb
'http://archive.ubuntu.com/ubuntu/pool/universe/p/python-meld3/python-meld3_0.6.10.orig.tar.gz' python-meld3_0.6.10.orig.tar.gz 41408 SHA256:6642f2444f3527a9338104edc2d1b420ba5a770b578063f729530d1f2f01a271
'http://archive.ubuntu.com/ubuntu/pool/universe/p/python-meld3/python-meld3_0.6.10-1.debian.tar.gz' python-meld3_0.6.10-1.debian.tar.gz 4778 SHA256:31ee358fef6cc62bcfc849e664b2fcbaeeadc087d1d441b73d1b03a00aea28bc
```
...
### `dpkg` source package: `redis=2:2.8.4-2`
...
Licenses: (parsed from: `/usr/share/doc/redis-server/copyright`, `/usr/share/doc/redis-tools/copyright`)
...
```console
$ apt-get source -qq --print-uris redis=2:2.8.4-2
'http://archive.ubuntu.com/ubuntu/pool/universe/r/redis/redis_2.8.4-2.dsc' redis_2.8.4-2.dsc 1217 SHA256:504ac7ecdfb13e284666f9d18efc07041aa915bdf565acf495f38216284620c9
'http://archive.ubuntu.com/ubuntu/pool/universe/r/redis/redis_2.8.4.orig.tar.gz' redis_2.8.4.orig.tar.gz 1048914 SHA256:6b6602321536401b8b46aa05ec509141506b689b420675685ffe147ae08c0c86
'http://archive.ubuntu.com/ubuntu/pool/universe/r/redis/redis_2.8.4-2.debian.tar.gz' redis_2.8.4-2.debian.tar.gz 21783 SHA256:84cf63d7ff67d8755c9135f8d4f72d5e6f54b1cb8fe71415477db46410ec6d84
```
...
### `dpkg` source package: `supervisor=3.0b2-1`

Binary Packages:

- `supervisor=3.0b2-1`

Licenses: (parsed from: `/usr/share/doc/supervisor/copyright`)
...
```console
$ apt-get source -qq --print-uris supervisor=3.0b2-1
'http://archive.ubuntu.com/ubuntu/pool/universe/s/supervisor/supervisor_3.0b2-1.dsc' supervisor_3.0b2-1.dsc 1555 SHA256:605a75ea18bb277ddd840e5445b6c7806872894ccdeff65ba03046d70234442b
'http://archive.ubuntu.com/ubuntu/pool/universe/s/supervisor/supervisor_3.0b2.orig.tar.gz' supervisor_3.0b2.orig.tar.gz 459326 SHA256:b4fc17cc3ce97c50baed69004c7574dcb507b185c74f9aed817d98aece76a2ef
'http://archive.ubuntu.com/ubuntu/pool/universe/s/supervisor/supervisor_3.0b2-1.debian.tar.gz' supervisor_3.0b2-1.debian.tar.gz 10137 SHA256:9bf9848e489b03cd2e79189f841c39dddfd4bbd48a3e3b658c3fe1b552ba9774
```
...
```console
$ apt-get source -qq --print-uris systemd=204-5ubuntu20.19
'http://archive.ubuntu.com/ubuntu/pool/main/s/systemd/systemd_204-5ubuntu20.19.dsc' systemd_204-5ubuntu20.19.dsc 4087 SHA256:17b293bda382f66776b0a4ec0e0a6009ac22343cb1da30359fdceb46bebc1d70
...
'http://archive.ubuntu.com/ubuntu/pool/main/s/systemd/systemd_204-5ubuntu20.19.debian.tar.xz' systemd_204-5ubuntu20.19.debian.tar.xz 137340 SHA256:c6cf722fca0d7ddfa0a457b61574ea69c369dbd85319cdb4c5b64ea1cc0af902
```
...
### `dpkg` source package: `tzdata=2016d-0ubuntu0.14.04`
