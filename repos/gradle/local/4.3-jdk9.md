...
- Image ID: `sha256:245eb04167dc1b64cb27fa11c9153aa3fcf0103c5c6ed689514a6967af4357c2`
- Created: `2017-12-12T17:49:15.957544781Z`
- Virtual Size: ~ 976.45 Mb  
...
### `dpkg` source package: `adwaita-icon-theme=3.26.1-1`
...
```console
$ apt-get source -qq --print-uris adwaita-icon-theme=3.26.1-1
'http://deb.debian.org/debian/pool/main/a/adwaita-icon-theme/adwaita-icon-theme_3.26.1-1.dsc' adwaita-icon-theme_3.26.1-1.dsc 2280 SHA256:c669e5a7564b9752bbd2386419c23698123bd7d20f53a86b42852f1710f9e8cf
...
'http://deb.debian.org/debian/pool/main/a/adwaita-icon-theme/adwaita-icon-theme_3.26.1-1.debian.tar.xz' adwaita-icon-theme_3.26.1-1.debian.tar.xz 27612 SHA256:9b1ef8f7803b85de248aece82b582439fe94f9915d437a0b45520ce2acdbbb9d
```

Other potentially useful URLs:

- https://sources.debian.net/src/adwaita-icon-theme/3.26.1-1/ (for browsing the source)
- https://sources.debian.net/src/adwaita-icon-theme/3.26.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/adwaita-icon-theme/3.26.1-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `apparmor=2.11.1-4`

Binary Packages:

- `libapparmor1:amd64=2.11.1-4`
...
```console
$ apt-get source -qq --print-uris apparmor=2.11.1-4
'http://deb.debian.org/debian/pool/main/a/apparmor/apparmor_2.11.1-4.dsc' apparmor_2.11.1-4.dsc 3405 SHA256:04dc5447fd89af241309418b21869692f11be178d655290fc64f59d1291ba0e0
...
'http://deb.debian.org/debian/pool/main/a/apparmor/apparmor_2.11.1-4.debian.tar.xz' apparmor_2.11.1-4.debian.tar.xz 86264 SHA256:36b4623f0f1cf4b3d242b17a1b06837d58692af002d38c56141575548d9f1888
```

Other potentially useful URLs:

- https://sources.debian.net/src/apparmor/2.11.1-4/ (for browsing the source)
- https://sources.debian.net/src/apparmor/2.11.1-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/apparmor/2.11.1-4/ (for access to the source package after it no longer exists in the archive)
...
- `libgail-common:amd64=2.24.31-4`
- `libgail18:amd64=2.24.31-4`
- `libgtk2.0-0:amd64=2.24.31-4`
- `libgtk2.0-bin=2.24.31-4`
...
### `dpkg` source package: `json-glib=1.4.2-2`

Binary Packages:

- `libjson-glib-1.0-0:amd64=1.4.2-2`
- `libjson-glib-1.0-common=1.4.2-2`
...
```console
$ apt-get source -qq --print-uris json-glib=1.4.2-2
'http://deb.debian.org/debian/pool/main/j/json-glib/json-glib_1.4.2-2.dsc' json-glib_1.4.2-2.dsc 2666 SHA256:ca257512091cefaed9903f9b8dabf486e32b42b3ba6c0eb72a8b605b6c6a2264
...
'http://deb.debian.org/debian/pool/main/j/json-glib/json-glib_1.4.2-2.debian.tar.xz' json-glib_1.4.2-2.debian.tar.xz 8120 SHA256:4e65ec28d4a9e0e9811345ab33e3e880927467ec221196ab741b21cf8121dc7d
```

Other potentially useful URLs:

- https://sources.debian.net/src/json-glib/1.4.2-2/ (for browsing the source)
- https://sources.debian.net/src/json-glib/1.4.2-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/json-glib/1.4.2-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libdrm=2.4.88-1`

Binary Packages:

- `libdrm-amdgpu1:amd64=2.4.88-1`
- `libdrm-common=2.4.88-1`
- `libdrm-intel1:amd64=2.4.88-1`
- `libdrm-nouveau2:amd64=2.4.88-1`
- `libdrm-radeon1:amd64=2.4.88-1`
- `libdrm2:amd64=2.4.88-1`
...
```console
$ apt-get source -qq --print-uris libdrm=2.4.88-1
'http://deb.debian.org/debian/pool/main/libd/libdrm/libdrm_2.4.88-1.dsc' libdrm_2.4.88-1.dsc 3040 SHA256:58cf9409d0a74abfdbf606bae849ada106274aecb10ed7b3a98193d1a1960316
'http://deb.debian.org/debian/pool/main/libd/libdrm/libdrm_2.4.88.orig.tar.gz' libdrm_2.4.88.orig.tar.gz 1084162 SHA256:a8b458db6a73c717baee2e249d39511fb6f5c0f5f24dee2770935eddeda1a017
'http://deb.debian.org/debian/pool/main/libd/libdrm/libdrm_2.4.88-1.diff.gz' libdrm_2.4.88-1.diff.gz 50017 SHA256:3bf3cfdc14b0ca3c009592448d5b7330426ccc36cc854e043d70c2ec3bb2c784
```

Other potentially useful URLs:

- https://sources.debian.net/src/libdrm/2.4.88-1/ (for browsing the source)
- https://sources.debian.net/src/libdrm/2.4.88-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libdrm/2.4.88-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libglvnd=1.0.0-1`

Binary Packages:

- `libegl1:amd64=1.0.0-1`
- `libgl1:amd64=1.0.0-1`
- `libglvnd0:amd64=1.0.0-1`
- `libglx0:amd64=1.0.0-1`
...
### `dpkg` source package: `mesa=17.2.5-1`

Binary Packages:

- `libegl-mesa0:amd64=17.2.5-1`
- `libgbm1:amd64=17.2.5-1`
- `libgl1-mesa-dri:amd64=17.2.5-1`
- `libgl1-mesa-glx:amd64=17.2.5-1`
- `libglapi-mesa:amd64=17.2.5-1`
- `libglx-mesa0:amd64=17.2.5-1`
- `libwayland-egl1-mesa:amd64=17.2.5-1`
...
```console
$ apt-get source -qq --print-uris mesa=17.2.5-1
'http://deb.debian.org/debian/pool/main/m/mesa/mesa_17.2.5-1.dsc' mesa_17.2.5-1.dsc 4929 SHA256:a6e20fc4125820926ac9ff02dce806892665abbff2f8b51a285b8b8e46b7bdf6
'http://deb.debian.org/debian/pool/main/m/mesa/mesa_17.2.5.orig.tar.gz' mesa_17.2.5.orig.tar.gz 17742132 SHA256:25b40e72fad64b096c2d8d6fe9579369954debe7970d4ad53e5033c7eec2918b
'http://deb.debian.org/debian/pool/main/m/mesa/mesa_17.2.5-1.diff.gz' mesa_17.2.5-1.diff.gz 116102 SHA256:0a3c8e9f9dfa0700c97d78c0f4745ecc638d40abef6a45db635b579fbc8e6c99
```

Other potentially useful URLs:

- https://sources.debian.net/src/mesa/17.2.5-1/ (for browsing the source)
- https://sources.debian.net/src/mesa/17.2.5-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mesa/17.2.5-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `nss=2:3.34-1`

Binary Packages:

- `libnss3:amd64=2:3.34-1`
...
- `libnss-systemd:amd64=235-3`
- `libpam-systemd:amd64=235-3`
- `libsystemd0:amd64=235-3`
- `libudev1:amd64=235-3`
- `systemd=235-3`
- `systemd-sysv=235-3`

Licenses: (parsed from: `/usr/share/doc/libnss-systemd/copyright`, `/usr/share/doc/libpam-systemd/copyright`, `/usr/share/doc/libsystemd0/copyright`, `/usr/share/doc/libudev1/copyright`, `/usr/share/doc/systemd/copyright`, `/usr/share/doc/systemd-sysv/copyright`)
