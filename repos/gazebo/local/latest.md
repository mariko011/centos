...
- Created: `2016-06-08T22:55:54.308948353Z`
- Arch: `linux`/`amd64`
...
### `dpkg` source package: `expat=2.1.0-4ubuntu1.2`
...
- `libgazebo7-dev:amd64=7.1.0-1~trusty`
...
- `libignition-math2-dev:amd64=2.3.0-1~trusty`
...
### `dpkg` source package: `linux=3.13.0-87.133`
...
- `libsdformat4-dev:amd64=4.1.0-1~trusty`
- `sdformat-sdf=4.1.0-1~trusty`

Licenses: (parsed from: `/usr/share/doc/libsdformat4/copyright`, `/usr/share/doc/libsdformat4-dev/copyright`, `/usr/share/doc/sdformat-sdf/copyright`)
...
- `libxerces-c-dev=3.1.1-5.1+deb8u2build0.14.04.1`
