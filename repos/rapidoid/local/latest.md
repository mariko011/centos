...
- Created: `2017-01-24T17:29:59.968180054Z`
- Arch: `linux`/`amd64`
...
- Environment:
  ...
  - `RAPIDOID_VERSION=5.2.8`
  - `RAPIDOID_URL=https://repo1.maven.org/maven2/org/rapidoid/rapidoid-platform/5.2.8/rapidoid-platform-5.2.8.jar`
