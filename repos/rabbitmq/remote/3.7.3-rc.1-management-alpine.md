...
```console
$ docker pull rabbitmq@sha256:67a69a436df1e8f33065a84d1b84615f5ddf4cc74c3ebd665417f36b3f98da53
```
...
### `rabbitmq:3.7.3-rc.1-management-alpine` - linux; 386
...
### `rabbitmq:3.7.3-rc.1-management-alpine` - linux; ppc64le
