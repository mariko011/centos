...
### `rabbitmq:3.6.11-management` - linux; arm variant v5
...
### `rabbitmq:3.6.11-management` - linux; arm variant v7
...
### `rabbitmq:3.6.11-management` - linux; arm64 variant v8
...
### `rabbitmq:3.6.11-management` - linux; 386
...
### `rabbitmq:3.6.11-management` - linux; s390x
