...
```console
$ docker pull rabbitmq@sha256:6e5cbafc99bdf2f03a5e4266820e96d85727952970262eff79cb50b2f3ece1d6
```
...
```console
$ docker pull rabbitmq@sha256:427b99168cdfe6f1496d1b256a372fc3adb026061a544221df0215257fe3c906
```
