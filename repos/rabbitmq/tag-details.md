...
```console
$ docker pull rabbitmq@sha256:b0f7ff2a05b1cc71b7cd009abe2457e3577bd4b72984732b9634222a5cc5135c
```
...
```console
$ docker pull rabbitmq@sha256:5a7c7968f242107d68eb230276fadb1eecba85258e04b9fdfaba1c33563d12f8
```
