...
```console
$ docker pull rabbitmq@sha256:927ffe918a0db9f37e2303fc9591cb621cda8a5f680baadb25ac67bc3efd228c
```
...
```console
$ docker pull rabbitmq@sha256:ba6913ffa8aafbc81e4b37a5de5946009644decd111d2df4c33c7da9100a9fe8
```
