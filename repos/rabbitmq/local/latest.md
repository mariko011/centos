...
- Created: `2017-06-23T05:10:07.067481073Z`
...
### `dpkg` source package: `socat=1.7.3.1-2`
...
```console
$ apt-get source -qq --print-uris socat=1.7.3.1-2
...
- https://sources.debian.net/src/socat/1.7.3.1-2/
- https://sources.debian.net/src/socat/1.7.3.1-2/debian/copyright (for direct copyright/license information)
