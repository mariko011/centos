...
- Created: `2018-01-26T01:10:47.700613257Z`
- Virtual Size: ~ 150.97 Mb  
...
- Environment:
  ...
  - `RABBITMQ_DEBIAN_VERSION=3.7.3.rc.2-1`
  - `LANG=C.UTF-8`
...
### `dpkg` source package: `rabbitmq-server=3.7.3~rc.2-1`

Binary Packages:

- `rabbitmq-server=3.7.3~rc.2-1`
