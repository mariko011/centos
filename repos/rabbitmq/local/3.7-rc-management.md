...
- Created: `2018-01-18T01:04:38.347312329Z`
- Virtual Size: ~ 150.96 Mb  
...
- Environment:
  ...
  - `RABBITMQ_DEBIAN_VERSION=3.7.3.rc.1-1`
  - `LANG=C.UTF-8`
...
### `dpkg` source package: `rabbitmq-server=3.7.3~rc.1-1`

Binary Packages:

- `rabbitmq-server=3.7.3~rc.1-1`
