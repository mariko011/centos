...
### `dpkg` source package: `erlang=1:19.2.1+dfsg-2`

Binary Packages:

- `erlang-asn1=1:19.2.1+dfsg-2`
- `erlang-base-hipe=1:19.2.1+dfsg-2`
- `erlang-corba=1:19.2.1+dfsg-2`
- `erlang-crypto=1:19.2.1+dfsg-2`
- `erlang-diameter=1:19.2.1+dfsg-2`
- `erlang-edoc=1:19.2.1+dfsg-2`
- `erlang-eldap=1:19.2.1+dfsg-2`
- `erlang-erl-docgen=1:19.2.1+dfsg-2`
- `erlang-eunit=1:19.2.1+dfsg-2`
- `erlang-ic=1:19.2.1+dfsg-2`
- `erlang-inets=1:19.2.1+dfsg-2`
- `erlang-mnesia=1:19.2.1+dfsg-2`
- `erlang-nox=1:19.2.1+dfsg-2`
- `erlang-odbc=1:19.2.1+dfsg-2`
- `erlang-os-mon=1:19.2.1+dfsg-2`
- `erlang-parsetools=1:19.2.1+dfsg-2`
- `erlang-percept=1:19.2.1+dfsg-2`
- `erlang-public-key=1:19.2.1+dfsg-2`
- `erlang-runtime-tools=1:19.2.1+dfsg-2`
- `erlang-snmp=1:19.2.1+dfsg-2`
- `erlang-ssh=1:19.2.1+dfsg-2`
- `erlang-ssl=1:19.2.1+dfsg-2`
- `erlang-syntax-tools=1:19.2.1+dfsg-2`
- `erlang-tools=1:19.2.1+dfsg-2`
...
```console
$ apt-get source -qq --print-uris erlang=1:19.2.1+dfsg-2
'http://deb.debian.org/debian/pool/main/e/erlang/erlang_19.2.1+dfsg-2.dsc' erlang_19.2.1+dfsg-2.dsc 5375 SHA256:47856b07f7381aefc62e8b246069583a9bc69ecc9fe93dedc6b0851e1fcc7a49
'http://deb.debian.org/debian/pool/main/e/erlang/erlang_19.2.1+dfsg.orig.tar.xz' erlang_19.2.1+dfsg.orig.tar.xz 23581804 SHA256:5d02abe19d00d4d71e30e1f615658f1ee1eba1dede6271cd8520e87c09262231
'http://deb.debian.org/debian/pool/main/e/erlang/erlang_19.2.1+dfsg-2.debian.tar.xz' erlang_19.2.1+dfsg-2.debian.tar.xz 61648 SHA256:4dbd63580e075d2c6509e01afe56c3a0fa0d8f1845cb7e73f0f4dd4b2a82e604
```

Other potentially useful URLs:

- https://sources.debian.net/src/erlang/1:19.2.1+dfsg-2/ (for browsing the source)
- https://sources.debian.net/src/erlang/1:19.2.1+dfsg-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/erlang/1:19.2.1+dfsg-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `socat=1.7.3.1-2+deb9u1`
...
```console
$ apt-get source -qq --print-uris socat=1.7.3.1-2+deb9u1
'http://deb.debian.org/debian/pool/main/s/socat/socat_1.7.3.1-2+deb9u1.dsc' socat_1.7.3.1-2+deb9u1.dsc 1769 SHA256:abc11b2d164b7cdf43d20242d0446f968fd42b6feedf6702eb38e78f1b58b8a4
'http://deb.debian.org/debian/pool/main/s/socat/socat_1.7.3.1.orig.tar.gz' socat_1.7.3.1.orig.tar.gz 606049 SHA256:a8cb07b12bcd04c98f4ffc1c68b79547f5dd4e23ddccb132940f6d55565c7f79
'http://deb.debian.org/debian/pool/main/s/socat/socat_1.7.3.1-2+deb9u1.debian.tar.xz' socat_1.7.3.1-2+deb9u1.debian.tar.xz 13580 SHA256:26c0884685a9f9ee933fa76e5bdfda37d525c214a88e09d3b87221ecdfd00f32
```

Other potentially useful URLs:

- https://sources.debian.net/src/socat/1.7.3.1-2+deb9u1/ (for browsing the source)
- https://sources.debian.net/src/socat/1.7.3.1-2+deb9u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/socat/1.7.3.1-2+deb9u1/ (for access to the source package after it no longer exists in the archive)
