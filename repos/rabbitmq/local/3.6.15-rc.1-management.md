...
- Created: `2018-01-08T22:50:27.621022545Z`
...
- Environment:
  ...
  - `RABBITMQ_DEBIAN_VERSION=3.6.15.rc.1-1`
...
### `dpkg` source package: `rabbitmq-server=3.6.15~rc.1-1`

Binary Packages:

- `rabbitmq-server=3.6.15~rc.1-1`
