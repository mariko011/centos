...
```console
$ docker pull node@sha256:4cba49c0de59d367df14496588b3477b7c0a606f36df3880cd9f56b8b1e6a329
```
...
```console
$ docker pull node@sha256:1b50e9fa7bc5e266fd1cdd0095c01db02eb0e99c99be8f8036efa5300a3dae4f
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.9 MB (18862911 bytes)**  
