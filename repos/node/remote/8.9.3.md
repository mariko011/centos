...
```console
$ docker pull node@sha256:7c8290a50527205b67f1ef743285d827eba2b3a726f4dedbd166175c7a39ed05
```
...
### `node:8.9.3` - linux; amd64

```console
$ docker pull node@sha256:fb11d95ec6174f435d6d00fe253eab8fac84b7f731b70067a28ac6769402be6d
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **269.6 MB (269610578 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2eeae8debf3df164fd4394ebe510dfd0a76e8739d1487ef8daa7673e755b63ab`
...
### `node:8.9.3` - linux; arm variant v7

```console
$ docker pull node@sha256:09db4073cdf5e1ec87aaa5f3ca2bfd3673e2cf90436958eb13a5139236c69042
```

-	Docker Version: 17.06.0-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **239.4 MB (239429875 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac2c0044cf898d51da2565d9ce0ca5d98de2965d810b5ae65fabb007e0737943`
-	Default Command: `["node"]`
...
### `node:8.9.3` - linux; arm64 variant v8

```console
$ docker pull node@sha256:9f23a2d925f59afe87e546776932d2502ee44d162e93d9e232febfda95dfb352
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.1 MB (245114308 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e5dc339298c79ded763793ebe54b8a4c9c293f9a2d9b65c772feb955982fe82`
-	Default Command: `["node"]`
...
RUN set -ex   && for key in     94AE36675C464D64BAFA68DD7434390BDBE9B9C5     FD3A5288F042B6850C66B31F09FE44734EB7990E     71DCFD284A79C3B38668286BC97EC7A07EDE3FC1     DD8F2338BAE7501E3DD5AC78C273792F7D83545D     C4F0DFFF4E8C1A8236409D08E73BC641CC11F4C8     B9AE9905FFD7803F25714661B63B535A4C206CA9     56730D5401028683275BD23C23EFEFE93C4CFFFE     77984A986EBC2AA786BC0F66B01FBB92821C587A   ; do     gpg --keyserver pgp.mit.edu --recv-keys "$key" ||     gpg --keyserver keyserver.pgp.com --recv-keys "$key" ||     gpg --keyserver ha.pool.sks-keyservers.net --recv-keys "$key" ;   done
# Sat, 16 Dec 2017 06:30:52 GMT
ENV NODE_VERSION=8.9.3
# Sat, 16 Dec 2017 06:31:00 GMT
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)"   && case "${dpkgArch##*-}" in     amd64) ARCH='x64';;     ppc64el) ARCH='ppc64le';;     s390x) ARCH='s390x';;     arm64) ARCH='arm64';;     armhf) ARCH='armv7l';;     i386) ARCH='x86';;     *) echo "unsupported architecture"; exit 1 ;;   esac   && curl -SLO "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz"   && curl -SLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc"   && gpg --batch --decrypt --output SHASUMS256.txt SHASUMS256.txt.asc   && grep " node-v$NODE_VERSION-linux-$ARCH.tar.xz\$" SHASUMS256.txt | sha256sum -c -   && tar -xJf "node-v$NODE_VERSION-linux-$ARCH.tar.xz" -C /usr/local --strip-components=1 --no-same-owner   && rm "node-v$NODE_VERSION-linux-$ARCH.tar.xz" SHASUMS256.txt.asc SHASUMS256.txt   && ln -s /usr/local/bin/node /usr/local/bin/nodejs
# Sat, 16 Dec 2017 06:31:01 GMT
ENV YARN_VERSION=1.3.2
# Sat, 16 Dec 2017 06:31:06 GMT
RUN set -ex   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --keyserver pgp.mit.edu --recv-keys "$key" ||     gpg --keyserver keyserver.pgp.com --recv-keys "$key" ||     gpg --keyserver ha.pool.sks-keyservers.net --recv-keys "$key" ;   done   && curl -fSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && mkdir -p /opt/yarn   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/yarn --strip-components=1   && ln -s /opt/yarn/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn/bin/yarn /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz
# Sat, 16 Dec 2017 06:31:07 GMT
CMD ["node"]
```
...
-	Layers:
	...
	-	`sha256:db2b12115cecd5386b5068f42caf3e73ed9016f64a7f6bd2dcc26a313dc37ff2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03cbb48e9b87d0c2936bd189f8a0b0c0691c7015b1958b84516279f2f966e795`  
		Last Modified: Sat, 16 Dec 2017 06:38:16 GMT  
		Size: 18.4 MB (18368287 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e230d21eb82608e0d1a90c69ffa07fdf88409e1a8e51d903b635f0448d1bf1c6`  
		Last Modified: Sat, 16 Dec 2017 06:38:08 GMT  
		Size: 1.0 MB (1010349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `node:8.9.3` - linux; 386

```console
$ docker pull node@sha256:975f385af536d766bead2b76efd3b298b29d74f539461b39a80a1a828b40e30d
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **272.5 MB (272520368 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab3accc4f8b54229eae3afe04cbb0a9d5acacd7316ad7ca239049daad39b1208`
-	Default Command: `["node"]`
...
### `node:8.9.3` - linux; ppc64le

```console
$ docker pull node@sha256:e4ac86b51509b2ee2cf1e724bf0fca18f56100ef649289e2a22cc94b787eb1db
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.1 MB (256071156 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc33c7c44429a23de8203a03e0601b81f240b98cdf5039763c75abf323551d89`
-	Default Command: `["node"]`
...
### `node:8.9.3` - linux; s390x

```console
$ docker pull node@sha256:d271fde26173e29cac6865c7c5705638623cf77b2824317517a36d6302a48803
```

-	Docker Version: 17.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.6 MB (251606179 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8665fc3dd85006c59d32e25d2f6e0dbb38e750db1b2cfb3a7901509d4b7b94be`
-	Default Command: `["node"]`
