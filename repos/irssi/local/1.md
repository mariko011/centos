...
### `dpkg` source package: `libio-socket-ssl-perl=2.002-2+deb8u2`
...
```console
$ apt-get source -qq --print-uris libio-socket-ssl-perl=2.002-2+deb8u2
'http://deb.debian.org/debian/pool/main/libi/libio-socket-ssl-perl/libio-socket-ssl-perl_2.002-2+deb8u2.dsc' libio-socket-ssl-perl_2.002-2+deb8u2.dsc 2775 SHA256:fe941f11e3366ccf7c7869010376a80d6e4a91ea057a674a00ca4cecab1e333a
...
'http://deb.debian.org/debian/pool/main/libi/libio-socket-ssl-perl/libio-socket-ssl-perl_2.002-2+deb8u2.debian.tar.xz' libio-socket-ssl-perl_2.002-2+deb8u2.debian.tar.xz 10364 SHA256:30d03b4f189a6fc1544285a74a394b19b1dd27df805a58120c69b776770ba7ae
```

Other potentially useful URLs:

- https://sources.debian.net/src/libio-socket-ssl-perl/2.002-2+deb8u2/ (for browsing the source)
- https://sources.debian.net/src/libio-socket-ssl-perl/2.002-2+deb8u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libio-socket-ssl-perl/2.002-2+deb8u2/ (for access to the source package after it no longer exists in the archive)
