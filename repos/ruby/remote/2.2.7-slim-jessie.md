...
### `ruby:2.2.7-slim-jessie` - linux; arm variant v7
...
### `ruby:2.2.7-slim-jessie` - linux; arm64 variant v8
...
### `ruby:2.2.7-slim-jessie` - linux; 386
...
### `ruby:2.2.7-slim-jessie` - linux; ppc64le
...
### `ruby:2.2.7-slim-jessie` - linux; s390x
