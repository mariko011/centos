...
### `ruby:2.5.0-rc1-slim` - linux; amd64
...
### `ruby:2.5.0-rc1-slim` - linux; arm variant v5
...
### `ruby:2.5.0-rc1-slim` - linux; arm variant v7
...
### `ruby:2.5.0-rc1-slim` - linux; arm64 variant v8
...
### `ruby:2.5.0-rc1-slim` - linux; ppc64le
