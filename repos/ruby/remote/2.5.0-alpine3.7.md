...
### `ruby:2.5.0-alpine3.7` - linux; amd64
...
### `ruby:2.5.0-alpine3.7` - linux; arm variant v6
...
### `ruby:2.5.0-alpine3.7` - linux; arm64 variant v8
...
### `ruby:2.5.0-alpine3.7` - linux; 386
...
### `ruby:2.5.0-alpine3.7` - linux; ppc64le
...
### `ruby:2.5.0-alpine3.7` - linux; s390x
