...
- Created: `2017-10-10T04:09:51.089795936Z`
...
- https://sources.debian.net/src/libxtst/2:1.2.2-1/ (for browsing the source)
- https://sources.debian.net/src/libxtst/2:1.2.2-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libxtst/2:1.2.2-1/ (for access to the source package after it no longer exists in the archive)
...
- https://sources.debian.net/src/openssh/1:6.7p1-5+deb8u3/ (for browsing the source)
- https://sources.debian.net/src/openssh/1:6.7p1-5+deb8u3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/openssh/1:6.7p1-5+deb8u3/ (for access to the source package after it no longer exists in the archive)
