...
```console
$ apt-get source -qq --print-uris graphviz=2.38.0-12ubuntu2
...
```console
$ apt-get source -qq --print-uris imagemagick=8:6.8.9.9-7ubuntu5.1
...
```console
$ apt-get source -qq --print-uris libxslt=1.1.28-2.1
...
```console
$ apt-get source -qq --print-uris openssl=1.0.2g-1ubuntu4.2
...
```console
$ apt-get source -qq --print-uris postgresql-9.5=9.5.4-0ubuntu0.16.04
...
```console
$ apt-get source -qq --print-uris systemd=229-4ubuntu7
