...
```console
$ docker pull buildpack-deps@sha256:5d5bc95a47f0e884e1be1cffe07eae3b36f0925f610c33595eff23e26f961d16
```
...
```console
$ docker pull buildpack-deps@sha256:f93f57632024ea690d164b19b823aa328b753701f2fc703b1df00af1b659f2a9
```
...
```console
$ docker pull buildpack-deps@sha256:f5bd0e2a9cb37542cece00c7fe908dfca7631206e41cf0a4af3e55555861da3f
```
...
```console
$ docker pull buildpack-deps@sha256:02f0aac359b70fae6179e353d003cb3bf2ea62c9650fee7d176470370ce41dad
```
...
```console
$ docker pull buildpack-deps@sha256:1046041e638bf9e7b2e47ee482d00469b3ecc48c5e8a91632302a62a68635773
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **89.5 MB (89515152 bytes)**  
	(compressed transfer size, not on-disk size)
...
```console
$ docker pull buildpack-deps@sha256:0d0481d9daf5e2bdf123853e9b6e787af6e8db64f82f01e2b9cdb704edda92f8
```
...
```console
$ docker pull buildpack-deps@sha256:30a45dd59ac61ac20843a4d43d23fea98027b261d155e1da1984c189c7093796
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **77.7 MB (77668512 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1775a13cce26cf699085dbdb1ff612f5f4b0c156c8782acc8e4acc96f8073e92`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull buildpack-deps@sha256:0ff2fb707011741d5809b5b68958e6ba8008ae9d6dcfed8ec467b17c698a8d80
```
...
```console
$ docker pull buildpack-deps@sha256:3bf72b8a2ecd94dff7cd18ecbb1e050988ae8f981702b80b10418dab3eb3dad9
```
...
```console
$ docker pull buildpack-deps@sha256:54ed2f10a696c38158650ea91b15bb602c0ec70aa2476e4748d9133d7760dc20
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **232.2 MB (232178192 bytes)**  
	(compressed transfer size, not on-disk size)
...
-	Layers:
	...
	-	`sha256:53b766c564f683b2089c161152f00e0766160ea3bbf7bde319c45ffe2a08e6a7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a018147b9967ae5037e9ed53481db65a614f37d1d352a3b05c943592738f0d12`  
		Last Modified: Tue, 16 Jan 2018 03:27:44 GMT  
		Size: 140.2 MB (140198661 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
