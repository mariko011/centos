...
### `dpkg` source package: `aerospike-server-community=3.12.0-1`

Binary Packages:

- `aerospike-server-community=3.12.0-1`
...
### `dpkg` source package: `aerospike-tools=3.12.0`

Binary Packages:

- `aerospike-tools=3.12.0`
