...
```console
$ docker pull redmine@sha256:187cb4d314d84fc89dc330474501c87ecbb7e3e0d0250970267a74382f61a778
```
...
```console
$ docker pull redmine@sha256:c36ecc8f4ec52922df8c3e3edd3e672acb491d3072513505187b88db0f16d85c
```
