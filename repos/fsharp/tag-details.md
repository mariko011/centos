...
```console
$ docker pull fsharp@sha256:562f7185a6b5007ce0e94a06d053d2bb0989f47655f476711b07934889a15006
```
...
-	Docker Version: 1.12.6
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **265.5 MB (265492102 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7be2edbde1e86ec84d51ef14912857c98142ef89856e370d2372df205e0ff946`
-	Default Command: `["fsharpi"]`
...
# Fri, 24 Feb 2017 23:32:31 GMT
RUN apt-get -y update &&     apt-get -y --no-install-recommends install nuget mono-devel ca-certificates-mono &&     rm -rf /var/lib/apt/lists/*
# Fri, 24 Feb 2017 23:40:47 GMT
ENV FSHARP_VERSION=4.0.1.1
# Fri, 24 Feb 2017 23:40:47 GMT
ENV FSHARP_PREFIX=/usr FSHARP_GACDIR=/usr/lib/mono/gac FSHARP_BASENAME=fsharp-4.0.1.1 FSHARP_ARCHIVE=4.0.1.1.tar.gz FSHARP_ARCHIVE_URL=https://github.com/fsharp/fsharp/archive/4.0.1.1.tar.gz
# Fri, 24 Feb 2017 23:46:38 GMT
RUN mkdir -p /tmp/src &&     cd /tmp/src &&     wget $FSHARP_ARCHIVE_URL &&     tar xf $FSHARP_ARCHIVE &&     cd $FSHARP_BASENAME &&     ./autogen.sh --prefix=$FSHARP_PREFIX --with-gacdir=$FSHARP_GACDIR &&     make &&     make install &&     cd ~ &&     rm -rf /tmp/src
# Fri, 24 Feb 2017 23:46:38 GMT
WORKDIR /root
# Fri, 24 Feb 2017 23:46:38 GMT
...
-	Layers:
	...
	-	`sha256:44ec08d11b02871f6a903ee314b136e3751c07c95ca78446a1621589aa8c8153`  
		...
		Size: 53.8 MB (53807349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ea13a09599cab8955a1a326c4cad21a9d26f8fac08a4e4eb6a5a31e2973221d`  
		Last Modified: Fri, 24 Feb 2017 23:54:02 GMT  
		Size: 10.3 MB (10309614 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
