...
### `openjdk:8-alpine3.7` - linux; amd64
...
### `openjdk:8-alpine3.7` - linux; arm variant v6
...
### `openjdk:8-alpine3.7` - linux; arm64 variant v8
...
### `openjdk:8-alpine3.7` - linux; ppc64le
...
### `openjdk:8-alpine3.7` - linux; s390x
