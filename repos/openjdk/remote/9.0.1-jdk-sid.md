...
### `openjdk:9.0.1-jdk-sid` - linux; amd64
...
### `openjdk:9.0.1-jdk-sid` - linux; arm variant v5
...
### `openjdk:9.0.1-jdk-sid` - linux; arm variant v7
...
### `openjdk:9.0.1-jdk-sid` - linux; arm64 variant v8
...
### `openjdk:9.0.1-jdk-sid` - linux; ppc64le
