...
```console
$ docker pull openjdk@sha256:5c3a974f0ebe825e821c5d9101817b434a3f3f9b27acaa199ba3545cbd79a959
```
...
### `openjdk:9.0.1` - linux; arm variant v5
...
### `openjdk:9.0.1` - linux; arm variant v7
...
### `openjdk:9.0.1` - linux; arm64 variant v8
