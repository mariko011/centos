...
### `openjdk:10-ea-32-jre-slim-experimental` - linux; amd64
...
### `openjdk:10-ea-32-jre-slim-experimental` - linux; arm variant v5
...
### `openjdk:10-ea-32-jre-slim-experimental` - linux; arm variant v7
...
### `openjdk:10-ea-32-jre-slim-experimental` - linux; arm64 variant v8
...
### `openjdk:10-ea-32-jre-slim-experimental` - linux; 386
...
### `openjdk:10-ea-32-jre-slim-experimental` - linux; ppc64le
...
### `openjdk:10-ea-32-jre-slim-experimental` - linux; s390x
