...
### `openjdk:9.0.1-11-jre-slim-sid` - linux; arm variant v5
...
### `openjdk:9.0.1-11-jre-slim-sid` - linux; arm64 variant v8
...
### `openjdk:9.0.1-11-jre-slim-sid` - linux; 386
...
### `openjdk:9.0.1-11-jre-slim-sid` - linux; ppc64le
...
### `openjdk:9.0.1-11-jre-slim-sid` - linux; s390x
