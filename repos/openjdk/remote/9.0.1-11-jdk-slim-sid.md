...
### `openjdk:9.0.1-11-jdk-slim-sid` - linux; amd64
...
### `openjdk:9.0.1-11-jdk-slim-sid` - linux; arm variant v5
...
### `openjdk:9.0.1-11-jdk-slim-sid` - linux; arm variant v7
...
### `openjdk:9.0.1-11-jdk-slim-sid` - linux; arm64 variant v8
...
### `openjdk:9.0.1-11-jdk-slim-sid` - linux; 386
...
### `openjdk:9.0.1-11-jdk-slim-sid` - linux; ppc64le
...
### `openjdk:9.0.1-11-jdk-slim-sid` - linux; s390x
