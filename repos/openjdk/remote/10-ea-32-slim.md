...
### `openjdk:10-ea-32-slim` - linux; arm variant v5
...
### `openjdk:10-ea-32-slim` - linux; arm variant v7
...
### `openjdk:10-ea-32-slim` - linux; arm64 variant v8
...
### `openjdk:10-ea-32-slim` - linux; 386
...
### `openjdk:10-ea-32-slim` - linux; ppc64le
