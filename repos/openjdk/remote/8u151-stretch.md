...
```console
$ docker pull openjdk@sha256:18c9622a8dc67b608a2dd0178b4c5aebc0e2da9a656072c6e799cfc46cb96422
```
...
### `openjdk:8u151-stretch` - linux; amd64
...
### `openjdk:8u151-stretch` - linux; arm variant v5
...
### `openjdk:8u151-stretch` - linux; arm variant v7
...
### `openjdk:8u151-stretch` - linux; arm64 variant v8
...
### `openjdk:8u151-stretch` - linux; 386
...
### `openjdk:8u151-stretch` - linux; ppc64le
...
### `openjdk:8u151-stretch` - linux; s390x
