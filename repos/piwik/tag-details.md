...
```console
$ docker pull piwik@sha256:962b66440ea05e7a17cbe621535d460de4b86aab63f7bfb7389dbecee568e8de
```
...
-	Docker Version: 17.03.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.8 MB (191753635 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b8842879120d94a9fa802c3357bbccd53e68df775ffa1f6c82df47a1bfc2c53`
-	Entrypoint: `["\/entrypoint.sh"]`
...
CMD ["php-fpm"]
# Wed, 14 Jun 2017 14:30:22 GMT
MAINTAINER pierre@piwik.org
# Wed, 14 Jun 2017 14:30:33 GMT
RUN apt-get update && apt-get install -y       libjpeg-dev       libfreetype6-dev       libgeoip-dev       libpng12-dev       libldap2-dev       zip  && rm -rf /var/lib/apt/lists/*
# Wed, 14 Jun 2017 14:31:47 GMT
RUN docker-php-ext-configure gd --with-freetype-dir=/usr --with-png-dir=/usr --with-jpeg-dir=/usr 	&& docker-php-ext-configure ldap --with-libdir=lib/x86_64-linux-gnu/  	&& docker-php-ext-install -j$(nproc) gd mbstring mysql pdo_mysql zip ldap opcache
# Wed, 14 Jun 2017 14:31:54 GMT
RUN pecl install APCu geoip
# Wed, 14 Jun 2017 14:32:14 GMT
ENV PIWIK_VERSION=3.0.4
# Wed, 14 Jun 2017 14:32:23 GMT
RUN curl -fsSL -o piwik.tar.gz       "https://builds.piwik.org/piwik-${PIWIK_VERSION}.tar.gz"  && curl -fsSL -o piwik.tar.gz.asc       "https://builds.piwik.org/piwik-${PIWIK_VERSION}.tar.gz.asc"  && export GNUPGHOME="$(mktemp -d)"  && gpg --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237  && gpg --batch --verify piwik.tar.gz.asc piwik.tar.gz  && rm -r "$GNUPGHOME" piwik.tar.gz.asc  && tar -xzf piwik.tar.gz -C /usr/src/  && rm piwik.tar.gz
# Wed, 14 Jun 2017 14:32:42 GMT
COPY file:c38913b1c220a089fa0b50e33e71a81a441978dfb47dd6b00cf105d42f87f82b in /usr/local/etc/php/php.ini 
# Wed, 14 Jun 2017 14:32:44 GMT
RUN curl -fsSL -o /usr/src/piwik/misc/GeoIPCity.dat.gz http://geolite.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz  && gunzip /usr/src/piwik/misc/GeoIPCity.dat.gz
# Wed, 14 Jun 2017 14:33:08 GMT
COPY file:624ec542e8b52694362740314ac6948ac2d59a5d302df84808cc0cfbddea1e59 in /entrypoint.sh 
# Wed, 14 Jun 2017 14:33:09 GMT
VOLUME [/var/www/html]
# Wed, 14 Jun 2017 14:33:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 14 Jun 2017 14:33:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ccd7e93bfe176448fe557aa2a05de5e239211ef70ca52ab35324bcedd2c39e16`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9b954b982f0f86851e52eb825b36d6e6ff70afb0c405d4e8c172edeb809c8c7`  
		Last Modified: Wed, 14 Jun 2017 14:39:47 GMT  
		Size: 7.1 MB (7073438 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc10c2f9b9afaa513051737392cf652413777aa902e979ad6188e97368354856`  
		Last Modified: Wed, 14 Jun 2017 14:39:43 GMT  
		Size: 1.1 MB (1128777 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3322bb102d4b4a18af4e0f4db34fa801730ab025720d3bb7843929804c7589d4`  
		Last Modified: Wed, 14 Jun 2017 14:39:42 GMT  
		Size: 46.8 KB (46810 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4eb6d3fce1a8b7c623fb1cb7a78efd9bba8309efcc8b28d1f5c816be2f1f0d72`  
		Last Modified: Wed, 14 Jun 2017 14:39:46 GMT  
		Size: 14.2 MB (14240992 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e25237d8bc80038c5f34e702fae10152495ee482544063064ff5af8ff32a1e1`  
		Last Modified: Wed, 14 Jun 2017 14:39:43 GMT  
		Size: 273.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c28e375c265358e65669f575bcf4fe900e1cd7d50fbf57017c73c0de34dcaf6c`  
		Last Modified: Wed, 14 Jun 2017 14:39:44 GMT  
		Size: 13.0 MB (13007733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d65b454b55d36db22031ca12ec458a449416cbac1085d779e974d816c6cf88f`  
		Last Modified: Wed, 14 Jun 2017 14:39:42 GMT  
		Size: 224.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
