...
### `php:7.1.11-apache-jessie` - linux; amd64
...
### `php:7.1.11-apache-jessie` - linux; arm variant v5
...
### `php:7.1.11-apache-jessie` - linux; arm variant v7
...
### `php:7.1.11-apache-jessie` - linux; arm64 variant v8
...
### `php:7.1.11-apache-jessie` - linux; 386
...
### `php:7.1.11-apache-jessie` - linux; ppc64le
...
### `php:7.1.11-apache-jessie` - linux; s390x
