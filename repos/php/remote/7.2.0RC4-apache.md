...
### `php:7.2.0RC4-apache` - linux; amd64
...
### `php:7.2.0RC4-apache` - linux; arm variant v5
...
### `php:7.2.0RC4-apache` - linux; arm variant v7
...
### `php:7.2.0RC4-apache` - linux; arm64 variant v8
...
### `php:7.2.0RC4-apache` - linux; ppc64le
