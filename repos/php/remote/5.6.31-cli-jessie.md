...
### `php:5.6.31-cli-jessie` - linux; amd64
...
### `php:5.6.31-cli-jessie` - linux; arm variant v7
...
### `php:5.6.31-cli-jessie` - linux; arm64 variant v8
...
### `php:5.6.31-cli-jessie` - linux; 386
...
### `php:5.6.31-cli-jessie` - linux; ppc64le
