...
```console
$ docker pull php@sha256:f7af1d41afae60487c7384fbef330bc23796ad1fa88b7714c0e9c8bd965c587a
```
...
```console
$ docker pull php@sha256:39583df64ff111448491be820ed21f000e7e249754476e4052498b9b7ecf2bf7
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.3 MB (162254349 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d0f937378a0db06f4135048e1d6626b1e3c51095f840385df6a7790e5ed082e8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
