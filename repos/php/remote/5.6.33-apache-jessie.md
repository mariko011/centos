...
```console
$ docker pull php@sha256:b455d2c6e8f8152723fa34fb17fc4292f232abaf97faac10ce16f9e4e747908e
```
...
### `php:5.6.33-apache-jessie` - linux; amd64
...
### `php:5.6.33-apache-jessie` - linux; arm variant v5
...
### `php:5.6.33-apache-jessie` - linux; arm variant v7
...
### `php:5.6.33-apache-jessie` - linux; arm64 variant v8
...
### `php:5.6.33-apache-jessie` - linux; ppc64le
