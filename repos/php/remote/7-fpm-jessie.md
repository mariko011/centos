...
```console
$ docker pull php@sha256:d8ebbb9f1146af10ec9b05943f82197d99b92d6e25516d82291f6d50419f4f4b
```
...
### `php:7-fpm-jessie` - linux; arm variant v5
...
### `php:7-fpm-jessie` - linux; arm variant v7
...
### `php:7-fpm-jessie` - linux; arm64 variant v8

```console
$ docker pull php@sha256:841f10b5ea9c662c89c11d7481e34399e433367f717be5e534e2f6ef0d329e59
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.5 MB (139487650 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2742e13ee39d94cfab5aa3a0835b2d582fb22d513dd317dcad91df9f882671d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7-fpm-jessie` - linux; ppc64le

```console
$ docker pull php@sha256:244639fcb29a3c39402d75256fc8e2ebd7060ea592938d3747994b624f2c637d
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.5 MB (147502219 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c72e073ed1c37fe5dcc27ebbf76cfe80642d4a9773ec38145fd6730be79f793`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
