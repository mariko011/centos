...
### `php:7.0.24-fpm-jessie` - linux; arm variant v5
...
### `php:7.0.24-fpm-jessie` - linux; arm variant v7
...
### `php:7.0.24-fpm-jessie` - linux; arm64 variant v8
...
### `php:7.0.24-fpm-jessie` - linux; 386
...
### `php:7.0.24-fpm-jessie` - linux; ppc64le
...
### `php:7.0.24-fpm-jessie` - linux; s390x
