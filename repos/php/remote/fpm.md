...
```console
$ docker pull php@sha256:5fbfab835c4a9cbb17c0ed168f759cbceb32a3b0f39c6a5dbb2ce15bb5aed9c4
```
...
```console
$ docker pull php@sha256:298a04b089fb2d9b1259cecb3686e65f0c8fd3c14a45b126a2b6b3a70784e2eb
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **136.1 MB (136077762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7aefad749574a184c7ed58cbde65bfd8eeb026793a98b5b5b3cf8878206d81d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
