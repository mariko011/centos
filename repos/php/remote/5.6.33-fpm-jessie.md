...
### `php:5.6.33-fpm-jessie` - linux; amd64
...
### `php:5.6.33-fpm-jessie` - linux; arm variant v5
...
### `php:5.6.33-fpm-jessie` - linux; arm variant v7
...
### `php:5.6.33-fpm-jessie` - linux; arm64 variant v8
...
### `php:5.6.33-fpm-jessie` - linux; 386
...
### `php:5.6.33-fpm-jessie` - linux; ppc64le
