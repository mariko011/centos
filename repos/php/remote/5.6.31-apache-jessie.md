...
```console
$ docker pull php@sha256:e49b2bf3f4f15ea59c5adf8fac44bd6136e0c46406affd47c2658ec16ee80d4e
```
...
### `php:5.6.31-apache-jessie` - linux; amd64
...
### `php:5.6.31-apache-jessie` - linux; arm variant v5
...
### `php:5.6.31-apache-jessie` - linux; arm variant v7
...
### `php:5.6.31-apache-jessie` - linux; arm64 variant v8
...
### `php:5.6.31-apache-jessie` - linux; 386
...
### `php:5.6.31-apache-jessie` - linux; ppc64le

```console
$ docker pull php@sha256:73ca45a642a99b369c19c7cffb3aff1986fe36b16a9b8fcc158f80ad926688cc
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.6 MB (146601541 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60f0b6c13146714ee0c83f44153578780196e7f356a46cdd2cefbd5c40474c6d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:5.6.31-apache-jessie` - linux; s390x
