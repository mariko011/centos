...
```console
$ docker pull php@sha256:86974711cdec412efb92dfb3b39cb12d9e5b40b1e0f6c8cbb45086eb2b8dbbaf
```
...
```console
$ docker pull php@sha256:72edc5a44f71b4ab4b2d2d6278bc0864a7dd157d61b124d25593cee5a34365b8
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.7 MB (30738342 bytes)**  
