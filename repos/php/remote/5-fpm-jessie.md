...
```console
$ docker pull php@sha256:bc947d425d699dcf26fccaaac12a738d18d44fab012b30477ab243e97ec8c75b
```
...
```console
$ docker pull php@sha256:fa7267918e9552ac35b2f6b1895c6b5bbca7cd2080ec130daee40986b4e18fc6
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.1 MB (143132711 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da5032a981e42269af498db27bdd319ad394609e3e9b3529113248e8d3c6a309`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
