...
```console
$ docker pull php@sha256:2fa4f259efed4c27abccdb15e44716a8fc8e548686eaeb84ca0d1f6eb8fd1124
```
...
```console
$ docker pull php@sha256:e28707ea594dffbca29b1adc09092d463020224ece3485386a117f7e4cf28db3
```
