...
- Created: `2016-10-19T17:28:40.613831687Z`
- Arch: `linux`/`amd64`
...
- Environment:
  ...
  - `GOSU_VERSION=1.7`
  - `MARIADB_MAJOR=5.5`
  - `MARIADB_VERSION=5.5.53+maria-1~wheezy`
...
### `dpkg` source package: `libdbd-mysql-perl=4.021-1+deb7u2`
...
```console
$ apt-get source -qq --print-uris libdbd-mysql-perl=4.021-1+deb7u2
'http://security.debian.org/pool/updates/main/libd/libdbd-mysql-perl/libdbd-mysql-perl_4.021-1+deb7u2.dsc' libdbd-mysql-perl_4.021-1+deb7u2.dsc 2221 SHA256:e44d2748c0399db939a7bddf94c2e91a28181c1958e7e17afe9cb10ca1010926
...
'http://security.debian.org/pool/updates/main/libd/libdbd-mysql-perl/libdbd-mysql-perl_4.021-1+deb7u2.debian.tar.gz' libdbd-mysql-perl_4.021-1+deb7u2.debian.tar.gz 10341 SHA256:16e281750c1a6648e4950917726f9dd969697b3e0f1aa9fbe10d78b990400bfe
```

Likely also available for browsing at:

- https://sources.debian.net/src/libdbd-mysql-perl/4.021-1+deb7u2/
- https://sources.debian.net/src/libdbd-mysql-perl/4.021-1+deb7u2/debian/copyright (for direct copyright/license information)
...
### `dpkg` source package: `mariadb-5.5=5.5.53+maria-1~wheezy`

Binary Packages:

- `libmariadbclient18=5.5.53+maria-1~wheezy`
- `libmysqlclient18=5.5.53+maria-1~wheezy`
- `mariadb-client-5.5=5.5.53+maria-1~wheezy`
- `mariadb-client-core-5.5=5.5.53+maria-1~wheezy`
- `mariadb-common=5.5.53+maria-1~wheezy`
- `mariadb-server=5.5.53+maria-1~wheezy`
- `mariadb-server-5.5=5.5.53+maria-1~wheezy`
- `mariadb-server-core-5.5=5.5.53+maria-1~wheezy`
- `mysql-common=5.5.53+maria-1~wheezy`
...
```console
$ apt-get source -qq --print-uris mariadb-5.5=5.5.53+maria-1~wheezy
'http://ftp.osuosl.org/pub/mariadb/repo/5.5/debian/pool/main/m/mariadb-5.5/mariadb-5.5_5.5.53+maria-1~wheezy.dsc' mariadb-5.5_5.5.53+maria-1~wheezy.dsc 1957 SHA256:801d610609e0c541a8676f7a0a67bb893a3b0d6486a0f1f259d9f43c2192ee20
'http://ftp.osuosl.org/pub/mariadb/repo/5.5/debian/pool/main/m/mariadb-5.5/mariadb-5.5_5.5.53+maria-1~wheezy.tar.gz' mariadb-5.5_5.5.53+maria-1~wheezy.tar.gz 45119713 SHA256:3109a214cc58941f6b735cd5ae04fb290c9072affba67625beaf2295e480b424
```
