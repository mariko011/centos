...
- Created: `2017-12-26T20:37:16.901978602Z`
- Virtual Size: ~ 399.33 Mb  
...
- Environment:
  ...
  - `MARIADB_MAJOR=10.3`
  - `MARIADB_VERSION=10.3.3+maria~jessie`
...
### `dpkg` source package: `mariadb-10.3=10.3.3+maria~jessie`

Binary Packages:

- `libmariadb3=10.3.3+maria~jessie`
- `libmysqlclient18=10.3.3+maria~jessie`
- `mariadb-client-10.3=10.3.3+maria~jessie`
- `mariadb-client-core-10.3=10.3.3+maria~jessie`
- `mariadb-common=10.3.3+maria~jessie`
- `mariadb-server=10.3.3+maria~jessie`
- `mariadb-server-10.3=10.3.3+maria~jessie`
- `mariadb-server-core-10.3=10.3.3+maria~jessie`
- `mysql-common=10.3.3+maria~jessie`
