...
- Created: `2017-09-13T11:42:40.751359101Z`
- Virtual Size: ~ 280.20 Mb  
...
- Environment:
  ...
  - `MARIADB_MAJOR=5.5`
  - `MARIADB_VERSION=5.5.57+maria-1~wheezy`
...
'http://security.debian.org/pool/updates/main/libd/libdbd-mysql-perl/libdbd-mysql-perl_4.021-1+deb7u3.dsc' libdbd-mysql-perl_4.021-1+deb7u3.dsc 2253 SHA256:5b6f60ac94f52cbabc58096794f4ae045c447a16196d1d1ca7e8d6405ef52751
...
'http://security.debian.org/pool/updates/main/libd/libdbd-mysql-perl/libdbd-mysql-perl_4.021-1+deb7u3.debian.tar.gz' libdbd-mysql-perl_4.021-1+deb7u3.debian.tar.gz 16284 SHA256:2980ca50eaa38dff4f901180a0ba6b16fc18181dc6396a924e0a7861de33f941
```
...
### `dpkg` source package: `mariadb-5.5=5.5.57+maria-1~wheezy`

Binary Packages:

- `libmariadbclient18=5.5.57+maria-1~wheezy`
- `libmysqlclient18=5.5.57+maria-1~wheezy`
- `mariadb-client-5.5=5.5.57+maria-1~wheezy`
- `mariadb-client-core-5.5=5.5.57+maria-1~wheezy`
- `mariadb-common=5.5.57+maria-1~wheezy`
- `mariadb-server=5.5.57+maria-1~wheezy`
- `mariadb-server-5.5=5.5.57+maria-1~wheezy`
- `mariadb-server-core-5.5=5.5.57+maria-1~wheezy`
- `mysql-common=5.5.57+maria-1~wheezy`
...
```console
$ apt-get source -qq --print-uris mariadb-5.5=5.5.57+maria-1~wheezy
'http://ftp.osuosl.org/pub/mariadb/repo/5.5/debian/pool/main/m/mariadb-5.5/mariadb-5.5_5.5.57+maria-1~wheezy.dsc' mariadb-5.5_5.5.57+maria-1~wheezy.dsc 1957 SHA256:46d8964e06b2614f7ddc830ddca6ae5c1788be1a1d612d6fa9798c1d187ad9f2
'http://ftp.osuosl.org/pub/mariadb/repo/5.5/debian/pool/main/m/mariadb-5.5/mariadb-5.5_5.5.57+maria-1~wheezy.tar.gz' mariadb-5.5_5.5.57+maria-1~wheezy.tar.gz 45168687 SHA256:c90d17f8bcbd89a19787a0aaef31fc05d450133aeabce08e28d7a78d134edf2a
```
...
### `dpkg` source package: `percona-xtrabackup=2.3.9-1.wheezy`

Binary Packages:

- `percona-xtrabackup=2.3.9-1.wheezy`
...
- https://sources.debian.net/src/psmisc/22.19-1+deb7u1/ (for browsing the source)
- https://sources.debian.net/src/psmisc/22.19-1+deb7u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/psmisc/22.19-1+deb7u1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/p/pwgen/pwgen_2.06-1.dsc' pwgen_2.06-1.dsc 556 SHA256:48c72351cc54301917bf17bbfd706a9f677ffca55358835944239eccaca54301
'http://deb.debian.org/debian/pool/main/p/pwgen/pwgen_2.06-1.diff.gz' pwgen_2.06-1.diff.gz 20 SHA256:99201575a5579e34ce244339e4c5092a3f51c4b3041781eef05db856d09436f9
'http://deb.debian.org/debian/pool/main/p/pwgen/pwgen_2.06.orig.tar.gz' pwgen_2.06.orig.tar.gz 30952 SHA256:61598c9e3a0f7eb2e7367d4ecc71522c4f16a7d41ed31db29e3afee8d9843454
```

Other potentially useful URLs:

- https://sources.debian.net/src/pwgen/2.06-1/ (for browsing the source)
- https://sources.debian.net/src/pwgen/2.06-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pwgen/2.06-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/r/readline5/readline5_5.2+dfsg-2~deb7u1.dsc' readline5_5.2+dfsg-2~deb7u1.dsc 2299 SHA256:529f64706fc2956187b4852c587918451ee22bf2c04d4307ecd534c6d06f1ff5
...
'http://deb.debian.org/debian/pool/main/r/readline5/readline5_5.2+dfsg-2~deb7u1.diff.gz' readline5_5.2+dfsg-2~deb7u1.diff.gz 27240 SHA256:799b5f3d11631194f12c59a99b017aa84558ca9dd2e0c1242be8c6f80ee1acb9
```

Other potentially useful URLs:

- https://sources.debian.net/src/readline5/5.2+dfsg-2~deb7u1/ (for browsing the source)
- https://sources.debian.net/src/readline5/5.2+dfsg-2~deb7u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/readline5/5.2+dfsg-2~deb7u1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/r/rsync/rsync_3.0.9-4.dsc' rsync_3.0.9-4.dsc 1014 SHA256:7ad4706716f96882c5cffdf2b6f2e0908fd99e5ad01c484f3725c08ec7c2a7b3
'http://deb.debian.org/debian/pool/main/r/rsync/rsync_3.0.9.orig.tar.gz' rsync_3.0.9.orig.tar.gz 792725 SHA256:30f10f8dd5490d28240d4271bb652b1da7a60b22ed2b9ae28090668de9247c05
'http://deb.debian.org/debian/pool/main/r/rsync/rsync_3.0.9-4.diff.gz' rsync_3.0.9-4.diff.gz 21527 SHA256:690492111a40cbe1a0d930773c427dd6edbd5efbff8ef444ed63250a07c33e6b
```

Other potentially useful URLs:

- https://sources.debian.net/src/rsync/3.0.9-4/ (for browsing the source)
- https://sources.debian.net/src/rsync/3.0.9-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/rsync/3.0.9-4/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/s/socat/socat_1.7.1.3-1.4.dsc' socat_1.7.1.3-1.4.dsc 1097 SHA256:971b82bfd97131cbbe37b7f2eaa881c2b369a8b9a7a71c486c59af44b559ef80
'http://deb.debian.org/debian/pool/main/s/socat/socat_1.7.1.3.orig.tar.gz' socat_1.7.1.3.orig.tar.gz 553489 SHA256:d6c2e6cae5e790c5fd875c19818c1be14234afe5a137fd78663cb85f828c4976
'http://deb.debian.org/debian/pool/main/s/socat/socat_1.7.1.3-1.4.debian.tar.gz' socat_1.7.1.3-1.4.debian.tar.gz 13329 SHA256:faaad4267330bf84f112f1536e760d93c95b4dd99647f9d47cd54292ca4143bd
```

Other potentially useful URLs:

- https://sources.debian.net/src/socat/1.7.1.3-1.4/ (for browsing the source)
- https://sources.debian.net/src/socat/1.7.1.3-1.4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/socat/1.7.1.3-1.4/ (for access to the source package after it no longer exists in the archive)
