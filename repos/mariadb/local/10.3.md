...
- Created: `2017-06-23T00:28:16.5347664Z`
- Virtual Size: ~ 387.46 Mb  
...
- Environment:
  ...
  - `MARIADB_MAJOR=10.3`
  - `MARIADB_VERSION=10.3.0+maria~jessie`
...
### `dpkg` source package: `mariadb-10.3=10.3.0+maria~jessie`

Binary Packages:

- `libmariadb3=10.3.0+maria~jessie`
- `libmysqlclient18=10.3.0+maria~jessie`
- `mariadb-client-10.3=10.3.0+maria~jessie`
- `mariadb-client-core-10.3=10.3.0+maria~jessie`
- `mariadb-common=10.3.0+maria~jessie`
- `mariadb-server=10.3.0+maria~jessie`
- `mariadb-server-10.3=10.3.0+maria~jessie`
- `mariadb-server-core-10.3=10.3.0+maria~jessie`
- `mysql-common=10.3.0+maria~jessie`
