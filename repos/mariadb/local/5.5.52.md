...
- Created: `2016-09-16T19:28:49.70585136Z`
- Arch: `linux`/`amd64`
...
- Environment:
  ...
  - `GOSU_VERSION=1.7`
  - `MARIADB_MAJOR=5.5`
  - `MARIADB_VERSION=5.5.52+maria-1~wheezy`
...
### `dpkg` source package: `curl=7.26.0-1+wheezy15`

Binary Packages:

- `libcurl3:amd64=7.26.0-1+wheezy15`
...
```console
$ apt-get source -qq --print-uris curl=7.26.0-1+wheezy15
'http://security.debian.org/pool/updates/main/c/curl/curl_7.26.0-1+wheezy15.dsc' curl_7.26.0-1+wheezy15.dsc 2520 SHA256:e01cc16b3c6c6f601403a596e90ef3d4355980438a253820a08b44c379aa6cca
...
'http://security.debian.org/pool/updates/main/c/curl/curl_7.26.0-1+wheezy15.debian.tar.gz' curl_7.26.0-1+wheezy15.debian.tar.gz 46292 SHA256:2ba69eb4a5b2d5cc2008c2630df73b41a1b2856573cb9f1f7cdd0193918e9ad8
```

Likely also available for browsing at:

- https://sources.debian.net/src/curl/7.26.0-1+wheezy15/
- https://sources.debian.net/src/curl/7.26.0-1+wheezy15/debian/copyright (for direct copyright/license information)
...
'http://httpredir.debian.org/debian/pool/main/liba/libaio/libaio_0.3.109-3.dsc' libaio_0.3.109-3.dsc 1347 SHA256:e6f1b7ec5cff3194a1df51c11c7e8ca463e069a6750d80915d10cc612e591d3b
'http://httpredir.debian.org/debian/pool/main/liba/libaio/libaio_0.3.109.orig.tar.gz' libaio_0.3.109.orig.tar.gz 52234 SHA256:bf4a457253cbaab215aea75cb6e18dc8d95bbd507e9920661ff9bdd288c8778d
'http://httpredir.debian.org/debian/pool/main/liba/libaio/libaio_0.3.109-3.debian.tar.gz' libaio_0.3.109-3.debian.tar.gz 26875 SHA256:cdfccc2842bcc60eacc009a72a4fa335ade793454ec87b20d1470f13bedac340
```

Likely also available for browsing at:

- https://sources.debian.net/src/libaio/0.3.109-3/
...
### `dpkg` source package: `libdbd-mysql-perl=4.021-1+deb7u1`
...
```console
$ apt-get source -qq --print-uris libdbd-mysql-perl=4.021-1+deb7u1
'http://security.debian.org/pool/updates/main/libd/libdbd-mysql-perl/libdbd-mysql-perl_4.021-1+deb7u1.dsc' libdbd-mysql-perl_4.021-1+deb7u1.dsc 2366 SHA256:7e999065f1f1fb6d2d6358cc10631b93124b10dc6fabc33540776a34c5862cea
'http://security.debian.org/pool/updates/main/libd/libdbd-mysql-perl/libdbd-mysql-perl_4.021.orig.tar.gz' libdbd-mysql-perl_4.021.orig.tar.gz 138802 SHA256:e3f5d0a7d77ca552cb3fb1e20ba084d84143a7db63e27bca3f4a3291bb3e8e3b
'http://security.debian.org/pool/updates/main/libd/libdbd-mysql-perl/libdbd-mysql-perl_4.021-1+deb7u1.debian.tar.gz' libdbd-mysql-perl_4.021-1+deb7u1.debian.tar.gz 9783 SHA256:51ebaae9364b1e31d5e4c3b24f16119814a4a85d17deeaa4cef77ec7c69f1961
```

Likely also available for browsing at:

- https://sources.debian.net/src/libdbd-mysql-perl/4.021-1+deb7u1/
- https://sources.debian.net/src/libdbd-mysql-perl/4.021-1+deb7u1/debian/copyright (for direct copyright/license information)
...
'http://httpredir.debian.org/debian/pool/main/libd/libdbi-perl/libdbi-perl_1.622-1+deb7u1.dsc' libdbi-perl_1.622-1+deb7u1.dsc 2335 SHA256:8eeb74752ea76128184f4c101a27d42eb4b481649e5beb3420d7cf8e0c8c2abb
'http://httpredir.debian.org/debian/pool/main/libd/libdbi-perl/libdbi-perl_1.622.orig.tar.gz' libdbi-perl_1.622.orig.tar.gz 585651 SHA256:6e91c47bf4c8413b6f436d96a62725b837ff76231c8d1aef7527025a7d86013c
'http://httpredir.debian.org/debian/pool/main/libd/libdbi-perl/libdbi-perl_1.622-1+deb7u1.debian.tar.gz' libdbi-perl_1.622-1+deb7u1.debian.tar.gz 12820 SHA256:a88cf058d06a8a0ab9933974dfc9435f93b5b371ef58d3eb6bab97b12a8e5b9a
```

Likely also available for browsing at:

- https://sources.debian.net/src/libdbi-perl/1.622-1+deb7u1/
...
'http://httpredir.debian.org/debian/pool/main/libe/libev/libev_4.11-1.dsc' libev_4.11-1.dsc 1309 SHA256:88f186b9d548cfb693766c5f48429e82336f6505fa03db227fd504cdcf5c4ff7
'http://httpredir.debian.org/debian/pool/main/libe/libev/libev_4.11.orig.tar.gz' libev_4.11.orig.tar.gz 481962 SHA256:bf069a14f60e633a83b87d08a894052cf3ede588bf8d47da94142121df6e8276
'http://httpredir.debian.org/debian/pool/main/libe/libev/libev_4.11-1.debian.tar.gz' libev_4.11-1.debian.tar.gz 4410 SHA256:588885e7265780dea4a4edd5f8a46100bc69c42fcadf273266c68c4840b2fa7b
```

Likely also available for browsing at:

- https://sources.debian.net/src/libev/1:4.11-1/
...
'http://httpredir.debian.org/debian/pool/main/libh/libhtml-template-perl/libhtml-template-perl_2.91-1.dsc' libhtml-template-perl_2.91-1.dsc 2157 SHA256:dd044402cd4ec33020b5292afc0b21649fcfac4c38343c2a18d3742dc57ff69c
'http://httpredir.debian.org/debian/pool/main/libh/libhtml-template-perl/libhtml-template-perl_2.91.orig.tar.gz' libhtml-template-perl_2.91.orig.tar.gz 89335 SHA256:63766170447e8441939f30ba6e88d432328b006bae3a6bea2d1c6e53a879447f
'http://httpredir.debian.org/debian/pool/main/libh/libhtml-template-perl/libhtml-template-perl_2.91-1.debian.tar.gz' libhtml-template-perl_2.91-1.debian.tar.gz 3282 SHA256:979a8c323bb9b3d499aea0662ec6e0bf0002c37e84b20dcbb7bac93e54f5065f
```

Likely also available for browsing at:

- https://sources.debian.net/src/libhtml-template-perl/2.91-1/
...
### `dpkg` source package: `mariadb-5.5=5.5.52+maria-1~wheezy`

Binary Packages:

- `libmariadbclient18=5.5.52+maria-1~wheezy`
- `libmysqlclient18=5.5.52+maria-1~wheezy`
- `mariadb-client-5.5=5.5.52+maria-1~wheezy`
- `mariadb-client-core-5.5=5.5.52+maria-1~wheezy`
- `mariadb-common=5.5.52+maria-1~wheezy`
- `mariadb-server=5.5.52+maria-1~wheezy`
- `mariadb-server-5.5=5.5.52+maria-1~wheezy`
- `mariadb-server-core-5.5=5.5.52+maria-1~wheezy`
- `mysql-common=5.5.52+maria-1~wheezy`
...
```console
$ apt-get source -qq --print-uris mariadb-5.5=5.5.52+maria-1~wheezy
'http://ftp.osuosl.org/pub/mariadb/repo/5.5/debian/pool/main/m/mariadb-5.5/mariadb-5.5_5.5.52+maria-1~wheezy.dsc' mariadb-5.5_5.5.52+maria-1~wheezy.dsc 1957 SHA256:18944d8ca56e377a3c702220df0ff1e948bd3dfe8141f5e359ae46625efe31c0
'http://ftp.osuosl.org/pub/mariadb/repo/5.5/debian/pool/main/m/mariadb-5.5/mariadb-5.5_5.5.52+maria-1~wheezy.tar.gz' mariadb-5.5_5.5.52+maria-1~wheezy.tar.gz 45115561 SHA256:07459d75fb26d5839d3a12f060eae5073b27f2a336ebecddc2da12d5af36014f
```
...
### `dpkg` source package: `percona-xtrabackup=2.3.5-1.wheezy`

Binary Packages:

- `percona-xtrabackup=2.3.5-1.wheezy`
...
### `dpkg` source package: `pwgen=2.06-1`
...
```console
$ apt-get source -qq --print-uris pwgen=2.06-1
'http://httpredir.debian.org/debian/pool/main/p/pwgen/pwgen_2.06-1.dsc' pwgen_2.06-1.dsc 556 SHA256:48c72351cc54301917bf17bbfd706a9f677ffca55358835944239eccaca54301
'http://httpredir.debian.org/debian/pool/main/p/pwgen/pwgen_2.06-1.diff.gz' pwgen_2.06-1.diff.gz 20 SHA256:99201575a5579e34ce244339e4c5092a3f51c4b3041781eef05db856d09436f9
'http://httpredir.debian.org/debian/pool/main/p/pwgen/pwgen_2.06.orig.tar.gz' pwgen_2.06.orig.tar.gz 30952 SHA256:61598c9e3a0f7eb2e7367d4ecc71522c4f16a7d41ed31db29e3afee8d9843454
```

Likely also available for browsing at:

- https://sources.debian.net/src/pwgen/2.06-1/
- https://sources.debian.net/src/pwgen/2.06-1/debian/copyright (for direct copyright/license information)

### `dpkg` source package: `readline5=5.2+dfsg-2~deb7u1`
...
```console
$ apt-get source -qq --print-uris readline5=5.2+dfsg-2~deb7u1
'http://httpredir.debian.org/debian/pool/main/r/readline5/readline5_5.2+dfsg-2~deb7u1.dsc' readline5_5.2+dfsg-2~deb7u1.dsc 2299 SHA256:529f64706fc2956187b4852c587918451ee22bf2c04d4307ecd534c6d06f1ff5
...
'http://httpredir.debian.org/debian/pool/main/r/readline5/readline5_5.2+dfsg-2~deb7u1.diff.gz' readline5_5.2+dfsg-2~deb7u1.diff.gz 27240 SHA256:799b5f3d11631194f12c59a99b017aa84558ca9dd2e0c1242be8c6f80ee1acb9
```

Likely also available for browsing at:

- https://sources.debian.net/src/readline5/5.2+dfsg-2~deb7u1/
- https://sources.debian.net/src/readline5/5.2+dfsg-2~deb7u1/debian/copyright (for direct copyright/license information)
...
### `dpkg` source package: `rsync=3.0.9-4`
...
```console
$ apt-get source -qq --print-uris rsync=3.0.9-4
'http://httpredir.debian.org/debian/pool/main/r/rsync/rsync_3.0.9-4.dsc' rsync_3.0.9-4.dsc 1014 SHA256:7ad4706716f96882c5cffdf2b6f2e0908fd99e5ad01c484f3725c08ec7c2a7b3
'http://httpredir.debian.org/debian/pool/main/r/rsync/rsync_3.0.9.orig.tar.gz' rsync_3.0.9.orig.tar.gz 792725 SHA256:30f10f8dd5490d28240d4271bb652b1da7a60b22ed2b9ae28090668de9247c05
'http://httpredir.debian.org/debian/pool/main/r/rsync/rsync_3.0.9-4.diff.gz' rsync_3.0.9-4.diff.gz 21527 SHA256:690492111a40cbe1a0d930773c427dd6edbd5efbff8ef444ed63250a07c33e6b
```

Likely also available for browsing at:

- https://sources.debian.net/src/rsync/3.0.9-4/
- https://sources.debian.net/src/rsync/3.0.9-4/debian/copyright (for direct copyright/license information)
...
### `dpkg` source package: `socat=1.7.1.3-1.4`
...
```console
$ apt-get source -qq --print-uris socat=1.7.1.3-1.4
'http://httpredir.debian.org/debian/pool/main/s/socat/socat_1.7.1.3-1.4.dsc' socat_1.7.1.3-1.4.dsc 1097 SHA256:971b82bfd97131cbbe37b7f2eaa881c2b369a8b9a7a71c486c59af44b559ef80
'http://httpredir.debian.org/debian/pool/main/s/socat/socat_1.7.1.3.orig.tar.gz' socat_1.7.1.3.orig.tar.gz 553489 SHA256:d6c2e6cae5e790c5fd875c19818c1be14234afe5a137fd78663cb85f828c4976
'http://httpredir.debian.org/debian/pool/main/s/socat/socat_1.7.1.3-1.4.debian.tar.gz' socat_1.7.1.3-1.4.debian.tar.gz 13329 SHA256:faaad4267330bf84f112f1536e760d93c95b4dd99647f9d47cd54292ca4143bd
```

Likely also available for browsing at:

- https://sources.debian.net/src/socat/1.7.1.3-1.4/
- https://sources.debian.net/src/socat/1.7.1.3-1.4/debian/copyright (for direct copyright/license information)
