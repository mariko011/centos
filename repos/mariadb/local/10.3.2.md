...
- Created: `2017-11-16T00:40:53.610550007Z`
- Virtual Size: ~ 396.77 Mb  
...
- Environment:
  ...
  - `MARIADB_MAJOR=10.3`
  - `MARIADB_VERSION=10.3.2+maria~jessie`
...
### `dpkg` source package: `mariadb-10.3=10.3.2+maria~jessie`

Binary Packages:

- `libmariadb3=10.3.2+maria~jessie`
- `libmysqlclient18=10.3.2+maria~jessie`
- `mariadb-client-10.3=10.3.2+maria~jessie`
- `mariadb-client-core-10.3=10.3.2+maria~jessie`
- `mariadb-common=10.3.2+maria~jessie`
- `mariadb-server=10.3.2+maria~jessie`
- `mariadb-server-10.3=10.3.2+maria~jessie`
- `mariadb-server-core-10.3=10.3.2+maria~jessie`
- `mysql-common=10.3.2+maria~jessie`
