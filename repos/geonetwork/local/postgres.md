...
- Image ID: `sha256:15e5d1febb755b9ccfa596b65c650a3d191c05fef6cd84fdcda6090b4cef5812`
- Created: `2017-10-04T00:43:14.775313463Z`
- Virtual Size: ~ 893.77 Mb  
...
- Environment:
  ...
  - `TOMCAT_SHA1=2b5a0d173040f9a576e372cae5d85b05599fd0eb`
  - `TOMCAT_TGZ_URLS=https://www.apache.org/dyn/closer.cgi?action=download&filename=tomcat/tomcat-8/v8.0.47/bin/apache-tomcat-8.0.47.tar.gz 	https://www-us.apache.org/dist/tomcat/tomcat-8/v8.0.47/bin/apache-tomcat-8.0.47.tar.gz 	https://www.apache.org/dist/tomcat/tomcat-8/v8.0.47/bin/apache-tomcat-8.0.47.tar.gz 	https://archive.apache.org/dist/tomcat/tomcat-8/v8.0.47/bin/apache-tomcat-8.0.47.tar.gz`
  - `TOMCAT_ASC_URLS=https://www.apache.org/dyn/closer.cgi?action=download&filename=tomcat/tomcat-8/v8.0.47/bin/apache-tomcat-8.0.47.tar.gz.asc 	https://www-us.apache.org/dist/tomcat/tomcat-8/v8.0.47/bin/apache-tomcat-8.0.47.tar.gz.asc 	https://www.apache.org/dist/tomcat/tomcat-8/v8.0.47/bin/apache-tomcat-8.0.47.tar.gz.asc 	https://archive.apache.org/dist/tomcat/tomcat-8/v8.0.47/bin/apache-tomcat-8.0.47.tar.gz.asc`
  ...
  - `GN_VERSION=3.2.2`
  - `GN_DOWNLOAD_MD5=93b5279223503106ffeea3e9ca697805`
...
```console
$ apt-get source -qq --print-uris postgresql-common=181
'http://deb.debian.org/debian/pool/main/p/postgresql-common/postgresql-common_181.dsc' postgresql-common_181.dsc 2344 SHA256:9b3369a549a6929bd57d4412d2c34fa7ef6d8ea8e10cdd6919a1ef63efa1d1fa
'http://deb.debian.org/debian/pool/main/p/postgresql-common/postgresql-common_181.tar.xz' postgresql-common_181.tar.xz 201868 SHA256:fe340964e0ca66e364ca2ee6690432b1bfb26bbaba81a46fba5525631b93e43c
```

Other potentially useful URLs:

- https://sources.debian.net/src/postgresql-common/181/ (for browsing the source)
- https://sources.debian.net/src/postgresql-common/181/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/postgresql-common/181/ (for access to the source package after it no longer exists in the archive)
