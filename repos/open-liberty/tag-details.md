...
```console
$ docker pull open-liberty@sha256:bf2c5a21b59d5bb20c05ea31b71c2cf87ba831eb58bba1366cb1ff16639c731f
```
...
```console
$ docker pull open-liberty@sha256:44420553048c5c66c8cc836626a1ab5e1fec6fc5d027a1642af4e772ced67db6
```
...
```console
$ docker pull open-liberty@sha256:f0ba2ba2fb62f99fcbb9e45d7ab47a0a86c4c890fa99e6c6d4a317f982220996
```
