...
- Created: `2017-10-02T17:45:28.317063906Z`
- Virtual Size: ~ 651.26 Mb  
...
### `dpkg` source package: `binutils=2.29.1-4`

Binary Packages:

- `binutils=2.29.1-4`
- `binutils-common:amd64=2.29.1-4`
- `binutils-x86-64-linux-gnu=2.29.1-4`
- `libbinutils:amd64=2.29.1-4`
...
### `dpkg` source package: `cdbs=0.4.152`
...
```console
$ apt-get source -qq --print-uris cdbs=0.4.152
'http://deb.debian.org/debian/pool/main/c/cdbs/cdbs_0.4.152.dsc' cdbs_0.4.152.dsc 1878 SHA256:a7e8c1df8fb3628b31bfa9554ea674a89cc454a69f9c67c1b390d0c27fff91f1
'http://deb.debian.org/debian/pool/main/c/cdbs/cdbs_0.4.152.tar.xz' cdbs_0.4.152.tar.xz 204592 SHA256:9f5ca38819309906d465038ef8e6955db8b63ca793a69d6d10ec84b35581243c
```

Other potentially useful URLs:

- https://sources.debian.net/src/cdbs/0.4.152/ (for browsing the source)
- https://sources.debian.net/src/cdbs/0.4.152/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/cdbs/0.4.152/ (for access to the source package after it no longer exists in the archive)
...
- http://snapshot.debian.org/package/gcc-6/6.4.0-4/
...
- `gfortran-7=7.2.0-8`
- `libasan4:amd64=7.2.0-8`
- `libatomic1:amd64=7.2.0-8`
- `libcc1-0:amd64=7.2.0-8`
- `libcilkrts5:amd64=7.2.0-8`
- `libgcc-7-dev:amd64=7.2.0-8`
- `libgcc1:amd64=1:7.2.0-8`
- `libgfortran-7-dev:amd64=7.2.0-8`
- `libgfortran4:amd64=7.2.0-8`
- `libgomp1:amd64=7.2.0-8`
- `libitm1:amd64=7.2.0-8`
- `liblsan0:amd64=7.2.0-8`
- `libmpx2:amd64=7.2.0-8`
- `libquadmath0:amd64=7.2.0-8`
- `libstdc++-7-dev:amd64=7.2.0-8`
- `libstdc++6:amd64=7.2.0-8`
- `libtsan0:amd64=7.2.0-8`
- `libubsan0:amd64=7.2.0-8`
...
- https://sources.debian.net/src/gnupg2/2.1.23-2/ (for browsing the source)
- https://sources.debian.net/src/gnupg2/2.1.23-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gnupg2/2.1.23-2/ (for access to the source package after it no longer exists in the archive)
...
- https://sources.debian.net/src/lapack/3.7.1-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lapack/3.7.1-4/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `lattice=0.20-35-1`

Binary Packages:

- `r-cran-lattice=0.20-35-1+b1`
...
- https://sources.debian.net/src/less/481-2.1/ (for browsing the source)
- https://sources.debian.net/src/less/481-2.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/less/481-2.1/ (for access to the source package after it no longer exists in the archive)
...
- http://snapshot.debian.org/package/libpsl/0.18.0-2/
...
### `dpkg` source package: `linux=4.12.13-1`

Binary Packages:

- `linux-libc-dev:amd64=4.12.13-1`
...
```console
$ apt-get source -qq --print-uris linux=4.12.13-1
'http://deb.debian.org/debian/pool/main/l/linux/linux_4.12.13-1.dsc' linux_4.12.13-1.dsc 124916 SHA256:0fb0b974a6ab9b6a7af007c12b1b2e03dc4f63b43b43df32e017ffc61f8be485
'http://deb.debian.org/debian/pool/main/l/linux/linux_4.12.13.orig.tar.xz' linux_4.12.13.orig.tar.xz 100227000 SHA256:916e55af206735521ba8a6983183a38c867033518638aa398224c316f56e835a
'http://deb.debian.org/debian/pool/main/l/linux/linux_4.12.13-1.debian.tar.xz' linux_4.12.13-1.debian.tar.xz 2794128 SHA256:2a5673037e5534215695a095c62ab2c984c4cbb048f7230982adbbad1eb52c07
```

Other potentially useful URLs:

- https://sources.debian.net/src/linux/4.12.13-1/ (for browsing the source)
- https://sources.debian.net/src/linux/4.12.13-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/linux/4.12.13-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mgcv=1.8-22-1`

Binary Packages:

- `r-cran-mgcv=1.8-22-1+b1`
...
- https://sources.debian.net/src/ncurses/6.0+20170715-2/ (for browsing the source)
- https://sources.debian.net/src/ncurses/6.0+20170715-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ncurses/6.0+20170715-2/ (for access to the source package after it no longer exists in the archive)
...
- `libpcre16-3:amd64=2:8.39-5`
- `libpcre3:amd64=2:8.39-5`
- `libpcre3-dev:amd64=2:8.39-5`
- `libpcre32-3:amd64=2:8.39-5`
- `libpcrecpp0v5:amd64=2:8.39-5`
...
### `dpkg` source package: `r-base=3.4.2-1`
...
### `dpkg` source package: `rmatrix=1.2-11-1`

Binary Packages:

- `r-cran-matrix=1.2-11-1+b1`
...
### `dpkg` source package: `survival=2.41-3-2`

Binary Packages:

- `r-cran-survival=2.41-3-2+b1`
...
- https://sources.debian.net/src/systemd/234-2.3/ (for browsing the source)
- https://sources.debian.net/src/systemd/234-2.3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/systemd/234-2.3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `tcl8.6=8.6.7+dfsg-1`

Binary Packages:

- `libtcl8.6:amd64=8.6.7+dfsg-1`
...
```console
$ apt-get source -qq --print-uris tex-gyre=20160520-1
'http://deb.debian.org/debian/pool/main/t/tex-gyre/tex-gyre_20160520-1.dsc' tex-gyre_20160520-1.dsc 1655 SHA256:8c0b9cf8edadbde0bedc5fd3e68e5f883b760adef926244715d6220e74c8d1f9
'http://deb.debian.org/debian/pool/main/t/tex-gyre/tex-gyre_20160520.orig.tar.gz' tex-gyre_20160520.orig.tar.gz 18834956 SHA256:97b8176f1f02e3d82a83183fd1f1ebd46c797ab19444f9914f3b7e6a42a4390e
'http://deb.debian.org/debian/pool/main/t/tex-gyre/tex-gyre_20160520-1.diff.gz' tex-gyre_20160520-1.diff.gz 13350 SHA256:53ced8d680b20f26d0a3fc8cbd48ca7612e82ea3d7a8479724225e40ec889fb4
```

Other potentially useful URLs:

- https://sources.debian.net/src/tex-gyre/20160520-1/ (for browsing the source)
- https://sources.debian.net/src/tex-gyre/20160520-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/tex-gyre/20160520-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `vim=2:8.0.0197-5`

Binary Packages:

- `vim-common=2:8.0.0197-5`
- `vim-tiny=2:8.0.0197-5+b1`
- `xxd=2:8.0.0197-5+b1`
...
- http://snapshot.debian.org/package/vim/2:8.0.0197-5/
...
### `dpkg` source package: `xauth=1:1.0.9-1`
...
- https://sources.debian.net/src/xdg-utils/1.1.1-1/ (for browsing the source)
- https://sources.debian.net/src/xdg-utils/1.1.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/xdg-utils/1.1.1-1/ (for access to the source package after it no longer exists in the archive)
