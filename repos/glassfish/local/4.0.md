...
- Created: `2016-08-31T20:48:16.965762308Z`
- Arch: `linux`/`amd64`
- Command: `["/bin/sh","-c","asadmin start-domain --verbose"]`
- Environment:
  - `PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/jvm/java-7-openjdk-amd64/bin:/usr/local/glassfish4/bin`
  - `LANG=C.UTF-8`
...
### `dpkg` source package: `inotify-tools=3.14-1`

Binary Packages:

- `inotify-tools=3.14-1+b1`
- `libinotifytools0=3.14-1+b1`

Licenses: (parsed from: `/usr/share/doc/inotify-tools/copyright`, `/usr/share/doc/libinotifytools0/copyright`)
...
```console
$ apt-get source -qq --print-uris inotify-tools=3.14-1
'http://httpredir.debian.org/debian/pool/main/i/inotify-tools/inotify-tools_3.14-1.dsc' inotify-tools_3.14-1.dsc 1473 SHA256:8349a364e21383ed3d6a7d05da8532af093ecf06b4bc8e8c37dd23c9b0bfd50c
'http://httpredir.debian.org/debian/pool/main/i/inotify-tools/inotify-tools_3.14.orig.tar.gz' inotify-tools_3.14.orig.tar.gz 358772 SHA256:222bcca8893d7bf8a1ce207fb39ceead5233b5015623d099392e95197676c92f
'http://httpredir.debian.org/debian/pool/main/i/inotify-tools/inotify-tools_3.14-1.debian.tar.gz' inotify-tools_3.14-1.debian.tar.gz 6443 SHA256:6d2df895932ade3982e6b490dc0c38614a308122cde716e7c080f03f32e31143
```

Likely also available for browsing at:

- https://sources.debian.net/src/inotify-tools/3.14-1/
- https://sources.debian.net/src/inotify-tools/3.14-1/debian/copyright (for direct copyright/license information)
