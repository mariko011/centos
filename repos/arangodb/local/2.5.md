...
- Created: `2016-08-31T01:06:00.941834046Z`
- Arch: `linux`/`amd64`
- Command: `["/usr/sbin/arangod"]`
- Environment:
  - `PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `ARCHITECTURE=amd64`
  - `ARANGO_VERSION=2.5.5`
  - `ARANGO_URL=https://www.arangodb.com/repositories/arangodb2/Debian_8.0`
  - `ARANGO_PACKAGE=arangodb_2.5.5_amd64.deb`
  - `ARANGO_PACKAGE_URL=https://www.arangodb.com/repositories/arangodb2/Debian_8.0/amd64/arangodb_2.5.5_amd64.deb`
  - `ARANGO_SIGNATURE_URL=https://www.arangodb.com/repositories/arangodb2/Debian_8.0/amd64/arangodb_2.5.5_amd64.deb.asc`
...
### `dpkg` source package: `arangodb=2.5.5`

Binary Packages:

- `arangodb=2.5.5`

Licenses: (parsed from: `/usr/share/doc/arangodb/copyright`)
