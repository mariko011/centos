...
- Created: `2017-11-13T15:22:04.581058042Z`
- Virtual Size: ~ 345.65 Mb  
...
- Environment:
  ...
  - `ARANGO_VERSION=3.1.28`
  - `ARANGO_URL=https://download.arangodb.com/arangodb31/Debian_8.0`
  - `ARANGO_PACKAGE=arangodb3-3.1.28-1_amd64.deb`
  - `ARANGO_PACKAGE_URL=https://download.arangodb.com/arangodb31/Debian_8.0/amd64/arangodb3-3.1.28-1_amd64.deb`
  - `ARANGO_SIGNATURE_URL=https://download.arangodb.com/arangodb31/Debian_8.0/amd64/arangodb3-3.1.28-1_amd64.deb.asc`
...
### `dpkg` source package: `arangodb3=3.1.28`
...
- http://snapshot.debian.org/package/snappy/1.1.2-3/
