...
- Created: `2017-06-27T17:29:47.360328048Z`
- Virtual Size: ~ 288.78 Mb  
...
- Environment:
  ...
  - `LANG=en_US.utf8`
  - `PG_MAJOR=10`
  - `PG_VERSION=10~beta1-1.pgdg90+1`
...
'http://deb.debian.org/debian/pool/main/c/cron/cron_3.0pl1-128.dsc' cron_3.0pl1-128.dsc 1911 SHA256:eb54373a81a19a2afa44457ac4a38d0e09436e8f078c68c7c6db2b6e2c6c0edf
...
'http://deb.debian.org/debian/pool/main/c/cron/cron_3.0pl1-128.diff.gz' cron_3.0pl1-128.diff.gz 98918 SHA256:0380e331d1f20187df088dea7b2e1ace5948192a4f729d8c28651ab01796a8a2
```

Likely also available for browsing at:

- https://sources.debian.net/src/cron/3.0pl1-128/
...
### `dpkg` source package: `exim4=4.89-2+deb9u1`

Binary Packages:

- `exim4=4.89-2+deb9u1`
- `exim4-base=4.89-2+deb9u1`
- `exim4-config=4.89-2+deb9u1`
- `exim4-daemon-light=4.89-2+deb9u1`
...
- https://sources.debian.net/src/exim4/4.89-2+deb9u1/
- https://sources.debian.net/src/exim4/4.89-2+deb9u1/debian/copyright (for direct copyright/license information)
...
- https://sources.debian.net/src/gsasl/1.8.0-8/
...
- https://sources.debian.net/src/guile-2.0/2.0.13+1-4/
...
- https://sources.debian.net/src/kyotocabinet/1.2.76-4.2/
...
- https://sources.debian.net/src/libgc/1:7.4.2-8/
...
- https://sources.debian.net/src/libntlm/1.4-8/
...
- https://sources.debian.net/src/logrotate/3.11.0-0.1/
...
### `dpkg` source package: `postgresql-10=10~beta1-1.pgdg90+1`

Binary Packages:

- `libpq5:amd64=10~beta1-1.pgdg90+1`
- `postgresql-10=10~beta1-1.pgdg90+1`
- `postgresql-client-10=10~beta1-1.pgdg90+1`
...
```console
$ apt-get source -qq --print-uris postgresql-10=10~beta1-1.pgdg90+1
'http://apt.postgresql.org/pub/repos/apt/pool/10/p/postgresql-10/postgresql-10_10~beta1-1.pgdg90+1.dsc' postgresql-10_10~beta1-1.pgdg90+1.dsc 2709 SHA256:11ccfc207978364d6bbc9f739e4211803cbe9c9a5088f6baf73ce7e447deff27
'http://apt.postgresql.org/pub/repos/apt/pool/10/p/postgresql-10/postgresql-10_10~beta1.orig.tar.bz2' postgresql-10_10~beta1.orig.tar.bz2 19735273 SHA256:7eee02e6f6646c7d4d6e78893a4ff638cfa5f1025b706712da8c6ef2257b5e29
'http://apt.postgresql.org/pub/repos/apt/pool/10/p/postgresql-10/postgresql-10_10~beta1-1.pgdg90+1.debian.tar.xz' postgresql-10_10~beta1-1.pgdg90+1.debian.tar.xz 16932 SHA256:dac1db737d3fa157b619633ddaf31216616e5054144fad1be2f2faf1f6d647e0
```

### `dpkg` source package: `postgresql-common=182.pgdg90+1`

Binary Packages:

- `postgresql-client-common=182.pgdg90+1`
- `postgresql-common=182.pgdg90+1`
...
```console
$ apt-get source -qq --print-uris postgresql-common=182.pgdg90+1
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-common/postgresql-common_182.pgdg90+1.dsc' postgresql-common_182.pgdg90+1.dsc 1497 SHA256:8b2088ed7fa0b6dcb4b6df8056b434fda9b33d9ba9dab7ec238be3651f6fa53c
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-common/postgresql-common_182.pgdg90+1.tar.xz' postgresql-common_182.pgdg90+1.tar.xz 205248 SHA256:e003f273616355ed0c5f512dce49690d7ec671f4f44ce4616d6a9a5a1466dc65
```
...
- https://sources.debian.net/src/ssl-cert/1.0.39/
...
- https://sources.debian.net/src/sysstat/11.4.3-2/
