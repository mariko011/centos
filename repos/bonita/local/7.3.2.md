...
```console
$ apt-get source -qq --print-uris ca-certificates-java=20130815ubuntu1
...
```console
$ apt-get source -qq --print-uris java-common=0.51
...
```console
$ apt-get source -qq --print-uris nspr=2:4.12-0ubuntu0.14.04.1
...
```console
$ apt-get source -qq --print-uris openjdk-7=7u111-2.6.7-0ubuntu0.14.04.3
...
```console
$ apt-get source -qq --print-uris postgresql-common=154ubuntu1
