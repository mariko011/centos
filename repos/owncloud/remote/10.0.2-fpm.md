...
### `owncloud:10.0.2-fpm` - linux; arm variant v7
...
### `owncloud:10.0.2-fpm` - linux; arm64 variant v8
...
### `owncloud:10.0.2-fpm` - linux; ppc64le
...
### `owncloud:10.0.2-fpm` - linux; s390x
