...
### `owncloud:10.0.2-apache` - linux; arm variant v7
...
### `owncloud:10.0.2-apache` - linux; arm64 variant v8
...
### `owncloud:10.0.2-apache` - linux; 386
...
### `owncloud:10.0.2-apache` - linux; ppc64le
...
### `owncloud:10.0.2-apache` - linux; s390x
