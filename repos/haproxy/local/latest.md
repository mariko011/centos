...
- Created: `2017-11-28T01:36:00.121553913Z`
...
- Environment:
  ...
  - `HAPROXY_MD5=6ccea4619b7183fbcc8c98bae1f9823d`
...
### `dpkg` source package: `lua5.3=5.3.3-1`
...
```console
$ apt-get source -qq --print-uris lua5.3=5.3.3-1
'http://deb.debian.org/debian/pool/main/l/lua5.3/lua5.3_5.3.3-1.dsc' lua5.3_5.3.3-1.dsc 2184 SHA256:5ffa955d5692d0d426c2815f6e0a6e4710a9ba3291ffd47fbcb3f5cc197a32af
...
'http://deb.debian.org/debian/pool/main/l/lua5.3/lua5.3_5.3.3-1.debian.tar.xz' lua5.3_5.3.3-1.debian.tar.xz 7628 SHA256:48fb3dd2916f7ee212b49dcf2eb3da6d60c79204a6e4cf04766a15c0882e0019
```

Other potentially useful URLs:

- https://sources.debian.net/src/lua5.3/5.3.3-1/ (for browsing the source)
- https://sources.debian.net/src/lua5.3/5.3.3-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lua5.3/5.3.3-1/ (for access to the source package after it no longer exists in the archive)
