...
- Created: `2017-11-04T18:37:50.107093285Z`
- Virtual Size: ~ 136.29 Mb  
...
### `dpkg` source package: `lua5.3=5.3.3-1~bpo8+1`

Binary Packages:

- `liblua5.3-0:amd64=5.3.3-1~bpo8+1`
...
```console
$ apt-get source -qq --print-uris lua5.3=5.3.3-1~bpo8+1
'http://deb.debian.org/debian/pool/main/l/lua5.3/lua5.3_5.3.3-1~bpo8+1.dsc' lua5.3_5.3.3-1~bpo8+1.dsc 2121 SHA256:c6e9beaa50ca18410e62193f5d13447723484f4ecf8ac62dbcfe4039d9d7da2e
...
'http://deb.debian.org/debian/pool/main/l/lua5.3/lua5.3_5.3.3-1~bpo8+1.debian.tar.xz' lua5.3_5.3.3-1~bpo8+1.debian.tar.xz 7832 SHA256:86dca659f3cc24f63d3304beaa9993caaa960f3db193aac42fc2ff84efbce412
```

Other potentially useful URLs:

- https://sources.debian.net/src/lua5.3/5.3.3-1~bpo8+1/ (for browsing the source)
- https://sources.debian.net/src/lua5.3/5.3.3-1~bpo8+1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lua5.3/5.3.3-1~bpo8+1/ (for access to the source package after it no longer exists in the archive)
