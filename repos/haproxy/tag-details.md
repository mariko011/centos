...
```console
$ docker pull haproxy@sha256:d43e9f4e45fc034a95d7c6d9580ae52faf0e80477a08aa695add5d37726ae309
```
...
```console
$ docker pull haproxy@sha256:ad8db71ef9b4dd206972883d4a297767a943aeb0d4649c5fabd755c4807d76f4
```
