...
```console
$ docker pull hello-seattle@sha256:1571e1a8fef45dce4b987c4c1a7c9157b848fb59bd1eca8ad88e77733fdeecd0
```
...
### `hello-seattle:latest` - windows version 10.0.14393.1593; amd64
...
```console
$ docker pull hello-seattle@sha256:7cb04685a896376af77b2c3e9b11368188a93a9e1b6b9308a1b65462ce19a187
```
