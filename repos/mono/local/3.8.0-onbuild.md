...
- Created: `2017-01-17T17:24:15.979715902Z`
- Arch: `linux`/`amd64`
- Command: `["/bin/bash"]`
- Environment:
...
### `dpkg` source package: `fsharp=3.1.1.26+dfsg-1~xamarin1`

Binary Packages:

- `fsharp=3.1.1.26+dfsg-1~xamarin1`
- `libfsharp-core4.3-cil=3.1.1.26+dfsg-1~xamarin1`
...
```console
$ apt-get source -qq --print-uris fsharp=3.1.1.26+dfsg-1~xamarin1
'http://download.mono-project.com/repo/debian/pool/main/f/fsharp/fsharp_3.1.1.26+dfsg-1~xamarin1.dsc' fsharp_3.1.1.26+dfsg-1~xamarin1.dsc 1893 SHA256:5af33b653940c4eb83541caa94f8c1f75b174430f92f5be786adf007135e09fa
'http://download.mono-project.com/repo/debian/pool/main/f/fsharp/fsharp_3.1.1.26+dfsg.orig.tar.gz' fsharp_3.1.1.26+dfsg.orig.tar.gz 26742859 SHA256:8b5489fd523e91535d2afc79ee6a1b0822547950eccb57491e42c8ce38b05517
'http://download.mono-project.com/repo/debian/pool/main/f/fsharp/fsharp_3.1.1.26+dfsg-1~xamarin1.debian.tar.gz' fsharp_3.1.1.26+dfsg-1~xamarin1.debian.tar.gz 15533 SHA256:4b9cf403ad9a819e8e42d925dd745efbd6199afc523191cd781bf44548f991b6
```
...
### `dpkg` source package: `libgdiplus=3.8-0xamarin1`
...
```console
$ apt-get source -qq --print-uris libgdiplus=3.8-0xamarin1
'http://download.mono-project.com/repo/debian/pool/main/libg/libgdiplus/libgdiplus_3.8-0xamarin1.dsc' libgdiplus_3.8-0xamarin1.dsc 1978 SHA256:01b1419231c02b99e06da732c6acff86b204e6a23b47dbf487f7b0346b547ae8
'http://download.mono-project.com/repo/debian/pool/main/libg/libgdiplus/libgdiplus_3.8.orig.tar.gz' libgdiplus_3.8.orig.tar.gz 688029 SHA256:6a3cfb4a1b67dd09197c385bacb8654f8d7ff49499f39c57825e1a8f77e69b28
'http://download.mono-project.com/repo/debian/pool/main/libg/libgdiplus/libgdiplus_3.8-0xamarin1.debian.tar.gz' libgdiplus_3.8-0xamarin1.debian.tar.gz 7586 SHA256:064a7eb1972e4312fac870e1e272338ea226624947d7408817f1c51748ca9189
```
...
### `dpkg` source package: `mono=3.8.0-0xamarin3`

Binary Packages:

- `libmono-2.0-dev=3.8.0-0xamarin3`
- `libmono-accessibility2.0-cil=3.8.0-0xamarin3`
- `libmono-accessibility4.0-cil=3.8.0-0xamarin3`
- `libmono-c5-1.1-cil=3.8.0-0xamarin3`
- `libmono-cairo2.0-cil=3.8.0-0xamarin3`
- `libmono-cairo4.0-cil=3.8.0-0xamarin3`
- `libmono-cecil-private-cil=3.8.0-0xamarin3`
- `libmono-cil-dev=3.8.0-0xamarin3`
- `libmono-codecontracts4.0-cil=3.8.0-0xamarin3`
- `libmono-compilerservices-symbolwriter4.0-cil=3.8.0-0xamarin3`
- `libmono-corlib2.0-cil=3.8.0-0xamarin3`
- `libmono-corlib4.0-cil=3.8.0-0xamarin3`
- `libmono-corlib4.5-cil=3.8.0-0xamarin3`
- `libmono-cscompmgd0.0-cil=3.8.0-0xamarin3`
- `libmono-cscompmgd8.0-cil=3.8.0-0xamarin3`
- `libmono-csharp4.0c-cil=3.8.0-0xamarin3`
- `libmono-custommarshalers4.0-cil=3.8.0-0xamarin3`
- `libmono-data-tds2.0-cil=3.8.0-0xamarin3`
- `libmono-data-tds4.0-cil=3.8.0-0xamarin3`
- `libmono-db2-1.0-cil=3.8.0-0xamarin3`
- `libmono-debugger-soft2.0a-cil=3.8.0-0xamarin3`
- `libmono-debugger-soft4.0a-cil=3.8.0-0xamarin3`
- `libmono-entityframework-sqlserver6.0-cil=3.8.0-0xamarin3`
- `libmono-entityframework6.0-cil=3.8.0-0xamarin3`
- `libmono-http4.0-cil=3.8.0-0xamarin3`
- `libmono-i18n-cjk4.0-cil=3.8.0-0xamarin3`
- `libmono-i18n-mideast4.0-cil=3.8.0-0xamarin3`
- `libmono-i18n-other4.0-cil=3.8.0-0xamarin3`
- `libmono-i18n-rare4.0-cil=3.8.0-0xamarin3`
- `libmono-i18n-west2.0-cil=3.8.0-0xamarin3`
- `libmono-i18n-west4.0-cil=3.8.0-0xamarin3`
- `libmono-i18n2.0-cil=3.8.0-0xamarin3`
- `libmono-i18n4.0-all=3.8.0-0xamarin3`
- `libmono-i18n4.0-cil=3.8.0-0xamarin3`
- `libmono-ldap2.0-cil=3.8.0-0xamarin3`
- `libmono-ldap4.0-cil=3.8.0-0xamarin3`
- `libmono-management2.0-cil=3.8.0-0xamarin3`
- `libmono-management4.0-cil=3.8.0-0xamarin3`
- `libmono-messaging-rabbitmq2.0-cil=3.8.0-0xamarin3`
- `libmono-messaging-rabbitmq4.0-cil=3.8.0-0xamarin3`
- `libmono-messaging2.0-cil=3.8.0-0xamarin3`
- `libmono-messaging4.0-cil=3.8.0-0xamarin3`
- `libmono-microsoft-build-engine4.0-cil=3.8.0-0xamarin3`
- `libmono-microsoft-build-framework4.0-cil=3.8.0-0xamarin3`
- `libmono-microsoft-build-tasks-v4.0-4.0-cil=3.8.0-0xamarin3`
- `libmono-microsoft-build-utilities-v4.0-4.0-cil=3.8.0-0xamarin3`
- `libmono-microsoft-build2.0-cil=3.8.0-0xamarin3`
- `libmono-microsoft-build4.0-cil=3.8.0-0xamarin3`
- `libmono-microsoft-csharp4.0-cil=3.8.0-0xamarin3`
- `libmono-microsoft-visualc10.0-cil=3.8.0-0xamarin3`
- `libmono-microsoft-web-infrastructure1.0-cil=3.8.0-0xamarin3`
- `libmono-microsoft8.0-cil=3.8.0-0xamarin3`
- `libmono-npgsql2.0-cil=3.8.0-0xamarin3`
- `libmono-npgsql4.0-cil=3.8.0-0xamarin3`
- `libmono-oracle2.0-cil=3.8.0-0xamarin3`
- `libmono-oracle4.0-cil=3.8.0-0xamarin3`
- `libmono-parallel4.0-cil=3.8.0-0xamarin3`
- `libmono-peapi2.0a-cil=3.8.0-0xamarin3`
- `libmono-peapi4.0a-cil=3.8.0-0xamarin3`
- `libmono-posix2.0-cil=3.8.0-0xamarin3`
- `libmono-posix4.0-cil=3.8.0-0xamarin3`
- `libmono-rabbitmq2.0-cil=3.8.0-0xamarin3`
- `libmono-rabbitmq4.0-cil=3.8.0-0xamarin3`
- `libmono-relaxng2.0-cil=3.8.0-0xamarin3`
- `libmono-relaxng4.0-cil=3.8.0-0xamarin3`
- `libmono-security2.0-cil=3.8.0-0xamarin3`
- `libmono-security4.0-cil=3.8.0-0xamarin3`
- `libmono-sharpzip2.6-cil=3.8.0-0xamarin3`
- `libmono-sharpzip2.84-cil=3.8.0-0xamarin3`
- `libmono-sharpzip4.84-cil=3.8.0-0xamarin3`
- `libmono-simd2.0-cil=3.8.0-0xamarin3`
- `libmono-simd4.0-cil=3.8.0-0xamarin3`
- `libmono-sqlite2.0-cil=3.8.0-0xamarin3`
- `libmono-sqlite4.0-cil=3.8.0-0xamarin3`
- `libmono-system-componentmodel-composition4.0-cil=3.8.0-0xamarin3`
- `libmono-system-componentmodel-dataannotations4.0-cil=3.8.0-0xamarin3`
- `libmono-system-configuration-install4.0-cil=3.8.0-0xamarin3`
- `libmono-system-configuration4.0-cil=3.8.0-0xamarin3`
- `libmono-system-core4.0-cil=3.8.0-0xamarin3`
- `libmono-system-data-datasetextensions4.0-cil=3.8.0-0xamarin3`
- `libmono-system-data-linq2.0-cil=3.8.0-0xamarin3`
- `libmono-system-data-linq4.0-cil=3.8.0-0xamarin3`
- `libmono-system-data-services-client4.0-cil=3.8.0-0xamarin3`
- `libmono-system-data-services2.0-cil=3.8.0-0xamarin3`
- `libmono-system-data-services4.0-cil=3.8.0-0xamarin3`
- `libmono-system-data2.0-cil=3.8.0-0xamarin3`
- `libmono-system-data4.0-cil=3.8.0-0xamarin3`
- `libmono-system-design4.0-cil=3.8.0-0xamarin3`
- `libmono-system-drawing-design4.0-cil=3.8.0-0xamarin3`
- `libmono-system-drawing4.0-cil=3.8.0-0xamarin3`
- `libmono-system-dynamic4.0-cil=3.8.0-0xamarin3`
- `libmono-system-enterpriseservices4.0-cil=3.8.0-0xamarin3`
- `libmono-system-identitymodel-selectors4.0-cil=3.8.0-0xamarin3`
- `libmono-system-identitymodel4.0-cil=3.8.0-0xamarin3`
- `libmono-system-io-compression-filesystem4.0-cil=3.8.0-0xamarin3`
- `libmono-system-io-compression4.0-cil=3.8.0-0xamarin3`
- `libmono-system-json-microsoft4.0-cil=3.8.0-0xamarin3`
- `libmono-system-json2.0-cil=3.8.0-0xamarin3`
- `libmono-system-json4.0-cil=3.8.0-0xamarin3`
- `libmono-system-ldap-protocols4.0-cil=3.8.0-0xamarin3`
- `libmono-system-ldap2.0-cil=3.8.0-0xamarin3`
- `libmono-system-ldap4.0-cil=3.8.0-0xamarin3`
- `libmono-system-management4.0-cil=3.8.0-0xamarin3`
- `libmono-system-messaging2.0-cil=3.8.0-0xamarin3`
- `libmono-system-messaging4.0-cil=3.8.0-0xamarin3`
- `libmono-system-net-http-formatting4.0-cil=3.8.0-0xamarin3`
- `libmono-system-net-http-webrequest4.0-cil=3.8.0-0xamarin3`
- `libmono-system-net-http4.0-cil=3.8.0-0xamarin3`
- `libmono-system-net2.0-cil=3.8.0-0xamarin3`
- `libmono-system-net4.0-cil=3.8.0-0xamarin3`
- `libmono-system-numerics4.0-cil=3.8.0-0xamarin3`
- `libmono-system-reactive-core2.2-cil=3.8.0-0xamarin3`
- `libmono-system-reactive-debugger2.2-cil=3.8.0-0xamarin3`
- `libmono-system-reactive-experimental2.2-cil=3.8.0-0xamarin3`
- `libmono-system-reactive-interfaces2.2-cil=3.8.0-0xamarin3`
- `libmono-system-reactive-linq2.2-cil=3.8.0-0xamarin3`
- `libmono-system-reactive-observable-aliases0.0-cil=3.8.0-0xamarin3`
- `libmono-system-reactive-platformservices2.2-cil=3.8.0-0xamarin3`
- `libmono-system-reactive-providers2.2-cil=3.8.0-0xamarin3`
- `libmono-system-reactive-runtime-remoting2.2-cil=3.8.0-0xamarin3`
- `libmono-system-reactive-windows-forms2.2-cil=3.8.0-0xamarin3`
- `libmono-system-reactive-windows-threading2.2-cil=3.8.0-0xamarin3`
- `libmono-system-runtime-caching4.0-cil=3.8.0-0xamarin3`
- `libmono-system-runtime-durableinstancing4.0-cil=3.8.0-0xamarin3`
- `libmono-system-runtime-serialization-formatters-soap4.0-cil=3.8.0-0xamarin3`
- `libmono-system-runtime-serialization4.0-cil=3.8.0-0xamarin3`
- `libmono-system-runtime2.0-cil=3.8.0-0xamarin3`
- `libmono-system-runtime4.0-cil=3.8.0-0xamarin3`
- `libmono-system-security4.0-cil=3.8.0-0xamarin3`
- `libmono-system-servicemodel-activation4.0-cil=3.8.0-0xamarin3`
- `libmono-system-servicemodel-discovery4.0-cil=3.8.0-0xamarin3`
- `libmono-system-servicemodel-routing4.0-cil=3.8.0-0xamarin3`
- `libmono-system-servicemodel-web4.0-cil=3.8.0-0xamarin3`
- `libmono-system-servicemodel4.0a-cil=3.8.0-0xamarin3`
- `libmono-system-serviceprocess4.0-cil=3.8.0-0xamarin3`
- `libmono-system-threading-tasks-dataflow4.0-cil=3.8.0-0xamarin3`
- `libmono-system-transactions4.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-abstractions4.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-applicationservices4.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-dynamicdata4.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-extensions-design4.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-extensions4.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-http-selfhost4.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-http-webhost4.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-http4.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-mvc1.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-mvc2.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-mvc3.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-razor2.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-routing4.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-services4.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-webpages-deployment2.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-webpages-razor2.0-cil=3.8.0-0xamarin3`
- `libmono-system-web-webpages2.0-cil=3.8.0-0xamarin3`
- `libmono-system-web2.0-cil=3.8.0-0xamarin3`
- `libmono-system-web4.0-cil=3.8.0-0xamarin3`
- `libmono-system-windows-forms-datavisualization4.0a-cil=3.8.0-0xamarin3`
- `libmono-system-windows-forms4.0-cil=3.8.0-0xamarin3`
- `libmono-system-windows4.0-cil=3.8.0-0xamarin3`
- `libmono-system-xaml4.0-cil=3.8.0-0xamarin3`
- `libmono-system-xml-linq4.0-cil=3.8.0-0xamarin3`
- `libmono-system-xml-serialization4.0-cil=3.8.0-0xamarin3`
- `libmono-system-xml4.0-cil=3.8.0-0xamarin3`
- `libmono-system2.0-cil=3.8.0-0xamarin3`
- `libmono-system4.0-cil=3.8.0-0xamarin3`
- `libmono-tasklets2.0-cil=3.8.0-0xamarin3`
- `libmono-tasklets4.0-cil=3.8.0-0xamarin3`
- `libmono-wcf3.0a-cil=3.8.0-0xamarin3`
- `libmono-webbrowser2.0-cil=3.8.0-0xamarin3`
- `libmono-webbrowser4.0-cil=3.8.0-0xamarin3`
- `libmono-webmatrix-data4.0-cil=3.8.0-0xamarin3`
- `libmono-windowsbase3.0-cil=3.8.0-0xamarin3`
- `libmono-windowsbase4.0-cil=3.8.0-0xamarin3`
- `libmono-winforms2.0-cil=3.8.0-0xamarin3`
- `libmono-xbuild-tasks2.0-cil=3.8.0-0xamarin3`
- `libmono-xbuild-tasks4.0-cil=3.8.0-0xamarin3`
- `libmono2.0-cil=3.8.0-0xamarin3`
- `libmonoboehm-2.0-1=3.8.0-0xamarin3`
- `libmonoboehm-2.0-dev=3.8.0-0xamarin3`
- `mono-4.0-gac=3.8.0-0xamarin3`
- `mono-csharp-shell=3.8.0-0xamarin3`
- `mono-devel=3.8.0-0xamarin3`
- `mono-gac=3.8.0-0xamarin3`
- `mono-mcs=3.8.0-0xamarin3`
- `mono-runtime=3.8.0-0xamarin3`
- `mono-runtime-common=3.8.0-0xamarin3`
- `mono-runtime-sgen=3.8.0-0xamarin3`
- `mono-xbuild=3.8.0-0xamarin3`
...
```console
$ apt-get source -qq --print-uris mono=3.8.0-0xamarin3
'http://download.mono-project.com/repo/debian/pool/main/m/mono/mono_3.8.0-0xamarin3.dsc' mono_3.8.0-0xamarin3.dsc 21916 SHA256:ee016f3e7ac5b36da9359b8415b28e5b035fc222a72419a29f49d51ca8038717
'http://download.mono-project.com/repo/debian/pool/main/m/mono/mono_3.8.0.orig.tar.bz2' mono_3.8.0.orig.tar.bz2 73495543 SHA256:71b80d555f334a05a8db386e1c41e1a2f61a845c57726205f846e563a5ee2a4b
'http://download.mono-project.com/repo/debian/pool/main/m/mono/mono_3.8.0-0xamarin3.debian.tar.xz' mono_3.8.0-0xamarin3.debian.tar.xz 140516 SHA256:40f2c87a9858bf154e7c0dab01738670c0f29486d419da4a9b5eb2b7f7e957d9
```
...
### `dpkg` source package: `nuget=2.8.1+md54+dhx1-3~xamarin1`

Binary Packages:

- `libnuget-core-cil=2.8.1+md54+dhx1-3~xamarin1`
- `nuget=2.8.1+md54+dhx1-3~xamarin1`
...
```console
$ apt-get source -qq --print-uris nuget=2.8.1+md54+dhx1-3~xamarin1
'http://download.mono-project.com/repo/debian/pool/main/n/nuget/nuget_2.8.1+md54+dhx1-3~xamarin1.dsc' nuget_2.8.1+md54+dhx1-3~xamarin1.dsc 1806 SHA256:f34e671afe9e7b032bfd7cccf3c3555b1da6148b5971732f2d721e4b8fd01cb5
'http://download.mono-project.com/repo/debian/pool/main/n/nuget/nuget_2.8.1+md54+dhx1.orig.tar.gz' nuget_2.8.1+md54+dhx1.orig.tar.gz 3912790 SHA256:5da099886af9273ed67f8b57a7c53e788827c6430cc6ee8723c59182521fb989
'http://download.mono-project.com/repo/debian/pool/main/n/nuget/nuget_2.8.1+md54+dhx1-3~xamarin1.debian.tar.gz' nuget_2.8.1+md54+dhx1-3~xamarin1.debian.tar.gz 2724 SHA256:ef6aeb03998ad4ecb7af3b2fd3f2329dd2ced65029399f086b3d3716be8adc37
```

### `dpkg` source package: `nunit=2.6.3+dfsg-1~xamarin1`

Binary Packages:

- `libnunit-cil-dev=2.6.3+dfsg-1~xamarin1`
- `libnunit-console-runner2.6.3-cil=2.6.3+dfsg-1~xamarin1`
- `libnunit-core-interfaces2.6.3-cil=2.6.3+dfsg-1~xamarin1`
- `libnunit-core2.6.3-cil=2.6.3+dfsg-1~xamarin1`
- `libnunit-framework2.6.3-cil=2.6.3+dfsg-1~xamarin1`
- `libnunit-mocks2.6.3-cil=2.6.3+dfsg-1~xamarin1`
- `libnunit-util2.6.3-cil=2.6.3+dfsg-1~xamarin1`
...
```console
$ apt-get source -qq --print-uris nunit=2.6.3+dfsg-1~xamarin1
'http://download.mono-project.com/repo/debian/pool/main/n/nunit/nunit_2.6.3+dfsg-1~xamarin1.dsc' nunit_2.6.3+dfsg-1~xamarin1.dsc 2463 SHA256:977df9c23d8419da7562251bec4800296e4ab61a457a6d984db88f22764ce202
...
'http://download.mono-project.com/repo/debian/pool/main/n/nunit/nunit_2.6.3+dfsg-1~xamarin1.debian.tar.gz' nunit_2.6.3+dfsg-1~xamarin1.debian.tar.gz 11175 SHA256:1b4d3314625e0ee3b7dbad409d9470f37bf2a9a2bf029606e6bdb45144b39d27
```
