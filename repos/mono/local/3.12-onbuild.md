...
- Created: `2016-09-19T20:14:58.797715851Z`
- Arch: `linux`/`amd64`
- Command: `["/bin/bash"]`
- Environment:
...
### `dpkg` source package: `fsharp=3.1.1.26+dfsg2-3~xamarin1`

Binary Packages:

- `fsharp=3.1.1.26+dfsg2-3~xamarin1`
...
```console
$ apt-get source -qq --print-uris fsharp=3.1.1.26+dfsg2-3~xamarin1
'http://download.mono-project.com/repo/debian/pool/main/f/fsharp/fsharp_3.1.1.26+dfsg2-3~xamarin1.dsc' fsharp_3.1.1.26+dfsg2-3~xamarin1.dsc 1903 SHA256:e51f7b8aaedcf84b40871534c899f881b40f90e0b0bf0c340f07cd7ceec4ab61
'http://download.mono-project.com/repo/debian/pool/main/f/fsharp/fsharp_3.1.1.26+dfsg2.orig.tar.gz' fsharp_3.1.1.26+dfsg2.orig.tar.gz 11416736 SHA256:c768dc7f13e0bcd9a9293ba02ced217404961a5931f824d5471d3e4b484ff7b0
'http://download.mono-project.com/repo/debian/pool/main/f/fsharp/fsharp_3.1.1.26+dfsg2-3~xamarin1.debian.tar.gz' fsharp_3.1.1.26+dfsg2-3~xamarin1.debian.tar.gz 248149 SHA256:50b294f3b08760a94a4d6434d30856b1e5aea3af99888d4249a6fe34246856c9
```
...
### `dpkg` source package: `mono-basic=3.8-0xamarin1`

Binary Packages:

- `libmono-cecil-vb0.9-cil=3.8-0xamarin1`
- `libmono-microsoft-visualbasic10.0-cil=3.8-0xamarin1`
- `libmono-microsoft-visualbasic11.0-cil=3.8-0xamarin1`
- `libmono-microsoft-visualbasic8.0-cil=3.8-0xamarin1`
- `mono-vbnc=3.8-0xamarin1`

Licenses: (parsed from: `/usr/share/doc/libmono-cecil-vb0.9-cil/copyright`, `/usr/share/doc/libmono-microsoft-visualbasic10.0-cil/copyright`, `/usr/share/doc/libmono-microsoft-visualbasic11.0-cil/copyright`, `/usr/share/doc/libmono-microsoft-visualbasic8.0-cil/copyright`, `/usr/share/doc/mono-vbnc/copyright`)
...
```console
$ apt-get source -qq --print-uris mono-basic=3.8-0xamarin1
'http://download.mono-project.com/repo/debian/pool/main/m/mono-basic/mono-basic_3.8-0xamarin1.dsc' mono-basic_3.8-0xamarin1.dsc 2083 SHA256:96c2a8fa59e4be88d063b399a929cded4632a9b2c3548b9bcb2b83b7c2806e1f
'http://download.mono-project.com/repo/debian/pool/main/m/mono-basic/mono-basic_3.8.orig.tar.bz2' mono-basic_3.8.orig.tar.bz2 2028586 SHA256:b971176cd35c07d809040975085412ea7cb7db721617fadfeee0f668d1853715
'http://download.mono-project.com/repo/debian/pool/main/m/mono-basic/mono-basic_3.8-0xamarin1.debian.tar.gz' mono-basic_3.8-0xamarin1.debian.tar.gz 7066 SHA256:f5f304672acb3d63425b348ec4e7333296be6988735d0d30de64aae45d2a0d0d
```

### `dpkg` source package: `mono=3.12.1-0xamarin2`

Binary Packages:

- `ca-certificates-mono=3.12.1-0xamarin2`
- `libmono-2.0-dev=3.12.1-0xamarin2`
- `libmono-accessibility2.0-cil=3.12.1-0xamarin2`
- `libmono-accessibility4.0-cil=3.12.1-0xamarin2`
- `libmono-c5-1.1-cil=3.12.1-0xamarin2`
- `libmono-cairo2.0-cil=3.12.1-0xamarin2`
- `libmono-cairo4.0-cil=3.12.1-0xamarin2`
- `libmono-cecil-private-cil=3.12.1-0xamarin2`
- `libmono-cil-dev=3.12.1-0xamarin2`
- `libmono-codecontracts4.0-cil=3.12.1-0xamarin2`
- `libmono-compilerservices-symbolwriter4.0-cil=3.12.1-0xamarin2`
- `libmono-corlib2.0-cil=3.12.1-0xamarin2`
- `libmono-corlib4.0-cil=3.12.1-0xamarin2`
- `libmono-corlib4.5-cil=3.12.1-0xamarin2`
- `libmono-cscompmgd0.0-cil=3.12.1-0xamarin2`
- `libmono-cscompmgd8.0-cil=3.12.1-0xamarin2`
- `libmono-csharp4.0c-cil=3.12.1-0xamarin2`
- `libmono-custommarshalers4.0-cil=3.12.1-0xamarin2`
- `libmono-data-tds2.0-cil=3.12.1-0xamarin2`
- `libmono-data-tds4.0-cil=3.12.1-0xamarin2`
- `libmono-db2-1.0-cil=3.12.1-0xamarin2`
- `libmono-debugger-soft2.0a-cil=3.12.1-0xamarin2`
- `libmono-debugger-soft4.0a-cil=3.12.1-0xamarin2`
- `libmono-entityframework-sqlserver6.0-cil=3.12.1-0xamarin2`
- `libmono-entityframework6.0-cil=3.12.1-0xamarin2`
- `libmono-http4.0-cil=3.12.1-0xamarin2`
- `libmono-i18n-cjk4.0-cil=3.12.1-0xamarin2`
- `libmono-i18n-mideast4.0-cil=3.12.1-0xamarin2`
- `libmono-i18n-other4.0-cil=3.12.1-0xamarin2`
- `libmono-i18n-rare4.0-cil=3.12.1-0xamarin2`
- `libmono-i18n-west2.0-cil=3.12.1-0xamarin2`
- `libmono-i18n-west4.0-cil=3.12.1-0xamarin2`
- `libmono-i18n2.0-cil=3.12.1-0xamarin2`
- `libmono-i18n4.0-all=3.12.1-0xamarin2`
- `libmono-i18n4.0-cil=3.12.1-0xamarin2`
- `libmono-ldap2.0-cil=3.12.1-0xamarin2`
- `libmono-ldap4.0-cil=3.12.1-0xamarin2`
- `libmono-management2.0-cil=3.12.1-0xamarin2`
- `libmono-management4.0-cil=3.12.1-0xamarin2`
- `libmono-messaging-rabbitmq2.0-cil=3.12.1-0xamarin2`
- `libmono-messaging-rabbitmq4.0-cil=3.12.1-0xamarin2`
- `libmono-messaging2.0-cil=3.12.1-0xamarin2`
- `libmono-messaging4.0-cil=3.12.1-0xamarin2`
- `libmono-microsoft-build-engine4.0-cil=3.12.1-0xamarin2`
- `libmono-microsoft-build-framework4.0-cil=3.12.1-0xamarin2`
- `libmono-microsoft-build-tasks-v4.0-4.0-cil=3.12.1-0xamarin2`
- `libmono-microsoft-build-utilities-v4.0-4.0-cil=3.12.1-0xamarin2`
- `libmono-microsoft-build2.0-cil=3.12.1-0xamarin2`
- `libmono-microsoft-build4.0-cil=3.12.1-0xamarin2`
- `libmono-microsoft-csharp4.0-cil=3.12.1-0xamarin2`
- `libmono-microsoft-visualc10.0-cil=3.12.1-0xamarin2`
- `libmono-microsoft-web-infrastructure1.0-cil=3.12.1-0xamarin2`
- `libmono-microsoft8.0-cil=3.12.1-0xamarin2`
- `libmono-npgsql2.0-cil=3.12.1-0xamarin2`
- `libmono-npgsql4.0-cil=3.12.1-0xamarin2`
- `libmono-oracle2.0-cil=3.12.1-0xamarin2`
- `libmono-oracle4.0-cil=3.12.1-0xamarin2`
- `libmono-parallel4.0-cil=3.12.1-0xamarin2`
- `libmono-peapi2.0a-cil=3.12.1-0xamarin2`
- `libmono-peapi4.0a-cil=3.12.1-0xamarin2`
- `libmono-posix2.0-cil=3.12.1-0xamarin2`
- `libmono-posix4.0-cil=3.12.1-0xamarin2`
- `libmono-rabbitmq2.0-cil=3.12.1-0xamarin2`
- `libmono-rabbitmq4.0-cil=3.12.1-0xamarin2`
- `libmono-relaxng2.0-cil=3.12.1-0xamarin2`
- `libmono-relaxng4.0-cil=3.12.1-0xamarin2`
- `libmono-security2.0-cil=3.12.1-0xamarin2`
- `libmono-security4.0-cil=3.12.1-0xamarin2`
- `libmono-sharpzip2.6-cil=3.12.1-0xamarin2`
- `libmono-sharpzip2.84-cil=3.12.1-0xamarin2`
- `libmono-sharpzip4.84-cil=3.12.1-0xamarin2`
- `libmono-simd2.0-cil=3.12.1-0xamarin2`
- `libmono-simd4.0-cil=3.12.1-0xamarin2`
- `libmono-sqlite2.0-cil=3.12.1-0xamarin2`
- `libmono-sqlite4.0-cil=3.12.1-0xamarin2`
- `libmono-system-componentmodel-composition4.0-cil=3.12.1-0xamarin2`
- `libmono-system-componentmodel-dataannotations4.0-cil=3.12.1-0xamarin2`
- `libmono-system-configuration-install4.0-cil=3.12.1-0xamarin2`
- `libmono-system-configuration4.0-cil=3.12.1-0xamarin2`
- `libmono-system-core4.0-cil=3.12.1-0xamarin2`
- `libmono-system-data-datasetextensions4.0-cil=3.12.1-0xamarin2`
- `libmono-system-data-linq2.0-cil=3.12.1-0xamarin2`
- `libmono-system-data-linq4.0-cil=3.12.1-0xamarin2`
- `libmono-system-data-services-client4.0-cil=3.12.1-0xamarin2`
- `libmono-system-data-services2.0-cil=3.12.1-0xamarin2`
- `libmono-system-data-services4.0-cil=3.12.1-0xamarin2`
- `libmono-system-data2.0-cil=3.12.1-0xamarin2`
- `libmono-system-data4.0-cil=3.12.1-0xamarin2`
- `libmono-system-design4.0-cil=3.12.1-0xamarin2`
- `libmono-system-drawing-design4.0-cil=3.12.1-0xamarin2`
- `libmono-system-drawing4.0-cil=3.12.1-0xamarin2`
- `libmono-system-dynamic4.0-cil=3.12.1-0xamarin2`
- `libmono-system-enterpriseservices4.0-cil=3.12.1-0xamarin2`
- `libmono-system-identitymodel-selectors4.0-cil=3.12.1-0xamarin2`
- `libmono-system-identitymodel4.0-cil=3.12.1-0xamarin2`
- `libmono-system-io-compression-filesystem4.0-cil=3.12.1-0xamarin2`
- `libmono-system-io-compression4.0-cil=3.12.1-0xamarin2`
- `libmono-system-json-microsoft4.0-cil=3.12.1-0xamarin2`
- `libmono-system-json2.0-cil=3.12.1-0xamarin2`
- `libmono-system-json4.0-cil=3.12.1-0xamarin2`
- `libmono-system-ldap-protocols4.0-cil=3.12.1-0xamarin2`
- `libmono-system-ldap2.0-cil=3.12.1-0xamarin2`
- `libmono-system-ldap4.0-cil=3.12.1-0xamarin2`
- `libmono-system-management4.0-cil=3.12.1-0xamarin2`
- `libmono-system-messaging2.0-cil=3.12.1-0xamarin2`
- `libmono-system-messaging4.0-cil=3.12.1-0xamarin2`
- `libmono-system-net-http-formatting4.0-cil=3.12.1-0xamarin2`
- `libmono-system-net-http-webrequest4.0-cil=3.12.1-0xamarin2`
- `libmono-system-net-http4.0-cil=3.12.1-0xamarin2`
- `libmono-system-net2.0-cil=3.12.1-0xamarin2`
- `libmono-system-net4.0-cil=3.12.1-0xamarin2`
- `libmono-system-numerics4.0-cil=3.12.1-0xamarin2`
- `libmono-system-reactive-core2.2-cil=3.12.1-0xamarin2`
- `libmono-system-reactive-debugger2.2-cil=3.12.1-0xamarin2`
- `libmono-system-reactive-experimental2.2-cil=3.12.1-0xamarin2`
- `libmono-system-reactive-interfaces2.2-cil=3.12.1-0xamarin2`
- `libmono-system-reactive-linq2.2-cil=3.12.1-0xamarin2`
- `libmono-system-reactive-observable-aliases0.0-cil=3.12.1-0xamarin2`
- `libmono-system-reactive-platformservices2.2-cil=3.12.1-0xamarin2`
- `libmono-system-reactive-providers2.2-cil=3.12.1-0xamarin2`
- `libmono-system-reactive-runtime-remoting2.2-cil=3.12.1-0xamarin2`
- `libmono-system-reactive-windows-forms2.2-cil=3.12.1-0xamarin2`
- `libmono-system-reactive-windows-threading2.2-cil=3.12.1-0xamarin2`
- `libmono-system-runtime-caching4.0-cil=3.12.1-0xamarin2`
- `libmono-system-runtime-durableinstancing4.0-cil=3.12.1-0xamarin2`
- `libmono-system-runtime-serialization-formatters-soap4.0-cil=3.12.1-0xamarin2`
- `libmono-system-runtime-serialization4.0-cil=3.12.1-0xamarin2`
- `libmono-system-runtime2.0-cil=3.12.1-0xamarin2`
- `libmono-system-runtime4.0-cil=3.12.1-0xamarin2`
- `libmono-system-security4.0-cil=3.12.1-0xamarin2`
- `libmono-system-servicemodel-activation4.0-cil=3.12.1-0xamarin2`
- `libmono-system-servicemodel-discovery4.0-cil=3.12.1-0xamarin2`
- `libmono-system-servicemodel-routing4.0-cil=3.12.1-0xamarin2`
- `libmono-system-servicemodel-web4.0-cil=3.12.1-0xamarin2`
- `libmono-system-servicemodel4.0a-cil=3.12.1-0xamarin2`
- `libmono-system-serviceprocess4.0-cil=3.12.1-0xamarin2`
- `libmono-system-threading-tasks-dataflow4.0-cil=3.12.1-0xamarin2`
- `libmono-system-transactions4.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-abstractions4.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-applicationservices4.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-dynamicdata4.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-extensions-design4.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-extensions4.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-http-selfhost4.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-http-webhost4.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-http4.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-mvc1.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-mvc2.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-mvc3.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-razor2.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-routing4.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-services4.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-webpages-deployment2.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-webpages-razor2.0-cil=3.12.1-0xamarin2`
- `libmono-system-web-webpages2.0-cil=3.12.1-0xamarin2`
- `libmono-system-web2.0-cil=3.12.1-0xamarin2`
- `libmono-system-web4.0-cil=3.12.1-0xamarin2`
- `libmono-system-windows-forms-datavisualization4.0a-cil=3.12.1-0xamarin2`
- `libmono-system-windows-forms4.0-cil=3.12.1-0xamarin2`
- `libmono-system-windows4.0-cil=3.12.1-0xamarin2`
- `libmono-system-xaml4.0-cil=3.12.1-0xamarin2`
- `libmono-system-xml-linq4.0-cil=3.12.1-0xamarin2`
- `libmono-system-xml-serialization4.0-cil=3.12.1-0xamarin2`
- `libmono-system-xml4.0-cil=3.12.1-0xamarin2`
- `libmono-system2.0-cil=3.12.1-0xamarin2`
- `libmono-system4.0-cil=3.12.1-0xamarin2`
- `libmono-tasklets2.0-cil=3.12.1-0xamarin2`
- `libmono-tasklets4.0-cil=3.12.1-0xamarin2`
- `libmono-wcf3.0a-cil=3.12.1-0xamarin2`
- `libmono-webbrowser2.0-cil=3.12.1-0xamarin2`
- `libmono-webbrowser4.0-cil=3.12.1-0xamarin2`
- `libmono-webmatrix-data4.0-cil=3.12.1-0xamarin2`
- `libmono-windowsbase3.0-cil=3.12.1-0xamarin2`
- `libmono-windowsbase4.0-cil=3.12.1-0xamarin2`
- `libmono-winforms2.0-cil=3.12.1-0xamarin2`
- `libmono-xbuild-tasks2.0-cil=3.12.1-0xamarin2`
- `libmono-xbuild-tasks4.0-cil=3.12.1-0xamarin2`
- `libmono2.0-cil=3.12.1-0xamarin2`
- `libmonoboehm-2.0-1=3.12.1-0xamarin2`
- `libmonoboehm-2.0-dev=3.12.1-0xamarin2`
- `mono-4.0-gac=3.12.1-0xamarin2`
- `mono-csharp-shell=3.12.1-0xamarin2`
- `mono-devel=3.12.1-0xamarin2`
- `mono-gac=3.12.1-0xamarin2`
- `mono-mcs=3.12.1-0xamarin2`
- `mono-runtime=3.12.1-0xamarin2`
- `mono-runtime-common=3.12.1-0xamarin2`
- `mono-runtime-sgen=3.12.1-0xamarin2`
- `mono-xbuild=3.12.1-0xamarin2`

Licenses: (parsed from: `/usr/share/doc/ca-certificates-mono/copyright`, `/usr/share/doc/libmono-2.0-dev/copyright`, `/usr/share/doc/libmono-accessibility2.0-cil/copyright`, `/usr/share/doc/libmono-accessibility4.0-cil/copyright`, `/usr/share/doc/libmono-c5-1.1-cil/copyright`, `/usr/share/doc/libmono-cairo2.0-cil/copyright`, `/usr/share/doc/libmono-cairo4.0-cil/copyright`, `/usr/share/doc/libmono-cecil-private-cil/copyright`, `/usr/share/doc/libmono-cil-dev/copyright`, `/usr/share/doc/libmono-codecontracts4.0-cil/copyright`, `/usr/share/doc/libmono-compilerservices-symbolwriter4.0-cil/copyright`, `/usr/share/doc/libmono-corlib2.0-cil/copyright`, `/usr/share/doc/libmono-corlib4.0-cil/copyright`, `/usr/share/doc/libmono-corlib4.5-cil/copyright`, `/usr/share/doc/libmono-cscompmgd0.0-cil/copyright`, `/usr/share/doc/libmono-cscompmgd8.0-cil/copyright`, `/usr/share/doc/libmono-csharp4.0c-cil/copyright`, `/usr/share/doc/libmono-custommarshalers4.0-cil/copyright`, `/usr/share/doc/libmono-data-tds2.0-cil/copyright`, `/usr/share/doc/libmono-data-tds4.0-cil/copyright`, `/usr/share/doc/libmono-db2-1.0-cil/copyright`, `/usr/share/doc/libmono-debugger-soft2.0a-cil/copyright`, `/usr/share/doc/libmono-debugger-soft4.0a-cil/copyright`, `/usr/share/doc/libmono-entityframework-sqlserver6.0-cil/copyright`, `/usr/share/doc/libmono-entityframework6.0-cil/copyright`, `/usr/share/doc/libmono-http4.0-cil/copyright`, `/usr/share/doc/libmono-i18n-cjk4.0-cil/copyright`, `/usr/share/doc/libmono-i18n-mideast4.0-cil/copyright`, `/usr/share/doc/libmono-i18n-other4.0-cil/copyright`, `/usr/share/doc/libmono-i18n-rare4.0-cil/copyright`, `/usr/share/doc/libmono-i18n-west2.0-cil/copyright`, `/usr/share/doc/libmono-i18n-west4.0-cil/copyright`, `/usr/share/doc/libmono-i18n2.0-cil/copyright`, `/usr/share/doc/libmono-i18n4.0-all/copyright`, `/usr/share/doc/libmono-i18n4.0-cil/copyright`, `/usr/share/doc/libmono-ldap2.0-cil/copyright`, `/usr/share/doc/libmono-ldap4.0-cil/copyright`, `/usr/share/doc/libmono-management2.0-cil/copyright`, `/usr/share/doc/libmono-management4.0-cil/copyright`, `/usr/share/doc/libmono-messaging-rabbitmq2.0-cil/copyright`, `/usr/share/doc/libmono-messaging-rabbitmq4.0-cil/copyright`, `/usr/share/doc/libmono-messaging2.0-cil/copyright`, `/usr/share/doc/libmono-messaging4.0-cil/copyright`, `/usr/share/doc/libmono-microsoft-build-engine4.0-cil/copyright`, `/usr/share/doc/libmono-microsoft-build-framework4.0-cil/copyright`, `/usr/share/doc/libmono-microsoft-build-tasks-v4.0-4.0-cil/copyright`, `/usr/share/doc/libmono-microsoft-build-utilities-v4.0-4.0-cil/copyright`, `/usr/share/doc/libmono-microsoft-build2.0-cil/copyright`, `/usr/share/doc/libmono-microsoft-build4.0-cil/copyright`, `/usr/share/doc/libmono-microsoft-csharp4.0-cil/copyright`, `/usr/share/doc/libmono-microsoft-visualc10.0-cil/copyright`, `/usr/share/doc/libmono-microsoft-web-infrastructure1.0-cil/copyright`, `/usr/share/doc/libmono-microsoft8.0-cil/copyright`, `/usr/share/doc/libmono-npgsql2.0-cil/copyright`, `/usr/share/doc/libmono-npgsql4.0-cil/copyright`, `/usr/share/doc/libmono-oracle2.0-cil/copyright`, `/usr/share/doc/libmono-oracle4.0-cil/copyright`, `/usr/share/doc/libmono-parallel4.0-cil/copyright`, `/usr/share/doc/libmono-peapi2.0a-cil/copyright`, `/usr/share/doc/libmono-peapi4.0a-cil/copyright`, `/usr/share/doc/libmono-posix2.0-cil/copyright`, `/usr/share/doc/libmono-posix4.0-cil/copyright`, `/usr/share/doc/libmono-rabbitmq2.0-cil/copyright`, `/usr/share/doc/libmono-rabbitmq4.0-cil/copyright`, `/usr/share/doc/libmono-relaxng2.0-cil/copyright`, `/usr/share/doc/libmono-relaxng4.0-cil/copyright`, `/usr/share/doc/libmono-security2.0-cil/copyright`, `/usr/share/doc/libmono-security4.0-cil/copyright`, `/usr/share/doc/libmono-sharpzip2.6-cil/copyright`, `/usr/share/doc/libmono-sharpzip2.84-cil/copyright`, `/usr/share/doc/libmono-sharpzip4.84-cil/copyright`, `/usr/share/doc/libmono-simd2.0-cil/copyright`, `/usr/share/doc/libmono-simd4.0-cil/copyright`, `/usr/share/doc/libmono-sqlite2.0-cil/copyright`, `/usr/share/doc/libmono-sqlite4.0-cil/copyright`, `/usr/share/doc/libmono-system-componentmodel-composition4.0-cil/copyright`, `/usr/share/doc/libmono-system-componentmodel-dataannotations4.0-cil/copyright`, `/usr/share/doc/libmono-system-configuration-install4.0-cil/copyright`, `/usr/share/doc/libmono-system-configuration4.0-cil/copyright`, `/usr/share/doc/libmono-system-core4.0-cil/copyright`, `/usr/share/doc/libmono-system-data-datasetextensions4.0-cil/copyright`, `/usr/share/doc/libmono-system-data-linq2.0-cil/copyright`, `/usr/share/doc/libmono-system-data-linq4.0-cil/copyright`, `/usr/share/doc/libmono-system-data-services-client4.0-cil/copyright`, `/usr/share/doc/libmono-system-data-services2.0-cil/copyright`, `/usr/share/doc/libmono-system-data-services4.0-cil/copyright`, `/usr/share/doc/libmono-system-data2.0-cil/copyright`, `/usr/share/doc/libmono-system-data4.0-cil/copyright`, `/usr/share/doc/libmono-system-design4.0-cil/copyright`, `/usr/share/doc/libmono-system-drawing-design4.0-cil/copyright`, `/usr/share/doc/libmono-system-drawing4.0-cil/copyright`, `/usr/share/doc/libmono-system-dynamic4.0-cil/copyright`, `/usr/share/doc/libmono-system-enterpriseservices4.0-cil/copyright`, `/usr/share/doc/libmono-system-identitymodel-selectors4.0-cil/copyright`, `/usr/share/doc/libmono-system-identitymodel4.0-cil/copyright`, `/usr/share/doc/libmono-system-io-compression-filesystem4.0-cil/copyright`, `/usr/share/doc/libmono-system-io-compression4.0-cil/copyright`, `/usr/share/doc/libmono-system-json-microsoft4.0-cil/copyright`, `/usr/share/doc/libmono-system-json2.0-cil/copyright`, `/usr/share/doc/libmono-system-json4.0-cil/copyright`, `/usr/share/doc/libmono-system-ldap-protocols4.0-cil/copyright`, `/usr/share/doc/libmono-system-ldap2.0-cil/copyright`, `/usr/share/doc/libmono-system-ldap4.0-cil/copyright`, `/usr/share/doc/libmono-system-management4.0-cil/copyright`, `/usr/share/doc/libmono-system-messaging2.0-cil/copyright`, `/usr/share/doc/libmono-system-messaging4.0-cil/copyright`, `/usr/share/doc/libmono-system-net-http-formatting4.0-cil/copyright`, `/usr/share/doc/libmono-system-net-http-webrequest4.0-cil/copyright`, `/usr/share/doc/libmono-system-net-http4.0-cil/copyright`, `/usr/share/doc/libmono-system-net2.0-cil/copyright`, `/usr/share/doc/libmono-system-net4.0-cil/copyright`, `/usr/share/doc/libmono-system-numerics4.0-cil/copyright`, `/usr/share/doc/libmono-system-reactive-core2.2-cil/copyright`, `/usr/share/doc/libmono-system-reactive-debugger2.2-cil/copyright`, `/usr/share/doc/libmono-system-reactive-experimental2.2-cil/copyright`, `/usr/share/doc/libmono-system-reactive-interfaces2.2-cil/copyright`, `/usr/share/doc/libmono-system-reactive-linq2.2-cil/copyright`, `/usr/share/doc/libmono-system-reactive-observable-aliases0.0-cil/copyright`, `/usr/share/doc/libmono-system-reactive-platformservices2.2-cil/copyright`, `/usr/share/doc/libmono-system-reactive-providers2.2-cil/copyright`, `/usr/share/doc/libmono-system-reactive-runtime-remoting2.2-cil/copyright`, `/usr/share/doc/libmono-system-reactive-windows-forms2.2-cil/copyright`, `/usr/share/doc/libmono-system-reactive-windows-threading2.2-cil/copyright`, `/usr/share/doc/libmono-system-runtime-caching4.0-cil/copyright`, `/usr/share/doc/libmono-system-runtime-durableinstancing4.0-cil/copyright`, `/usr/share/doc/libmono-system-runtime-serialization-formatters-soap4.0-cil/copyright`, `/usr/share/doc/libmono-system-runtime-serialization4.0-cil/copyright`, `/usr/share/doc/libmono-system-runtime2.0-cil/copyright`, `/usr/share/doc/libmono-system-runtime4.0-cil/copyright`, `/usr/share/doc/libmono-system-security4.0-cil/copyright`, `/usr/share/doc/libmono-system-servicemodel-activation4.0-cil/copyright`, `/usr/share/doc/libmono-system-servicemodel-discovery4.0-cil/copyright`, `/usr/share/doc/libmono-system-servicemodel-routing4.0-cil/copyright`, `/usr/share/doc/libmono-system-servicemodel-web4.0-cil/copyright`, `/usr/share/doc/libmono-system-servicemodel4.0a-cil/copyright`, `/usr/share/doc/libmono-system-serviceprocess4.0-cil/copyright`, `/usr/share/doc/libmono-system-threading-tasks-dataflow4.0-cil/copyright`, `/usr/share/doc/libmono-system-transactions4.0-cil/copyright`, `/usr/share/doc/libmono-system-web-abstractions4.0-cil/copyright`, `/usr/share/doc/libmono-system-web-applicationservices4.0-cil/copyright`, `/usr/share/doc/libmono-system-web-dynamicdata4.0-cil/copyright`, `/usr/share/doc/libmono-system-web-extensions-design4.0-cil/copyright`, `/usr/share/doc/libmono-system-web-extensions4.0-cil/copyright`, `/usr/share/doc/libmono-system-web-http-selfhost4.0-cil/copyright`, `/usr/share/doc/libmono-system-web-http-webhost4.0-cil/copyright`, `/usr/share/doc/libmono-system-web-http4.0-cil/copyright`, `/usr/share/doc/libmono-system-web-mvc1.0-cil/copyright`, `/usr/share/doc/libmono-system-web-mvc2.0-cil/copyright`, `/usr/share/doc/libmono-system-web-mvc3.0-cil/copyright`, `/usr/share/doc/libmono-system-web-razor2.0-cil/copyright`, `/usr/share/doc/libmono-system-web-routing4.0-cil/copyright`, `/usr/share/doc/libmono-system-web-services4.0-cil/copyright`, `/usr/share/doc/libmono-system-web-webpages-deployment2.0-cil/copyright`, `/usr/share/doc/libmono-system-web-webpages-razor2.0-cil/copyright`, `/usr/share/doc/libmono-system-web-webpages2.0-cil/copyright`, `/usr/share/doc/libmono-system-web2.0-cil/copyright`, `/usr/share/doc/libmono-system-web4.0-cil/copyright`, `/usr/share/doc/libmono-system-windows-forms-datavisualization4.0a-cil/copyright`, `/usr/share/doc/libmono-system-windows-forms4.0-cil/copyright`, `/usr/share/doc/libmono-system-windows4.0-cil/copyright`, `/usr/share/doc/libmono-system-xaml4.0-cil/copyright`, `/usr/share/doc/libmono-system-xml-linq4.0-cil/copyright`, `/usr/share/doc/libmono-system-xml-serialization4.0-cil/copyright`, `/usr/share/doc/libmono-system-xml4.0-cil/copyright`, `/usr/share/doc/libmono-system2.0-cil/copyright`, `/usr/share/doc/libmono-system4.0-cil/copyright`, `/usr/share/doc/libmono-tasklets2.0-cil/copyright`, `/usr/share/doc/libmono-tasklets4.0-cil/copyright`, `/usr/share/doc/libmono-wcf3.0a-cil/copyright`, `/usr/share/doc/libmono-webbrowser2.0-cil/copyright`, `/usr/share/doc/libmono-webbrowser4.0-cil/copyright`, `/usr/share/doc/libmono-webmatrix-data4.0-cil/copyright`, `/usr/share/doc/libmono-windowsbase3.0-cil/copyright`, `/usr/share/doc/libmono-windowsbase4.0-cil/copyright`, `/usr/share/doc/libmono-winforms2.0-cil/copyright`, `/usr/share/doc/libmono-xbuild-tasks2.0-cil/copyright`, `/usr/share/doc/libmono-xbuild-tasks4.0-cil/copyright`, `/usr/share/doc/libmono2.0-cil/copyright`, `/usr/share/doc/libmonoboehm-2.0-1/copyright`, `/usr/share/doc/libmonoboehm-2.0-dev/copyright`, `/usr/share/doc/mono-4.0-gac/copyright`, `/usr/share/doc/mono-csharp-shell/copyright`, `/usr/share/doc/mono-devel/copyright`, `/usr/share/doc/mono-gac/copyright`, `/usr/share/doc/mono-mcs/copyright`, `/usr/share/doc/mono-runtime/copyright`, `/usr/share/doc/mono-runtime-common/copyright`, `/usr/share/doc/mono-runtime-sgen/copyright`, `/usr/share/doc/mono-xbuild/copyright`)
...
```console
$ apt-get source -qq --print-uris mono=3.12.1-0xamarin2
'http://download.mono-project.com/repo/debian/pool/main/m/mono/mono_3.12.1-0xamarin2.dsc' mono_3.12.1-0xamarin2.dsc 21998 SHA256:b340c347ce9996cb73adde915516780060530abe78cecec23ef3451d7006e2e4
'http://download.mono-project.com/repo/debian/pool/main/m/mono/mono_3.12.1.orig.tar.bz2' mono_3.12.1.orig.tar.bz2 73487974 SHA256:5d8cf153af2948c06bc9fbf5088f6834868e4db8e5f41c7cff76da173732b60d
'http://download.mono-project.com/repo/debian/pool/main/m/mono/mono_3.12.1-0xamarin2.debian.tar.xz' mono_3.12.1-0xamarin2.debian.tar.xz 139200 SHA256:f0bb8a281e34da072f2bb5e25558f3071e81d212f0e23104226ddff5e24e639b
```
...
### `dpkg` source package: `nuget=2.8.3+md58+dhx1-0xamarin1`
...
```console
$ apt-get source -qq --print-uris nuget=2.8.3+md58+dhx1-0xamarin1
'http://download.mono-project.com/repo/debian/pool/main/n/nuget/nuget_2.8.3+md58+dhx1-0xamarin1.dsc' nuget_2.8.3+md58+dhx1-0xamarin1.dsc 1802 SHA256:9bcc7a07a872f67258180a30f970ffb9ecfcdb5e07f8a54424501156e2d0e4ac
'http://download.mono-project.com/repo/debian/pool/main/n/nuget/nuget_2.8.3+md58+dhx1.orig.tar.bz2' nuget_2.8.3+md58+dhx1.orig.tar.bz2 752782 SHA256:ce9af727d35ea7ed32a95954e176e6396e54538eedeccbbae799acb22b96cf96
'http://download.mono-project.com/repo/debian/pool/main/n/nuget/nuget_2.8.3+md58+dhx1-0xamarin1.debian.tar.gz' nuget_2.8.3+md58+dhx1-0xamarin1.debian.tar.gz 3809 SHA256:e3426feb137ca51ded7440da23bf8d2cd92b3366761a7b17871dc971e975696d
```
...
### `dpkg` source package: `tiff=4.0.2-6+deb7u6`

Binary Packages:

- `libtiff5:amd64=4.0.2-6+deb7u6`
...
```console
$ apt-get source -qq --print-uris tiff=4.0.2-6+deb7u6
'http://security.debian.org/pool/updates/main/t/tiff/tiff_4.0.2-6+deb7u6.dsc' tiff_4.0.2-6+deb7u6.dsc 2174 SHA256:f227cb049776506e51e7047e4f274134c6f878e795f04d33cbb46cf89b8c3a72
...
'http://security.debian.org/pool/updates/main/t/tiff/tiff_4.0.2-6+deb7u6.debian.tar.gz' tiff_4.0.2-6+deb7u6.debian.tar.gz 47928 SHA256:e149211886bfa1adbb03dbc9e2723e24e25de6e701c903b113e68e72feccb3ee
```

Likely also available for browsing at:

- https://sources.debian.net/src/tiff/4.0.2-6+deb7u6/
- https://sources.debian.net/src/tiff/4.0.2-6+deb7u6/debian/copyright (for direct copyright/license information)
