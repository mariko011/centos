...
- Created: `2016-08-24T17:10:30.675633084Z`
- Arch: `linux`/`amd64`
...
- Environment:
  ...
  - `GOSU_VERSION=1.7`
  - `PERCONA_MAJOR=5.7`
  - `PERCONA_VERSION=5.7.14-7-1.jessie`
...
### `dpkg` source package: `percona-server-5.7=5.7.14-7-1.jessie`

Binary Packages:

- `percona-server-client-5.7=5.7.14-7-1.jessie`
- `percona-server-common-5.7=5.7.14-7-1.jessie`
- `percona-server-server-5.7=5.7.14-7-1.jessie`
